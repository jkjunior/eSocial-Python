...
class eSocial(GeneratedsSuper):
    ...
    def __init__(self, evtAdmPrelim=None, Signature=None):
        ...
        self.evtAdmPrelim = evtAdmPrelim
    ...
    def get_evtAdmPrelim(self): return self.evtAdmPrelim
    def set_evtAdmPrelim(self, evtAdmPrelim): self.evtAdmPrelim = evtAdmPrelim
    def get_Signature(self): return self.Signature
    def set_Signature(self, Signature): self.Signature = Signature
    def hasContent_(self):
        if (
            self.evtAdmPrelim is not None or
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            ...
            eol_ = ''
        if self.evtAdmPrelim is not None:
            self.evtAdmPrelim.export(outfile, level, namespaceprefix_, name_='evtAdmPrelim', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'evtAdmPrelim':
            obj_ = evtAdmPrelimType.factory()
            obj_.build(child_)
            self.evtAdmPrelim = obj_
            obj_.original_tagname_ = 'evtAdmPrelim'
...
class evtAdmPrelimType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, infoRegPrelim=None):
        ...
        self.infoRegPrelim = infoRegPrelim
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtAdmPrelimType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtAdmPrelimType.subclass:
            return evtAdmPrelimType.subclass(*args_, **kwargs_)
        else:
            return evtAdmPrelimType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def get_infoRegPrelim(self): return self.infoRegPrelim
    def set_infoRegPrelim(self, infoRegPrelim): self.infoRegPrelim = infoRegPrelim
    def get_Id(self): return self.Id
    def set_Id(self, Id): self.Id = Id
    def hasContent_(self):
        if (
            ...
            self.infoRegPrelim is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtAdmPrelimType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtAdmPrelimType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtAdmPrelimType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtAdmPrelimType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtAdmPrelimType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtAdmPrelimType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoRegPrelim is not None:
            self.infoRegPrelim.export(outfile, level, namespaceprefix_, name_='infoRegPrelim', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'infoRegPrelim':
            obj_ = infoRegPrelimType.factory()
            obj_.build(child_)
            self.infoRegPrelim = obj_
            obj_.original_tagname_ = 'infoRegPrelim'
# end class evtAdmPrelimType


class infoRegPrelimType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoRegPrelimType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoRegPrelimType.subclass:
            return infoRegPrelimType.subclass(*args_, **kwargs_)
        else:
            return infoRegPrelimType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            self.dtAdm is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoRegPrelimType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoRegPrelimType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoRegPrelimType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoRegPrelimType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoRegPrelimType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoRegPrelimType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''

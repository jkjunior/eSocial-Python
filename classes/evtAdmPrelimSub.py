...
#   ('-o', 'classes/evtAdmPrelim.py')
#   ('-s', 'classes/evtAdmPrelimSub.py')
#   ('--super', 'evtAdmPrelim')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtAdmPrelim.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtAdmPrelim.py" -s "classes/evtAdmPrelimSub.py" --super="evtAdmPrelim" /home/joao/Documents/teste_xsd/xsd/evtAdmPrelim.xsd
#
...
import evtAdmPrelim as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtAdmPrelim=None, Signature=None):
        super(eSocialSub, self).__init__(evtAdmPrelim, Signature, )
...
class evtAdmPrelimTypeSub(supermod.evtAdmPrelimType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, infoRegPrelim=None):
        super(evtAdmPrelimTypeSub, self).__init__(Id, ideEvento, ideEmpregador, infoRegPrelim, )
supermod.evtAdmPrelimType.subclass = evtAdmPrelimTypeSub
# end class evtAdmPrelimTypeSub


class infoRegPrelimTypeSub(supermod.infoRegPrelimType):
    def __init__(self, cpfTrab=None, dtNascto=None, dtAdm=None):
        super(infoRegPrelimTypeSub, self).__init__(cpfTrab, dtNascto, dtAdm, )
supermod.infoRegPrelimType.subclass = infoRegPrelimTypeSub
# end class infoRegPrelimTypeSub
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from evtAdmPrelim import *\n\n')
        sys.stdout.write('import evtAdmPrelim as model_\n\n')

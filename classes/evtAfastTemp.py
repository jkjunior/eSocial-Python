...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtAfastTemp is not None:
            self.evtAfastTemp.export(outfile, level, namespaceprefix_, name_='evtAfastTemp', pretty_print=pretty_print)
...
class evtAfastTempType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtAfastTempType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtAfastTempType.subclass:
            return evtAfastTempType.subclass(*args_, **kwargs_)
        else:
            return evtAfastTempType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtAfastTempType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtAfastTempType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtAfastTempType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtAfastTempType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtAfastTempType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtAfastTempType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoAfastamento is not None:
            self.infoAfastamento.export(outfile, level, namespaceprefix_, name_='infoAfastamento', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class ideVinculoType(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ideVinculoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ideVinculoType.subclass:
            return ideVinculoType.subclass(*args_, **kwargs_)
        else:
            return ideVinculoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='ideVinculoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ideVinculoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ideVinculoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='ideVinculoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ideVinculoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideVinculoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'cpfTrab':
            ...
            self.validate_codCategType(self.codCateg)
# end class ideVinculoType


class infoAfastamentoType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoAfastamentoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoAfastamentoType.subclass:
            return infoAfastamentoType.subclass(*args_, **kwargs_)
        else:
            return infoAfastamentoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoAfastamentoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoAfastamentoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoAfastamentoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoAfastamentoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoAfastamentoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoAfastamentoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.iniAfastamento is not None:
            self.iniAfastamento.export(outfile, level, namespaceprefix_, name_='iniAfastamento', pretty_print=pretty_print)
        if self.infoRetif is not None:
            self.infoRetif.export(outfile, level, namespaceprefix_, name_='infoRetif', pretty_print=pretty_print)
        if self.fimAfastamento is not None:
            self.fimAfastamento.export(outfile, level, namespaceprefix_, name_='fimAfastamento', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class iniAfastamentoType(GeneratedsSuper):
    ...
    def __init__(self, dtIniAfast=None, codMotAfast=None, infoMesmoMtv=None, tpAcidTransito=None, observacao=None, infoAtestado=None, infoCessao=None, infoMandSind=None):
        ...
        self.validate_infoMesmoMtvType(self.infoMesmoMtv)
        self.tpAcidTransito = tpAcidTransito
        self.validate_tpAcidTransitoType(self.tpAcidTransito)
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, iniAfastamentoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if iniAfastamentoType.subclass:
            return iniAfastamentoType.subclass(*args_, **kwargs_)
        else:
            return iniAfastamentoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_infoMesmoMtvType(self, value):
        # Validate type infoMesmoMtvType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_infoMesmoMtvType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_infoMesmoMtvType_patterns_, ))
    validate_infoMesmoMtvType_patterns_ = [['^[N|S]$']]
    def validate_tpAcidTransitoType(self, value):
        # Validate type tpAcidTransitoType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tpAcidTransitoType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_tpAcidTransitoType_patterns_, ))
    validate_tpAcidTransitoType_patterns_ = [['^\\d$']]
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='iniAfastamentoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('iniAfastamentoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='iniAfastamentoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='iniAfastamentoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='iniAfastamentoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='iniAfastamentoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoMesmoMtv is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<infoMesmoMtv>%s</infoMesmoMtv>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.infoMesmoMtv), input_name='infoMesmoMtv')), eol_))
        if self.tpAcidTransito is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tpAcidTransito>%s</tpAcidTransito>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.tpAcidTransito), input_name='tpAcidTransito')), eol_))
        ...
        for infoAtestado_ in self.infoAtestado:
            infoAtestado_.export(outfile, level, namespaceprefix_, name_='infoAtestado', pretty_print=pretty_print)
        if self.infoCessao is not None:
            self.infoCessao.export(outfile, level, namespaceprefix_, name_='infoCessao', pretty_print=pretty_print)
        if self.infoMandSind is not None:
            self.infoMandSind.export(outfile, level, namespaceprefix_, name_='infoMandSind', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dtIniAfast':
            ...
            # validate type infoMesmoMtvType
            self.validate_infoMesmoMtvType(self.infoMesmoMtv)
        elif nodeName_ == 'tpAcidTransito':
            tpAcidTransito_ = child_.text
            tpAcidTransito_ = self.gds_validate_string(tpAcidTransito_, node, 'tpAcidTransito')
            self.tpAcidTransito = tpAcidTransito_
            # validate type tpAcidTransitoType
            self.validate_tpAcidTransitoType(self.tpAcidTransito)
...
class infoAtestadoType(GeneratedsSuper):
    ...
    def __init__(self, codCID=None, qtdDiasAfast=None, emitente=None):
        ...
        self.validate_qtdDiasAfastType(self.qtdDiasAfast)
        self.emitente = emitente
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoAtestadoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoAtestadoType.subclass:
            return infoAtestadoType.subclass(*args_, **kwargs_)
        else:
            return infoAtestadoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_qtdDiasAfastType(self, value):
        # Validate type qtdDiasAfastType, a restriction on xs:integer.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_qtdDiasAfastType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_qtdDiasAfastType_patterns_, ))
    validate_qtdDiasAfastType_patterns_ = [['^\\d{1,3}$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoAtestadoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoAtestadoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoAtestadoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoAtestadoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoAtestadoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoAtestadoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.qtdDiasAfast is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<qtdDiasAfast>%s</qtdDiasAfast>%s' % (self.gds_format_integer(self.qtdDiasAfast, input_name='qtdDiasAfast'), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'codCID':
            ...
            self.validate_codCIDType(self.codCID)
        elif nodeName_ == 'qtdDiasAfast' and child_.text:
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
            ...
            # validate type qtdDiasAfastType
            self.validate_qtdDiasAfastType(self.qtdDiasAfast)
...
class infoCessaoType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, cnpjCess=None, infOnus=None):
        self.original_tagname_ = None
        self.cnpjCess = cnpjCess
        self.validate_cnpjCessType(self.cnpjCess)
        self.infOnus = infOnus
        self.validate_infOnusType(self.infOnus)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoCessaoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoCessaoType.subclass:
            return infoCessaoType.subclass(*args_, **kwargs_)
        else:
            return infoCessaoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_cnpjCessType(self, value):
        # Validate type cnpjCessType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 14:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on cnpjCessType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_cnpjCessType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_cnpjCessType_patterns_, ))
    validate_cnpjCessType_patterns_ = [['^\\d{8,14}$']]
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoCessaoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoCessaoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoCessaoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoCessaoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoCessaoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoCessaoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.cnpjCess is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<cnpjCess>%s</cnpjCess>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.cnpjCess), input_name='cnpjCess')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'cnpjCess':
            ...
            self.validate_infOnusType(self.infOnus)
# end class infoCessaoType


class infoMandSindType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, cnpjSind=None, infOnusRemun=None):
        self.original_tagname_ = None
        self.cnpjSind = cnpjSind
        self.validate_cnpjSindType(self.cnpjSind)
        self.infOnusRemun = infOnusRemun
        self.validate_infOnusRemunType(self.infOnusRemun)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoMandSindType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoMandSindType.subclass:
            return infoMandSindType.subclass(*args_, **kwargs_)
        else:
            return infoMandSindType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_cnpjSindType(self, value):
        # Validate type cnpjSindType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 14:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on cnpjSindType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_cnpjSindType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_cnpjSindType_patterns_, ))
    validate_cnpjSindType_patterns_ = [['^\\d{8,14}$']]
    def validate_infOnusRemunType(self, value):
        # Validate type infOnusRemunType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_infOnusRemunType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_infOnusRemunType_patterns_, ))
    validate_infOnusRemunType_patterns_ = [['^\\d$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoMandSindType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoMandSindType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoMandSindType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoMandSindType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoMandSindType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoMandSindType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.cnpjSind is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<cnpjSind>%s</cnpjSind>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.cnpjSind), input_name='cnpjSind')), eol_))
        if self.infOnusRemun is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<infOnusRemun>%s</infOnusRemun>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.infOnusRemun), input_name='infOnusRemun')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'cnpjSind':
            ...
            # validate type cnpjSindType
            self.validate_cnpjSindType(self.cnpjSind)
        elif nodeName_ == 'infOnusRemun':
            infOnusRemun_ = child_.text
            infOnusRemun_ = self.gds_validate_string(infOnusRemun_, node, 'infOnusRemun')
            self.infOnusRemun = infOnusRemun_
            # validate type infOnusRemunType
            self.validate_infOnusRemunType(self.infOnusRemun)
# end class infoMandSindType


class infoRetifType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, origRetif=None, tpProc=None, nrProc=None):
        self.original_tagname_ = None
        self.origRetif = origRetif
        self.validate_origRetifType(self.origRetif)
        self.tpProc = tpProc
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoRetifType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoRetifType.subclass:
            return infoRetifType.subclass(*args_, **kwargs_)
        else:
            return infoRetifType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_origRetifType(self, value):
        # Validate type origRetifType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_origRetifType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_origRetifType_patterns_, ))
    validate_origRetifType_patterns_ = [['^\\d$']]
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoRetifType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoRetifType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoRetifType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoRetifType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoRetifType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoRetifType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.origRetif is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<origRetif>%s</origRetif>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.origRetif), input_name='origRetif')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'origRetif':
            origRetif_ = child_.text
            origRetif_ = self.gds_validate_string(origRetif_, node, 'origRetif')
            self.origRetif = origRetif_
            # validate type origRetifType
            self.validate_origRetifType(self.origRetif)
            ...
            self.validate_nrProcType(self.nrProc)
# end class infoRetifType


class fimAfastamentoType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, fimAfastamentoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if fimAfastamentoType.subclass:
            return fimAfastamentoType.subclass(*args_, **kwargs_)
        else:
            return fimAfastamentoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_dtTermAfast(self): return self.dtTermAfast
    def set_dtTermAfast(self, dtTermAfast): self.dtTermAfast = dtTermAfast
    def validate_dtTermAfastType(self, value):
        # Validate type dtTermAfastType, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='fimAfastamentoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('fimAfastamentoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='fimAfastamentoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='fimAfastamentoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='fimAfastamentoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='fimAfastamentoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.dtTermAfast is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtTermAfast>%s</dtTermAfast>%s' % (self.gds_format_date(self.dtTermAfast, input_name='dtTermAfast'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dtTermAfast':
            ...
            # validate type dtTermAfastType
            self.validate_dtTermAfastType(self.dtTermAfast)
# end class fimAfastamentoType

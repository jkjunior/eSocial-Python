...
#   ('-o', 'classes/evtAfastTemp.py')
#   ('-s', 'classes/evtAfastTempSub.py')
#   ('--super', 'evtAfastTemp')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtAfastTemp.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtAfastTemp.py" -s "classes/evtAfastTempSub.py" --super="evtAfastTemp" /home/joao/Documents/teste_xsd/xsd/evtAfastTemp.xsd
#
...
import evtAfastTemp as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtAfastTemp=None, Signature=None):
        super(eSocialSub, self).__init__(evtAfastTemp, Signature, )
...
class evtAfastTempTypeSub(supermod.evtAfastTempType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, ideVinculo=None, infoAfastamento=None):
        super(evtAfastTempTypeSub, self).__init__(Id, ideEvento, ideEmpregador, ideVinculo, infoAfastamento, )
supermod.evtAfastTempType.subclass = evtAfastTempTypeSub
# end class evtAfastTempTypeSub


class ideVinculoTypeSub(supermod.ideVinculoType):
    def __init__(self, cpfTrab=None, nisTrab=None, matricula=None, codCateg=None):
        super(ideVinculoTypeSub, self).__init__(cpfTrab, nisTrab, matricula, codCateg, )
supermod.ideVinculoType.subclass = ideVinculoTypeSub
# end class ideVinculoTypeSub


class infoAfastamentoTypeSub(supermod.infoAfastamentoType):
    def __init__(self, iniAfastamento=None, infoRetif=None, fimAfastamento=None):
        super(infoAfastamentoTypeSub, self).__init__(iniAfastamento, infoRetif, fimAfastamento, )
supermod.infoAfastamentoType.subclass = infoAfastamentoTypeSub
# end class infoAfastamentoTypeSub


class iniAfastamentoTypeSub(supermod.iniAfastamentoType):
    def __init__(self, dtIniAfast=None, codMotAfast=None, infoMesmoMtv=None, tpAcidTransito=None, observacao=None, infoAtestado=None, infoCessao=None, infoMandSind=None):
        super(iniAfastamentoTypeSub, self).__init__(dtIniAfast, codMotAfast, infoMesmoMtv, tpAcidTransito, observacao, infoAtestado, infoCessao, infoMandSind, )
supermod.iniAfastamentoType.subclass = iniAfastamentoTypeSub
# end class iniAfastamentoTypeSub


class infoAtestadoTypeSub(supermod.infoAtestadoType):
    def __init__(self, codCID=None, qtdDiasAfast=None, emitente=None):
        super(infoAtestadoTypeSub, self).__init__(codCID, qtdDiasAfast, emitente, )
supermod.infoAtestadoType.subclass = infoAtestadoTypeSub
# end class infoAtestadoTypeSub
...
class infoCessaoTypeSub(supermod.infoCessaoType):
    def __init__(self, cnpjCess=None, infOnus=None):
        super(infoCessaoTypeSub, self).__init__(cnpjCess, infOnus, )
supermod.infoCessaoType.subclass = infoCessaoTypeSub
# end class infoCessaoTypeSub


class infoMandSindTypeSub(supermod.infoMandSindType):
    def __init__(self, cnpjSind=None, infOnusRemun=None):
        super(infoMandSindTypeSub, self).__init__(cnpjSind, infOnusRemun, )
supermod.infoMandSindType.subclass = infoMandSindTypeSub
# end class infoMandSindTypeSub


class infoRetifTypeSub(supermod.infoRetifType):
    def __init__(self, origRetif=None, tpProc=None, nrProc=None):
        super(infoRetifTypeSub, self).__init__(origRetif, tpProc, nrProc, )
supermod.infoRetifType.subclass = infoRetifTypeSub
# end class infoRetifTypeSub


class fimAfastamentoTypeSub(supermod.fimAfastamentoType):
    def __init__(self, dtTermAfast=None):
        super(fimAfastamentoTypeSub, self).__init__(dtTermAfast, )
supermod.fimAfastamentoType.subclass = fimAfastamentoTypeSub
# end class fimAfastamentoTypeSub

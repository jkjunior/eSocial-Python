...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtAqProd is not None:
            self.evtAqProd.export(outfile, level, namespaceprefix_, name_='evtAqProd', pretty_print=pretty_print)
...
class evtAqProdType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtAqProdType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtAqProdType.subclass:
            return evtAqProdType.subclass(*args_, **kwargs_)
        else:
            return evtAqProdType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtAqProdType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtAqProdType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtAqProdType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtAqProdType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtAqProdType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtAqProdType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoAquisProd is not None:
            self.infoAquisProd.export(outfile, level, namespaceprefix_, name_='infoAquisProd', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ideEvento':
            ...
            obj_ = infoAquisProdType.factory()
            obj_.build(child_)
            self.infoAquisProd = obj_
            obj_.original_tagname_ = 'infoAquisProd'
# end class evtAqProdType


class infoAquisProdType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoAquisProdType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoAquisProdType.subclass:
            return infoAquisProdType.subclass(*args_, **kwargs_)
        else:
            return infoAquisProdType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoAquisProdType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoAquisProdType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoAquisProdType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoAquisProdType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoAquisProdType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoAquisProdType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.ideEstabAdquir is not None:
            self.ideEstabAdquir.export(outfile, level, namespaceprefix_, name_='ideEstabAdquir', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ideEstabAdquir':
            obj_ = ideEstabAdquirType.factory()
            obj_.build(child_)
            self.ideEstabAdquir = obj_
            obj_.original_tagname_ = 'ideEstabAdquir'
# end class infoAquisProdType


class ideEstabAdquirType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, tpInscAdq=None, nrInscAdq=None, tpAquis=None):
        self.original_tagname_ = None
        self.tpInscAdq = tpInscAdq
        self.validate_tpInscAdqType(self.tpInscAdq)
        self.nrInscAdq = nrInscAdq
        self.validate_nrInscAdqType(self.nrInscAdq)
        if tpAquis is None:
            self.tpAquis = []
        else:
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ideEstabAdquirType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ideEstabAdquirType.subclass:
            return ideEstabAdquirType.subclass(*args_, **kwargs_)
        else:
            return ideEstabAdquirType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_tpInscAdqType(self, value):
        # Validate type tpInscAdqType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tpInscAdqType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_tpInscAdqType_patterns_, ))
    validate_tpInscAdqType_patterns_ = [['^\\d$']]
    def validate_nrInscAdqType(self, value):
        # Validate type nrInscAdqType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_nrInscAdqType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_nrInscAdqType_patterns_, ))
    validate_nrInscAdqType_patterns_ = [['^\\d{11,15}$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='ideEstabAdquirType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ideEstabAdquirType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ideEstabAdquirType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='ideEstabAdquirType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ideEstabAdquirType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideEstabAdquirType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.tpInscAdq is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tpInscAdq>%s</tpInscAdq>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.tpInscAdq), input_name='tpInscAdq')), eol_))
        if self.nrInscAdq is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nrInscAdq>%s</nrInscAdq>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.nrInscAdq), input_name='nrInscAdq')), eol_))
        for tpAquis_ in self.tpAquis:
            tpAquis_.export(outfile, level, namespaceprefix_, name_='tpAquis', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpInscAdq':
            tpInscAdq_ = child_.text
            tpInscAdq_ = self.gds_validate_string(tpInscAdq_, node, 'tpInscAdq')
            self.tpInscAdq = tpInscAdq_
            # validate type tpInscAdqType
            self.validate_tpInscAdqType(self.tpInscAdq)
            ...
            # validate type nrInscAdqType
            self.validate_nrInscAdqType(self.nrInscAdq)
        elif nodeName_ == 'tpAquis':
            obj_ = tpAquisType.factory()
            obj_.build(child_)
            self.tpAquis.append(obj_)
            obj_.original_tagname_ = 'tpAquis'
# end class ideEstabAdquirType


class tpAquisType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, indAquis=None, vlrTotAquis=None, ideProdutor=None):
        ...
        self.validate_vlrTotAquisType(self.vlrTotAquis)
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, tpAquisType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if tpAquisType.subclass:
            return tpAquisType.subclass(*args_, **kwargs_)
        else:
            return tpAquisType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_vlrTotAquisType(self, value):
        # Validate type vlrTotAquisType, a restriction on xs:decimal.
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 14:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on vlrTotAquisType' % {"value" : value} )
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='tpAquisType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('tpAquisType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='tpAquisType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='tpAquisType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='tpAquisType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='tpAquisType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.vlrTotAquis is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<vlrTotAquis>%s</vlrTotAquis>%s' % (self.gds_format_float(self.vlrTotAquis, input_name='vlrTotAquis'), eol_))
        for ideProdutor_ in self.ideProdutor:
            ideProdutor_.export(outfile, level, namespaceprefix_, name_='ideProdutor', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'indAquis':
            ...
            self.validate_indAquisType(self.indAquis)
        elif nodeName_ == 'vlrTotAquis' and child_.text:
            sval_ = child_.text
            try:
                fval_ = float(sval_)
            except (TypeError, ValueError) as exp:
            ...
            # validate type vlrTotAquisType
            self.validate_vlrTotAquisType(self.vlrTotAquis)
        elif nodeName_ == 'ideProdutor':
            obj_ = ideProdutorType.factory()
            obj_.build(child_)
            self.ideProdutor.append(obj_)
            obj_.original_tagname_ = 'ideProdutor'
# end class tpAquisType


class ideProdutorType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, tpInscProd=None, nrInscProd=None, vlrBruto=None, vrCPDescPR=None, vrRatDescPR=None, vrSenarDesc=None, nfs=None, infoProcJud=None):
        ...
        self.validate_tpInscProdType(self.tpInscProd)
        self.nrInscProd = nrInscProd
        self.validate_nrInscProdType(self.nrInscProd)
        self.vlrBruto = vlrBruto
        self.validate_vlrBrutoType(self.vlrBruto)
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ideProdutorType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ideProdutorType.subclass:
            return ideProdutorType.subclass(*args_, **kwargs_)
        else:
            return ideProdutorType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_tpInscProdType(self, value):
        # Validate type tpInscProdType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tpInscProdType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_tpInscProdType_patterns_, ))
    validate_tpInscProdType_patterns_ = [['^\\d$']]
    def validate_nrInscProdType(self, value):
        # Validate type nrInscProdType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_nrInscProdType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_nrInscProdType_patterns_, ))
    validate_nrInscProdType_patterns_ = [['^\\d{11,15}$']]
    def validate_vlrBrutoType(self, value):
        # Validate type vlrBrutoType, a restriction on xs:decimal.
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 14:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on vlrBrutoType' % {"value" : value} )
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='ideProdutorType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ideProdutorType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ideProdutorType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='ideProdutorType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ideProdutorType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideProdutorType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.tpInscProd is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tpInscProd>%s</tpInscProd>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.tpInscProd), input_name='tpInscProd')), eol_))
        if self.nrInscProd is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nrInscProd>%s</nrInscProd>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.nrInscProd), input_name='nrInscProd')), eol_))
        if self.vlrBruto is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<vlrBruto>%s</vlrBruto>%s' % (self.gds_format_float(self.vlrBruto, input_name='vlrBruto'), eol_))
        ...
        for nfs_ in self.nfs:
            nfs_.export(outfile, level, namespaceprefix_, name_='nfs', pretty_print=pretty_print)
        for infoProcJud_ in self.infoProcJud:
            infoProcJud_.export(outfile, level, namespaceprefix_, name_='infoProcJud', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpInscProd':
            tpInscProd_ = child_.text
            tpInscProd_ = self.gds_validate_string(tpInscProd_, node, 'tpInscProd')
            self.tpInscProd = tpInscProd_
            # validate type tpInscProdType
            self.validate_tpInscProdType(self.tpInscProd)
            ...
            # validate type nrInscProdType
            self.validate_nrInscProdType(self.nrInscProd)
        elif nodeName_ == 'vlrBruto' and child_.text:
            sval_ = child_.text
            try:
                fval_ = float(sval_)
            except (TypeError, ValueError) as exp:
...
class nfsType(GeneratedsSuper):
    ...
    def __init__(self, serie=None, nrDocto=None, dtEmisNF=None, vlrBruto=None, vrCPDescPR=None, vrRatDescPR=None, vrSenarDesc=None):
        ...
        self.validate_nrDoctoType(self.nrDocto)
        ...
        self.vlrBruto = vlrBruto
        self.validate_vlrBrutoType1(self.vlrBruto)
        self.vrCPDescPR = vrCPDescPR
        self.validate_vrCPDescPRType2(self.vrCPDescPR)
        self.vrRatDescPR = vrRatDescPR
        self.validate_vrRatDescPRType3(self.vrRatDescPR)
        self.vrSenarDesc = vrSenarDesc
        self.validate_vrSenarDescType4(self.vrSenarDesc)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, nfsType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if nfsType.subclass:
            return nfsType.subclass(*args_, **kwargs_)
        else:
            return nfsType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_serieType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 5:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on serieType' % {"value" : value.encode("utf-8")} )
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on serieType' % {"value" : value.encode("utf-8")} )
    def validate_nrDoctoType(self, value):
        # Validate type nrDoctoType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 20:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on nrDoctoType' % {"value" : value.encode("utf-8")} )
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on nrDoctoType' % {"value" : value.encode("utf-8")} )
    def validate_dtEmisNFType(self, value):
        # Validate type dtEmisNFType, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def validate_vlrBrutoType1(self, value):
        # Validate type vlrBrutoType1, a restriction on xs:decimal.
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 14:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on vlrBrutoType1' % {"value" : value} )
    def validate_vrCPDescPRType2(self, value):
        # Validate type vrCPDescPRType2, a restriction on xs:decimal.
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 14:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on vrCPDescPRType2' % {"value" : value} )
    def validate_vrRatDescPRType3(self, value):
        # Validate type vrRatDescPRType3, a restriction on xs:decimal.
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 14:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on vrRatDescPRType3' % {"value" : value} )
    def validate_vrSenarDescType4(self, value):
        # Validate type vrSenarDescType4, a restriction on xs:decimal.
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 14:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on vrSenarDescType4' % {"value" : value} )
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='nfsType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('nfsType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='nfsType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='nfsType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='nfsType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='nfsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.nrDocto is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nrDocto>%s</nrDocto>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.nrDocto), input_name='nrDocto')), eol_))
        if self.dtEmisNF is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtEmisNF>%s</dtEmisNF>%s' % (self.gds_format_date(self.dtEmisNF, input_name='dtEmisNF'), eol_))
        if self.vlrBruto is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<vlrBruto>%s</vlrBruto>%s' % (self.gds_format_float(self.vlrBruto, input_name='vlrBruto'), eol_))
        if self.vrCPDescPR is not None:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'serie':
            ...
            # validate type nrDoctoType
            self.validate_nrDoctoType(self.nrDocto)
        elif nodeName_ == 'dtEmisNF':
            sval_ = child_.text
            dval_ = self.gds_parse_date(sval_)
            self.dtEmisNF = dval_
            # validate type dtEmisNFType
            self.validate_dtEmisNFType(self.dtEmisNF)
        elif nodeName_ == 'vlrBruto' and child_.text:
            sval_ = child_.text
            try:
                fval_ = float(sval_)
            ...
            fval_ = self.gds_validate_float(fval_, node, 'vrRatDescPR')
            self.vrRatDescPR = fval_
            # validate type vrRatDescPRType3
            self.validate_vrRatDescPRType3(self.vrRatDescPR)
        elif nodeName_ == 'vrSenarDesc' and child_.text:
            sval_ = child_.text
            try:
            ...
            fval_ = self.gds_validate_float(fval_, node, 'vrSenarDesc')
            self.vrSenarDesc = fval_
            # validate type vrSenarDescType4
            self.validate_vrSenarDescType4(self.vrSenarDesc)
# end class nfsType


class infoProcJudType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoProcJudType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoProcJudType.subclass:
            return infoProcJudType.subclass(*args_, **kwargs_)
        else:
            return infoProcJudType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoProcJudType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoProcJudType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoProcJudType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoProcJudType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoProcJudType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoProcJudType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''

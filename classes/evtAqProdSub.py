...
#
# Generated Wed Oct 10 14:18:17 2018 by generateDS.py version 2.29.24.
# Python 3.6.5 (default, May 11 2018, 13:30:17)  [GCC 7.3.0]
#
# Command line options:
#   ('-o', 'classes/evtAqProd.py')
#   ('-s', 'classes/evtAqProdSub.py')
#   ('--super', 'evtAqProd')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtAqProd.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtAqProd.py" -s "classes/evtAqProdSub.py" --super="evtAqProd" /home/joao/Documents/teste_xsd/xsd/evtAqProd.xsd
#
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtAqProd=None, Signature=None):
        super(eSocialSub, self).__init__(evtAqProd, Signature, )
...
class evtAqProdTypeSub(supermod.evtAqProdType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, infoAquisProd=None):
        super(evtAqProdTypeSub, self).__init__(Id, ideEvento, ideEmpregador, infoAquisProd, )
supermod.evtAqProdType.subclass = evtAqProdTypeSub
# end class evtAqProdTypeSub


class infoAquisProdTypeSub(supermod.infoAquisProdType):
    def __init__(self, ideEstabAdquir=None):
        super(infoAquisProdTypeSub, self).__init__(ideEstabAdquir, )
supermod.infoAquisProdType.subclass = infoAquisProdTypeSub
# end class infoAquisProdTypeSub


class ideEstabAdquirTypeSub(supermod.ideEstabAdquirType):
    def __init__(self, tpInscAdq=None, nrInscAdq=None, tpAquis=None):
        super(ideEstabAdquirTypeSub, self).__init__(tpInscAdq, nrInscAdq, tpAquis, )
supermod.ideEstabAdquirType.subclass = ideEstabAdquirTypeSub
# end class ideEstabAdquirTypeSub


class tpAquisTypeSub(supermod.tpAquisType):
    def __init__(self, indAquis=None, vlrTotAquis=None, ideProdutor=None):
        super(tpAquisTypeSub, self).__init__(indAquis, vlrTotAquis, ideProdutor, )
supermod.tpAquisType.subclass = tpAquisTypeSub
# end class tpAquisTypeSub


class ideProdutorTypeSub(supermod.ideProdutorType):
    def __init__(self, tpInscProd=None, nrInscProd=None, vlrBruto=None, vrCPDescPR=None, vrRatDescPR=None, vrSenarDesc=None, nfs=None, infoProcJud=None):
        super(ideProdutorTypeSub, self).__init__(tpInscProd, nrInscProd, vlrBruto, vrCPDescPR, vrRatDescPR, vrSenarDesc, nfs, infoProcJud, )
supermod.ideProdutorType.subclass = ideProdutorTypeSub
# end class ideProdutorTypeSub
...
class infoProcJudTypeSub(supermod.infoProcJudType):
    def __init__(self, nrProcJud=None, codSusp=None, vrCPNRet=None, vrRatNRet=None, vrSenarNRet=None):
        super(infoProcJudTypeSub, self).__init__(nrProcJud, codSusp, vrCPNRet, vrRatNRet, vrSenarNRet, )

...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtAvPrevio is not None:
            self.evtAvPrevio.export(outfile, level, namespaceprefix_, name_='evtAvPrevio', pretty_print=pretty_print)
...
class evtAvPrevioType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtAvPrevioType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtAvPrevioType.subclass:
            return evtAvPrevioType.subclass(*args_, **kwargs_)
        else:
            return evtAvPrevioType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtAvPrevioType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtAvPrevioType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtAvPrevioType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtAvPrevioType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtAvPrevioType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtAvPrevioType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoAvPrevio is not None:
            self.infoAvPrevio.export(outfile, level, namespaceprefix_, name_='infoAvPrevio', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ideEvento':
            ...
            obj_ = infoAvPrevioType.factory()
            obj_.build(child_)
            self.infoAvPrevio = obj_
            obj_.original_tagname_ = 'infoAvPrevio'
# end class evtAvPrevioType


class infoAvPrevioType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoAvPrevioType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoAvPrevioType.subclass:
            return infoAvPrevioType.subclass(*args_, **kwargs_)
        else:
            return infoAvPrevioType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoAvPrevioType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoAvPrevioType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoAvPrevioType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoAvPrevioType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoAvPrevioType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoAvPrevioType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.detAvPrevio is not None:
            self.detAvPrevio.export(outfile, level, namespaceprefix_, name_='detAvPrevio', pretty_print=pretty_print)
        if self.cancAvPrevio is not None:
            self.cancAvPrevio.export(outfile, level, namespaceprefix_, name_='cancAvPrevio', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class detAvPrevioType(GeneratedsSuper):
    ...
    def __init__(self, dtAvPrv=None, dtPrevDeslig=None, tpAvPrevio=None, observacao=None):
        ...
        self.validate_tpAvPrevioType(self.tpAvPrevio)
        self.observacao = observacao
        self.validate_observacaoType(self.observacao)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, detAvPrevioType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if detAvPrevioType.subclass:
            return detAvPrevioType.subclass(*args_, **kwargs_)
        else:
            return detAvPrevioType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_dtAvPrvType(self, value):
        # Validate type dtAvPrvType, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def validate_dtPrevDesligType(self, value):
        # Validate type dtPrevDesligType, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def validate_tpAvPrevioType(self, value):
        # Validate type tpAvPrevioType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tpAvPrevioType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_tpAvPrevioType_patterns_, ))
    validate_tpAvPrevioType_patterns_ = [['^\\d$']]
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='detAvPrevioType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('detAvPrevioType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='detAvPrevioType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='detAvPrevioType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='detAvPrevioType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='detAvPrevioType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.dtAvPrv is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtAvPrv>%s</dtAvPrv>%s' % (self.gds_format_date(self.dtAvPrv, input_name='dtAvPrv'), eol_))
        if self.dtPrevDeslig is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtPrevDeslig>%s</dtPrevDeslig>%s' % (self.gds_format_date(self.dtPrevDeslig, input_name='dtPrevDeslig'), eol_))
        if self.tpAvPrevio is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tpAvPrevio>%s</tpAvPrevio>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.tpAvPrevio), input_name='tpAvPrevio')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dtAvPrv':
            ...
            self.dtAvPrv = dval_
            # validate type dtAvPrvType
            self.validate_dtAvPrvType(self.dtAvPrv)
        elif nodeName_ == 'dtPrevDeslig':
            sval_ = child_.text
            dval_ = self.gds_parse_date(sval_)
            self.dtPrevDeslig = dval_
            # validate type dtPrevDesligType
            self.validate_dtPrevDesligType(self.dtPrevDeslig)
        elif nodeName_ == 'tpAvPrevio':
            tpAvPrevio_ = child_.text
            tpAvPrevio_ = self.gds_validate_string(tpAvPrevio_, node, 'tpAvPrevio')
            self.tpAvPrevio = tpAvPrevio_
            # validate type tpAvPrevioType
            self.validate_tpAvPrevioType(self.tpAvPrevio)
            ...
            self.validate_observacaoType(self.observacao)
# end class detAvPrevioType


class cancAvPrevioType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, dtCancAvPrv=None, observacao=None, mtvCancAvPrevio=None):
        ...
        self.validate_mtvCancAvPrevioType(self.mtvCancAvPrevio)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, cancAvPrevioType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if cancAvPrevioType.subclass:
            return cancAvPrevioType.subclass(*args_, **kwargs_)
        else:
            return cancAvPrevioType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_dtCancAvPrvType(self, value):
        # Validate type dtCancAvPrvType, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    ...
    def validate_mtvCancAvPrevioType(self, value):
        # Validate type mtvCancAvPrevioType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_mtvCancAvPrevioType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_mtvCancAvPrevioType_patterns_, ))
    validate_mtvCancAvPrevioType_patterns_ = [['^\\d$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='cancAvPrevioType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('cancAvPrevioType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='cancAvPrevioType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='cancAvPrevioType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='cancAvPrevioType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='cancAvPrevioType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.dtCancAvPrv is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtCancAvPrv>%s</dtCancAvPrv>%s' % (self.gds_format_date(self.dtCancAvPrv, input_name='dtCancAvPrv'), eol_))
        if self.observacao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<observacao>%s</observacao>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.observacao), input_name='observacao')), eol_))
        if self.mtvCancAvPrevio is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<mtvCancAvPrevio>%s</mtvCancAvPrevio>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.mtvCancAvPrevio), input_name='mtvCancAvPrevio')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dtCancAvPrv':
            ...
            # validate type dtCancAvPrvType
            self.validate_dtCancAvPrvType(self.dtCancAvPrv)
        elif nodeName_ == 'observacao':
            observacao_ = child_.text
            observacao_ = self.gds_validate_string(observacao_, node, 'observacao')
            self.observacao = observacao_
            ...
            mtvCancAvPrevio_ = child_.text
            mtvCancAvPrevio_ = self.gds_validate_string(mtvCancAvPrevio_, node, 'mtvCancAvPrevio')
            self.mtvCancAvPrevio = mtvCancAvPrevio_
            # validate type mtvCancAvPrevioType
            self.validate_mtvCancAvPrevioType(self.mtvCancAvPrevio)
# end class cancAvPrevioType

...
#   ('-o', 'classes/evtAvPrevio.py')
#   ('-s', 'classes/evtAvPrevioSub.py')
#   ('--super', 'evtAvPrevio')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtAvPrevio.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtAvPrevio.py" -s "classes/evtAvPrevioSub.py" --super="evtAvPrevio" /home/joao/Documents/teste_xsd/xsd/evtAvPrevio.xsd
#
...
import evtAvPrevio as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtAvPrevio=None, Signature=None):
        super(eSocialSub, self).__init__(evtAvPrevio, Signature, )
...
class evtAvPrevioTypeSub(supermod.evtAvPrevioType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, ideVinculo=None, infoAvPrevio=None):
        super(evtAvPrevioTypeSub, self).__init__(Id, ideEvento, ideEmpregador, ideVinculo, infoAvPrevio, )
supermod.evtAvPrevioType.subclass = evtAvPrevioTypeSub
# end class evtAvPrevioTypeSub


class infoAvPrevioTypeSub(supermod.infoAvPrevioType):
    def __init__(self, detAvPrevio=None, cancAvPrevio=None):
        super(infoAvPrevioTypeSub, self).__init__(detAvPrevio, cancAvPrevio, )
supermod.infoAvPrevioType.subclass = infoAvPrevioTypeSub
# end class infoAvPrevioTypeSub


class detAvPrevioTypeSub(supermod.detAvPrevioType):
    def __init__(self, dtAvPrv=None, dtPrevDeslig=None, tpAvPrevio=None, observacao=None):
        super(detAvPrevioTypeSub, self).__init__(dtAvPrv, dtPrevDeslig, tpAvPrevio, observacao, )
supermod.detAvPrevioType.subclass = detAvPrevioTypeSub
# end class detAvPrevioTypeSub


class cancAvPrevioTypeSub(supermod.cancAvPrevioType):
    def __init__(self, dtCancAvPrv=None, observacao=None, mtvCancAvPrevio=None):
        super(cancAvPrevioTypeSub, self).__init__(dtCancAvPrv, observacao, mtvCancAvPrevio, )
supermod.cancAvPrevioType.subclass = cancAvPrevioTypeSub
# end class cancAvPrevioTypeSub

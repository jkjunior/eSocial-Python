...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtBasesTrab is not None:
            self.evtBasesTrab.export(outfile, level, namespaceprefix_, name_='evtBasesTrab', pretty_print=pretty_print)
...
class evtBasesTrabType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtBasesTrabType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtBasesTrabType.subclass:
            return evtBasesTrabType.subclass(*args_, **kwargs_)
        else:
            return evtBasesTrabType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtBasesTrabType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtBasesTrabType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtBasesTrabType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtBasesTrabType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtBasesTrabType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtBasesTrabType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for infoCpCalc_ in self.infoCpCalc:
            infoCpCalc_.export(outfile, level, namespaceprefix_, name_='infoCpCalc', pretty_print=pretty_print)
        if self.infoCp is not None:
            self.infoCp.export(outfile, level, namespaceprefix_, name_='infoCp', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class infoCpCalcType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, tpCR=None, vrCpSeg=None, vrDescSeg=None):
        ...
        self.validate_vrDescSegType(self.vrDescSeg)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoCpCalcType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoCpCalcType.subclass:
            return infoCpCalcType.subclass(*args_, **kwargs_)
        else:
            return infoCpCalcType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_vrDescSegType(self, value):
        # Validate type vrDescSegType, a restriction on xs:decimal.
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 14:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on vrDescSegType' % {"value" : value} )
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoCpCalcType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoCpCalcType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoCpCalcType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoCpCalcType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoCpCalcType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoCpCalcType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.vrDescSeg is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<vrDescSeg>%s</vrDescSeg>%s' % (self.gds_format_float(self.vrDescSeg, input_name='vrDescSeg'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpCR' and child_.text:
            ...
            self.validate_vrCpSegType(self.vrCpSeg)
        elif nodeName_ == 'vrDescSeg' and child_.text:
            sval_ = child_.text
            try:
                fval_ = float(sval_)
            except (TypeError, ValueError) as exp:
            ...
            # validate type vrDescSegType
            self.validate_vrDescSegType(self.vrDescSeg)
# end class infoCpCalcType


class infoCpType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoCpType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoCpType.subclass:
            return infoCpType.subclass(*args_, **kwargs_)
        else:
            return infoCpType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoCpType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoCpType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoCpType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoCpType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoCpType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoCpType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ideEstabLotType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideEstabLotType', fromsubclass_=False, pretty_print=True):
        ...
        for infoCategIncid_ in self.infoCategIncid:
            infoCategIncid_.export(outfile, level, namespaceprefix_, name_='infoCategIncid', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpInsc':
            ...
            obj_ = infoCategIncidType.factory()
            obj_.build(child_)
...
class infoCategIncidType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoCategIncidType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoCategIncidType.subclass:
            return infoCategIncidType.subclass(*args_, **kwargs_)
        else:
            return infoCategIncidType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoCategIncidType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoCategIncidType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoCategIncidType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoCategIncidType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoCategIncidType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoCategIncidType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for infoBaseCS_ in self.infoBaseCS:
            infoBaseCS_.export(outfile, level, namespaceprefix_, name_='infoBaseCS', pretty_print=pretty_print)
        for calcTerc_ in self.calcTerc:
            calcTerc_.export(outfile, level, namespaceprefix_, name_='calcTerc', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'matricula':
            ...
            obj_ = infoBaseCSType.factory()
            obj_.build(child_)
            self.infoBaseCS.append(obj_)
            obj_.original_tagname_ = 'infoBaseCS'
        elif nodeName_ == 'calcTerc':
            obj_ = calcTercType.factory()
            obj_.build(child_)
            self.calcTerc.append(obj_)
            obj_.original_tagname_ = 'calcTerc'
# end class infoCategIncidType


class infoBaseCSType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, ind13=None, tpValor=None, valor=None):
        self.original_tagname_ = None
        self.ind13 = ind13
        self.validate_ind13Type(self.ind13)
        self.tpValor = tpValor
        self.validate_tpValorType(self.tpValor)
        self.valor = valor
        self.validate_valorType(self.valor)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoBaseCSType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoBaseCSType.subclass:
            return infoBaseCSType.subclass(*args_, **kwargs_)
        else:
            return infoBaseCSType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_ind13Type(self, value):
        # Validate type ind13Type, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_ind13Type_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_ind13Type_patterns_, ))
    validate_ind13Type_patterns_ = [['^\\d$']]
    def validate_tpValorType(self, value):
        # Validate type tpValorType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tpValorType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_tpValorType_patterns_, ))
    validate_tpValorType_patterns_ = [['^\\d{1,2}$']]
    def validate_valorType(self, value):
        # Validate type valorType, a restriction on xs:decimal.
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 14:
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoBaseCSType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoBaseCSType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoBaseCSType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoBaseCSType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoBaseCSType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoBaseCSType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.ind13 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ind13>%s</ind13>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ind13), input_name='ind13')), eol_))
        if self.tpValor is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tpValor>%s</tpValor>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.tpValor), input_name='tpValor')), eol_))
        if self.valor is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<valor>%s</valor>%s' % (self.gds_format_float(self.valor, input_name='valor'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ind13':
            ind13_ = child_.text
            ind13_ = self.gds_validate_string(ind13_, node, 'ind13')
            self.ind13 = ind13_
            # validate type ind13Type
            self.validate_ind13Type(self.ind13)
        elif nodeName_ == 'tpValor':
            tpValor_ = child_.text
            tpValor_ = self.gds_validate_string(tpValor_, node, 'tpValor')
            self.tpValor = tpValor_
            # validate type tpValorType
            self.validate_tpValorType(self.tpValor)
            ...
            self.validate_valorType(self.valor)
# end class infoBaseCSType


class calcTercType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, tpCR=None, vrCsSegTerc=None, vrDescTerc=None):
        self.original_tagname_ = None
        self.tpCR = tpCR
        self.validate_tpCRType1(self.tpCR)
        self.vrCsSegTerc = vrCsSegTerc
        self.validate_vrCsSegTercType(self.vrCsSegTerc)
        self.vrDescTerc = vrDescTerc
        self.validate_vrDescTercType(self.vrDescTerc)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, calcTercType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if calcTercType.subclass:
            return calcTercType.subclass(*args_, **kwargs_)
        else:
            return calcTercType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_tpCR(self): return self.tpCR
    def set_tpCR(self, tpCR): self.tpCR = tpCR
    ...
    def validate_tpCRType1(self, value):
        # Validate type tpCRType1, a restriction on xs:integer.
        if value is not None and Validate_simpletypes_:
            pass
    def validate_vrCsSegTercType(self, value):
        # Validate type vrCsSegTercType, a restriction on xs:decimal.
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 14:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on vrCsSegTercType' % {"value" : value} )
    def validate_vrDescTercType(self, value):
        # Validate type vrDescTercType, a restriction on xs:decimal.
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 14:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on vrDescTercType' % {"value" : value} )
    def hasContent_(self):
        if (
            self.tpCR is not None or
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='calcTercType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('calcTercType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='calcTercType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='calcTercType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='calcTercType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='calcTercType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.vrCsSegTerc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<vrCsSegTerc>%s</vrCsSegTerc>%s' % (self.gds_format_float(self.vrCsSegTerc, input_name='vrCsSegTerc'), eol_))
        if self.vrDescTerc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<vrDescTerc>%s</vrDescTerc>%s' % (self.gds_format_float(self.vrDescTerc, input_name='vrDescTerc'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpCR' and child_.text:
            ...
            ival_ = self.gds_validate_integer(ival_, node, 'tpCR')
            self.tpCR = ival_
            # validate type tpCRType1
            self.validate_tpCRType1(self.tpCR)
        elif nodeName_ == 'vrCsSegTerc' and child_.text:
            sval_ = child_.text
            try:
                fval_ = float(sval_)
            except (TypeError, ValueError) as exp:
            ...
            # validate type vrCsSegTercType
            self.validate_vrCsSegTercType(self.vrCsSegTerc)
        elif nodeName_ == 'vrDescTerc' and child_.text:
            sval_ = child_.text
            try:
                fval_ = float(sval_)
            except (TypeError, ValueError) as exp:
            ...
            # validate type vrDescTercType
            self.validate_vrDescTercType(self.vrDescTerc)
# end class calcTercType

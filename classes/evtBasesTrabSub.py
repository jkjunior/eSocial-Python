...
#   ('-o', 'classes/evtBasesTrab.py')
#   ('-s', 'classes/evtBasesTrabSub.py')
#   ('--super', 'evtBasesTrab')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtBasesTrab.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtBasesTrab.py" -s "classes/evtBasesTrabSub.py" --super="evtBasesTrab" /home/joao/Documents/teste_xsd/xsd/evtBasesTrab.xsd
#
...
import evtBasesTrab as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtBasesTrab=None, Signature=None):
        super(eSocialSub, self).__init__(evtBasesTrab, Signature, )
...
class evtBasesTrabTypeSub(supermod.evtBasesTrabType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, ideTrabalhador=None, infoCpCalc=None, infoCp=None):
        super(evtBasesTrabTypeSub, self).__init__(Id, ideEvento, ideEmpregador, ideTrabalhador, infoCpCalc, infoCp, )
supermod.evtBasesTrabType.subclass = evtBasesTrabTypeSub
# end class evtBasesTrabTypeSub


class ideEventoTypeSub(supermod.ideEventoType):
    def __init__(self, nrRecArqBase=None, indApuracao=None, perApur=None):
        super(ideEventoTypeSub, self).__init__(nrRecArqBase, indApuracao, perApur, )
...
class ideTrabalhadorTypeSub(supermod.ideTrabalhadorType):
    def __init__(self, cpfTrab=None, procJudTrab=None):
        super(ideTrabalhadorTypeSub, self).__init__(cpfTrab, procJudTrab, )
...
class procJudTrabTypeSub(supermod.procJudTrabType):
    def __init__(self, nrProcJud=None, codSusp=None):
        super(procJudTrabTypeSub, self).__init__(nrProcJud, codSusp, )
supermod.procJudTrabType.subclass = procJudTrabTypeSub
# end class procJudTrabTypeSub


class infoCpCalcTypeSub(supermod.infoCpCalcType):
    def __init__(self, tpCR=None, vrCpSeg=None, vrDescSeg=None):
        super(infoCpCalcTypeSub, self).__init__(tpCR, vrCpSeg, vrDescSeg, )
supermod.infoCpCalcType.subclass = infoCpCalcTypeSub
# end class infoCpCalcTypeSub


class infoCpTypeSub(supermod.infoCpType):
    def __init__(self, ideEstabLot=None):
        super(infoCpTypeSub, self).__init__(ideEstabLot, )
supermod.infoCpType.subclass = infoCpTypeSub
# end class infoCpTypeSub
...
class ideEstabLotTypeSub(supermod.ideEstabLotType):
    def __init__(self, tpInsc=None, nrInsc=None, codLotacao=None, infoCategIncid=None):
        super(ideEstabLotTypeSub, self).__init__(tpInsc, nrInsc, codLotacao, infoCategIncid, )
supermod.ideEstabLotType.subclass = ideEstabLotTypeSub
# end class ideEstabLotTypeSub


class infoCategIncidTypeSub(supermod.infoCategIncidType):
    def __init__(self, matricula=None, codCateg=None, indSimples=None, infoBaseCS=None, calcTerc=None):
        super(infoCategIncidTypeSub, self).__init__(matricula, codCateg, indSimples, infoBaseCS, calcTerc, )
supermod.infoCategIncidType.subclass = infoCategIncidTypeSub
# end class infoCategIncidTypeSub


class infoBaseCSTypeSub(supermod.infoBaseCSType):
    def __init__(self, ind13=None, tpValor=None, valor=None):
        super(infoBaseCSTypeSub, self).__init__(ind13, tpValor, valor, )
supermod.infoBaseCSType.subclass = infoBaseCSTypeSub
# end class infoBaseCSTypeSub


class calcTercTypeSub(supermod.calcTercType):
    def __init__(self, tpCR=None, vrCsSegTerc=None, vrDescTerc=None):
        super(calcTercTypeSub, self).__init__(tpCR, vrCsSegTerc, vrDescTerc, )
supermod.calcTercType.subclass = calcTercTypeSub
# end class calcTercTypeSub

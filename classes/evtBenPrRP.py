...
class eSocial(GeneratedsSuper):
    ...
    def get_evtBenPrRP(self): return self.evtBenPrRP
    def set_evtBenPrRP(self, evtBenPrRP): self.evtBenPrRP = evtBenPrRP
    def get_Signature(self): return self.Signature
    def set_Signature(self, Signature): self.Signature = Signature
    def hasContent_(self):
        if (
            self.evtBenPrRP is not None or
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            ...
            eol_ = ''
        if self.evtBenPrRP is not None:
            self.evtBenPrRP.export(outfile, level, namespaceprefix_, name_='evtBenPrRP', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'evtBenPrRP':
            obj_ = evtBenPrRPType.factory()
            obj_.build(child_)
            self.evtBenPrRP = obj_
            obj_.original_tagname_ = 'evtBenPrRP'
...
class evtBenPrRPType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtBenPrRPType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtBenPrRPType.subclass:
            return evtBenPrRPType.subclass(*args_, **kwargs_)
        else:
            return evtBenPrRPType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtBenPrRPType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtBenPrRPType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtBenPrRPType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtBenPrRPType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtBenPrRPType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtBenPrRPType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class dmDevType(GeneratedsSuper):
    ...
    def get_itens(self): return self.itens
    def set_itens(self, itens): self.itens = itens
    def add_itens(self, value): self.itens.append(value)
    def insert_itens_at(self, index, value): self.itens.insert(index, value)
    def replace_itens_at(self, index, value): self.itens[index] = value
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='dmDevType', fromsubclass_=False, pretty_print=True):
        ...
        for itens_ in self.itens:
            itens_.export(outfile, level, namespaceprefix_, name_='itens', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpBenef':
            ...
            obj_ = itensType.factory()
            obj_.build(child_)
            self.itens.append(obj_)
            obj_.original_tagname_ = 'itens'
# end class dmDevType


class itensType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, itensType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if itensType.subclass:
            return itensType.subclass(*args_, **kwargs_)
        else:
            return itensType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='itensType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('itensType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='itensType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='itensType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='itensType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='itensType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''

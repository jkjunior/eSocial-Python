...
#   ('-o', 'classes/evtBenPrRP.py')
#   ('-s', 'classes/evtBenPrRPSub.py')
#   ('--super', 'evtBenPrRP')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtBenPrRP.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtBenPrRP.py" -s "classes/evtBenPrRPSub.py" --super="evtBenPrRP" /home/joao/Documents/teste_xsd/xsd/evtBenPrRP.xsd
#
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtBenPrRP=None, Signature=None):
        super(eSocialSub, self).__init__(evtBenPrRP, Signature, )
...
class evtBenPrRPTypeSub(supermod.evtBenPrRPType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, ideBenef=None, dmDev=None):
        super(evtBenPrRPTypeSub, self).__init__(Id, ideEvento, ideEmpregador, ideBenef, dmDev, )
supermod.evtBenPrRPType.subclass = evtBenPrRPTypeSub
# end class evtBenPrRPTypeSub


class ideBenefTypeSub(supermod.ideBenefType):
    def __init__(self, cpfBenef=None):
        super(ideBenefTypeSub, self).__init__(cpfBenef, )
supermod.ideBenefType.subclass = ideBenefTypeSub
# end class ideBenefTypeSub


class dmDevTypeSub(supermod.dmDevType):
    def __init__(self, tpBenef=None, nrBenefic=None, ideDmDev=None, itens=None):
        super(dmDevTypeSub, self).__init__(tpBenef, nrBenefic, ideDmDev, itens, )
supermod.dmDevType.subclass = dmDevTypeSub
# end class dmDevTypeSub


class itensTypeSub(supermod.itensType):
    def __init__(self, codRubr=None, ideTabRubr=None, vrRubr=None):
        super(itensTypeSub, self).__init__(codRubr, ideTabRubr, vrRubr, )
supermod.itensType.subclass = itensTypeSub
# end class itensTypeSub
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from evtBenPrRP import *\n\n')
        sys.stdout.write('import evtBenPrRP as model_\n\n')

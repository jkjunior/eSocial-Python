...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtCdBenPrRP is not None:
            self.evtCdBenPrRP.export(outfile, level, namespaceprefix_, name_='evtCdBenPrRP', pretty_print=pretty_print)
...
class TEmprPJ(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TEmprPJ', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TEmprPJ')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TEmprPJ', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TEmprPJ'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TEmprPJ', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TDadosBenef(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TDadosBenef', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TDadosBenef')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TDadosBenef', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TDadosBenef'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TDadosBenef', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.dadosNasc is not None:
            self.dadosNasc.export(outfile, level, namespaceprefix_, name_='dadosNasc', pretty_print=pretty_print)
...
class TEnderecoExterior(GeneratedsSuper):
    ...
    def __init__(self, paisResid=None, dscLograd=None, nrLograd=None, complemento=None, bairro=None, nmCid=None, codPostal=None):
        ...
        self.dscLograd = dscLograd
        self.validate_dscLogradType3(self.dscLograd)
        self.nrLograd = nrLograd
        self.validate_nrLogradType4(self.nrLograd)
        self.complemento = complemento
        self.validate_complementoType5(self.complemento)
        self.bairro = bairro
    ...
    def validate_dscLogradType3(self, value):
        # Validate type dscLogradType3, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 100:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on dscLogradType3' % {"value" : value.encode("utf-8")} )
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on dscLogradType3' % {"value" : value.encode("utf-8")} )
    def validate_nrLogradType4(self, value):
        # Validate type nrLogradType4, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 10:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on nrLogradType4' % {"value" : value.encode("utf-8")} )
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on nrLogradType4' % {"value" : value.encode("utf-8")} )
    def validate_complementoType5(self, value):
        # Validate type complementoType5, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 30:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on complementoType5' % {"value" : value.encode("utf-8")} )
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'paisResid':
            ...
            dscLograd_ = self.gds_validate_string(dscLograd_, node, 'dscLograd')
            self.dscLograd = dscLograd_
            # validate type dscLogradType3
            self.validate_dscLogradType3(self.dscLograd)
        elif nodeName_ == 'nrLograd':
            nrLograd_ = child_.text
            nrLograd_ = self.gds_validate_string(nrLograd_, node, 'nrLograd')
            self.nrLograd = nrLograd_
            # validate type nrLogradType4
            self.validate_nrLogradType4(self.nrLograd)
        elif nodeName_ == 'complemento':
            complemento_ = child_.text
            complemento_ = self.gds_validate_string(complemento_, node, 'complemento')
            self.complemento = complemento_
            # validate type complementoType5
            self.validate_complementoType5(self.complemento)
        elif nodeName_ == 'bairro':
            bairro_ = child_.text
            bairro_ = self.gds_validate_string(bairro_, node, 'bairro')
...
class TDadosBeneficio(GeneratedsSuper):
    ...
    def __init__(self, tpBenef=None, nrBenefic=None, dtIniBenef=None, vrBenef=None, infoPenMorte=None):
        ...
        self.validate_tpBenefType7(self.tpBenef)
        self.nrBenefic = nrBenefic
        self.validate_nrBeneficType8(self.nrBenefic)
        ...
        self.validate_vrBenefType(self.vrBenef)
    ...
    def validate_tpBenefType7(self, value):
        # Validate type tpBenefType7, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tpBenefType7_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_tpBenefType7_patterns_, ))
    validate_tpBenefType7_patterns_ = [['^\\d{1,2}$']]
    def validate_nrBeneficType8(self, value):
        # Validate type nrBeneficType8, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 20:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on nrBeneficType8' % {"value" : value.encode("utf-8")} )
            if len(value) < 3:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on nrBeneficType8' % {"value" : value.encode("utf-8")} )
    def validate_dtIniBenefType(self, value):
        # Validate type dtIniBenefType, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def validate_vrBenefType(self, value):
        # Validate type vrBenefType, a restriction on xs:decimal.
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 14:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on vrBenefType' % {"value" : value} )
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TDadosBeneficio', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TDadosBeneficio')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TDadosBeneficio', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TDadosBeneficio'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TDadosBeneficio', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.tpBenef is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tpBenef>%s</tpBenef>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.tpBenef), input_name='tpBenef')), eol_))
        if self.nrBenefic is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nrBenefic>%s</nrBenefic>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.nrBenefic), input_name='nrBenefic')), eol_))
        if self.dtIniBenef is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtIniBenef>%s</dtIniBenef>%s' % (self.gds_format_date(self.dtIniBenef, input_name='dtIniBenef'), eol_))
        if self.vrBenef is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<vrBenef>%s</vrBenef>%s' % (self.gds_format_float(self.vrBenef, input_name='vrBenef'), eol_))
        if self.infoPenMorte is not None:
            self.infoPenMorte.export(outfile, level, namespaceprefix_, name_='infoPenMorte', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpBenef':
            tpBenef_ = child_.text
            tpBenef_ = self.gds_validate_string(tpBenef_, node, 'tpBenef')
            self.tpBenef = tpBenef_
            # validate type tpBenefType7
            self.validate_tpBenefType7(self.tpBenef)
            ...
            # validate type nrBeneficType8
            self.validate_nrBeneficType8(self.nrBenefic)
        elif nodeName_ == 'dtIniBenef':
            sval_ = child_.text
            dval_ = self.gds_parse_date(sval_)
            self.dtIniBenef = dval_
            # validate type dtIniBenefType
            self.validate_dtIniBenefType(self.dtIniBenef)
        elif nodeName_ == 'vrBenef' and child_.text:
            sval_ = child_.text
            try:
                fval_ = float(sval_)
            except (TypeError, ValueError) as exp:
            ...
            self.vrBenef = fval_
            # validate type vrBenefType
            self.validate_vrBenefType(self.vrBenef)
        elif nodeName_ == 'infoPenMorte':
            obj_ = infoPenMorteType.factory()
            obj_.build(child_)
...
class evtCdBenPrRPType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtCdBenPrRPType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtCdBenPrRPType.subclass:
            return evtCdBenPrRPType.subclass(*args_, **kwargs_)
        else:
            return evtCdBenPrRPType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtCdBenPrRPType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtCdBenPrRPType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtCdBenPrRPType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtCdBenPrRPType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtCdBenPrRPType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtCdBenPrRPType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoBeneficio is not None:
            self.infoBeneficio.export(outfile, level, namespaceprefix_, name_='infoBeneficio', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class ideBenefType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideBenefType', fromsubclass_=False, pretty_print=True):
        ...
        if self.dadosBenef is not None:
            self.dadosBenef.export(outfile, level, namespaceprefix_, name_='dadosBenef', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class infoBeneficioType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoBeneficioType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoBeneficioType.subclass:
            return infoBeneficioType.subclass(*args_, **kwargs_)
        else:
            return infoBeneficioType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoBeneficioType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoBeneficioType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoBeneficioType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoBeneficioType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoBeneficioType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoBeneficioType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.iniBeneficio is not None:
            self.iniBeneficio.export(outfile, level, namespaceprefix_, name_='iniBeneficio', pretty_print=pretty_print)
        if self.altBeneficio is not None:
            self.altBeneficio.export(outfile, level, namespaceprefix_, name_='altBeneficio', pretty_print=pretty_print)
        if self.fimBeneficio is not None:
            self.fimBeneficio.export(outfile, level, namespaceprefix_, name_='fimBeneficio', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpPlanRP':
            ...
            obj_ = fimBeneficioType.factory()
            obj_.build(child_)
            self.fimBeneficio = obj_
            obj_.original_tagname_ = 'fimBeneficio'
# end class infoBeneficioType


class fimBeneficioType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, tpBenef=None, nrBenefic=None, dtFimBenef=None, mtvFim=None):
        self.original_tagname_ = None
        self.tpBenef = tpBenef
        self.validate_tpBenefType(self.tpBenef)
        self.nrBenefic = nrBenefic
        self.validate_nrBeneficType(self.nrBenefic)
        ...
        self.mtvFim = mtvFim
        self.validate_mtvFimType(self.mtvFim)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, fimBeneficioType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if fimBeneficioType.subclass:
            return fimBeneficioType.subclass(*args_, **kwargs_)
        else:
            return fimBeneficioType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_tpBenef(self): return self.tpBenef
    def set_tpBenef(self, tpBenef): self.tpBenef = tpBenef
    def get_nrBenefic(self): return self.nrBenefic
    ...
    def validate_tpBenefType(self, value):
        # Validate type tpBenefType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tpBenefType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_tpBenefType_patterns_, ))
    validate_tpBenefType_patterns_ = [['^\\d{1,2}$']]
    def validate_nrBeneficType(self, value):
        # Validate type nrBeneficType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 20:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on nrBeneficType' % {"value" : value.encode("utf-8")} )
            if len(value) < 3:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on nrBeneficType' % {"value" : value.encode("utf-8")} )
    def validate_dtFimBenefType(self, value):
        # Validate type dtFimBenefType, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def validate_mtvFimType(self, value):
        # Validate type mtvFimType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_mtvFimType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_mtvFimType_patterns_, ))
    validate_mtvFimType_patterns_ = [['^\\d{1,2}$']]
    def hasContent_(self):
        if (
            self.tpBenef is not None or
            self.nrBenefic is not None or
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='fimBeneficioType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('fimBeneficioType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='fimBeneficioType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='fimBeneficioType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='fimBeneficioType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='fimBeneficioType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.dtFimBenef is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtFimBenef>%s</dtFimBenef>%s' % (self.gds_format_date(self.dtFimBenef, input_name='dtFimBenef'), eol_))
        if self.mtvFim is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<mtvFim>%s</mtvFim>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.mtvFim), input_name='mtvFim')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpBenef':
            ...
            tpBenef_ = self.gds_validate_string(tpBenef_, node, 'tpBenef')
            self.tpBenef = tpBenef_
            # validate type tpBenefType
            self.validate_tpBenefType(self.tpBenef)
        elif nodeName_ == 'nrBenefic':
            nrBenefic_ = child_.text
            nrBenefic_ = self.gds_validate_string(nrBenefic_, node, 'nrBenefic')
            self.nrBenefic = nrBenefic_
            # validate type nrBeneficType
            self.validate_nrBeneficType(self.nrBenefic)
        elif nodeName_ == 'dtFimBenef':
            sval_ = child_.text
            dval_ = self.gds_parse_date(sval_)
            self.dtFimBenef = dval_
            # validate type dtFimBenefType
            self.validate_dtFimBenefType(self.dtFimBenef)
        elif nodeName_ == 'mtvFim':
            mtvFim_ = child_.text
            mtvFim_ = self.gds_validate_string(mtvFim_, node, 'mtvFim')
            self.mtvFim = mtvFim_
            # validate type mtvFimType
            self.validate_mtvFimType(self.mtvFim)
# end class fimBeneficioType


class dadosNascType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, dadosNascType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if dadosNascType.subclass:
            return dadosNascType.subclass(*args_, **kwargs_)
        else:
            return dadosNascType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='dadosNascType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('dadosNascType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='dadosNascType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='dadosNascType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='dadosNascType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='dadosNascType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infoPenMorteType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, idQuota=None, cpfInst=None):
        self.original_tagname_ = None
        self.idQuota = idQuota
        self.validate_idQuotaType(self.idQuota)
        self.cpfInst = cpfInst
        self.validate_cpfInstType(self.cpfInst)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoPenMorteType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoPenMorteType.subclass:
            return infoPenMorteType.subclass(*args_, **kwargs_)
        else:
            return infoPenMorteType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_idQuotaType(self, value):
        # Validate type idQuotaType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 30:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on idQuotaType' % {"value" : value.encode("utf-8")} )
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on idQuotaType' % {"value" : value.encode("utf-8")} )
    def validate_cpfInstType(self, value):
        # Validate type cpfInstType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_cpfInstType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_cpfInstType_patterns_, ))
    validate_cpfInstType_patterns_ = [['^\\d{11}$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoPenMorteType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoPenMorteType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoPenMorteType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoPenMorteType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoPenMorteType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoPenMorteType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.idQuota is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<idQuota>%s</idQuota>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.idQuota), input_name='idQuota')), eol_))
        if self.cpfInst is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<cpfInst>%s</cpfInst>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.cpfInst), input_name='cpfInst')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:

...
#   ('-o', 'classes/evtCdBenPrRP.py')
#   ('-s', 'classes/evtCdBenPrRPSub.py')
#   ('--super', 'evtCdBenPrRP')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtCdBenPrRP.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtCdBenPrRP.py" -s "classes/evtCdBenPrRPSub.py" --super="evtCdBenPrRP" /home/joao/Documents/teste_xsd/xsd/evtCdBenPrRP.xsd
#
...
import evtCdBenPrRP as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtCdBenPrRP=None, Signature=None):
        super(eSocialSub, self).__init__(evtCdBenPrRP, Signature, )
...
class TDadosBenefSub(supermod.TDadosBenef):
    def __init__(self, dadosNasc=None, endereco=None):
        super(TDadosBenefSub, self).__init__(dadosNasc, endereco, )
supermod.TDadosBenef.subclass = TDadosBenefSub
# end class TDadosBenefSub
...
class TDadosBeneficioSub(supermod.TDadosBeneficio):
    def __init__(self, tpBenef=None, nrBenefic=None, dtIniBenef=None, vrBenef=None, infoPenMorte=None):
        super(TDadosBeneficioSub, self).__init__(tpBenef, nrBenefic, dtIniBenef, vrBenef, infoPenMorte, )
supermod.TDadosBeneficio.subclass = TDadosBeneficioSub
# end class TDadosBeneficioSub
...
class evtCdBenPrRPTypeSub(supermod.evtCdBenPrRPType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, ideBenef=None, infoBeneficio=None):
        super(evtCdBenPrRPTypeSub, self).__init__(Id, ideEvento, ideEmpregador, ideBenef, infoBeneficio, )
supermod.evtCdBenPrRPType.subclass = evtCdBenPrRPTypeSub
# end class evtCdBenPrRPTypeSub


class ideBenefTypeSub(supermod.ideBenefType):
    def __init__(self, cpfBenef=None, nmBenefic=None, dadosBenef=None):
        super(ideBenefTypeSub, self).__init__(cpfBenef, nmBenefic, dadosBenef, )
supermod.ideBenefType.subclass = ideBenefTypeSub
# end class ideBenefTypeSub


class infoBeneficioTypeSub(supermod.infoBeneficioType):
    def __init__(self, tpPlanRP=None, iniBeneficio=None, altBeneficio=None, fimBeneficio=None):
        super(infoBeneficioTypeSub, self).__init__(tpPlanRP, iniBeneficio, altBeneficio, fimBeneficio, )
supermod.infoBeneficioType.subclass = infoBeneficioTypeSub
# end class infoBeneficioTypeSub


class fimBeneficioTypeSub(supermod.fimBeneficioType):
    def __init__(self, tpBenef=None, nrBenefic=None, dtFimBenef=None, mtvFim=None):
        super(fimBeneficioTypeSub, self).__init__(tpBenef, nrBenefic, dtFimBenef, mtvFim, )
supermod.fimBeneficioType.subclass = fimBeneficioTypeSub
# end class fimBeneficioTypeSub


class dadosNascTypeSub(supermod.dadosNascType):
    def __init__(self, dtNascto=None, codMunic=None, uf=None, paisNascto=None, paisNac=None, nmMae=None, nmPai=None):
        super(dadosNascTypeSub, self).__init__(dtNascto, codMunic, uf, paisNascto, paisNac, nmMae, nmPai, )
supermod.dadosNascType.subclass = dadosNascTypeSub
# end class dadosNascTypeSub
...
class infoPenMorteTypeSub(supermod.infoPenMorteType):
    def __init__(self, idQuota=None, cpfInst=None):
        super(infoPenMorteTypeSub, self).__init__(idQuota, cpfInst, )
supermod.infoPenMorteType.subclass = infoPenMorteTypeSub
# end class infoPenMorteTypeSub

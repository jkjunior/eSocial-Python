...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtComProd is not None:
            self.evtComProd.export(outfile, level, namespaceprefix_, name_='evtComProd', pretty_print=pretty_print)
...
class evtComProdType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtComProdType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtComProdType.subclass:
            return evtComProdType.subclass(*args_, **kwargs_)
        else:
            return evtComProdType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtComProdType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtComProdType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtComProdType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtComProdType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtComProdType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtComProdType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoComProd is not None:
            self.infoComProd.export(outfile, level, namespaceprefix_, name_='infoComProd', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class ideEmpregadorType(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ideEmpregadorType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ideEmpregadorType.subclass:
            return ideEmpregadorType.subclass(*args_, **kwargs_)
        else:
            return ideEmpregadorType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='ideEmpregadorType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ideEmpregadorType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ideEmpregadorType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='ideEmpregadorType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ideEmpregadorType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideEmpregadorType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpInsc':
            ...
            self.validate_nrInscType(self.nrInsc)
# end class ideEmpregadorType


class infoComProdType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoComProdType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoComProdType.subclass:
            return infoComProdType.subclass(*args_, **kwargs_)
        else:
            return infoComProdType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoComProdType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoComProdType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoComProdType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoComProdType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoComProdType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoComProdType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.ideEstabel is not None:
            self.ideEstabel.export(outfile, level, namespaceprefix_, name_='ideEstabel', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ideEstabel':
            obj_ = ideEstabelType.factory()
            obj_.build(child_)
            self.ideEstabel = obj_
            obj_.original_tagname_ = 'ideEstabel'
# end class infoComProdType


class ideEstabelType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, nrInscEstabRural=None, tpComerc=None):
        self.original_tagname_ = None
        self.nrInscEstabRural = nrInscEstabRural
        self.validate_nrInscEstabRuralType(self.nrInscEstabRural)
        if tpComerc is None:
            self.tpComerc = []
        else:
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ideEstabelType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ideEstabelType.subclass:
            return ideEstabelType.subclass(*args_, **kwargs_)
        else:
            return ideEstabelType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_nrInscEstabRuralType(self, value):
        # Validate type nrInscEstabRuralType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_nrInscEstabRuralType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_nrInscEstabRuralType_patterns_, ))
    validate_nrInscEstabRuralType_patterns_ = [['^\\d{11,15}$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='ideEstabelType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ideEstabelType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ideEstabelType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='ideEstabelType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ideEstabelType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideEstabelType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.nrInscEstabRural is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nrInscEstabRural>%s</nrInscEstabRural>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.nrInscEstabRural), input_name='nrInscEstabRural')), eol_))
        for tpComerc_ in self.tpComerc:
            tpComerc_.export(outfile, level, namespaceprefix_, name_='tpComerc', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'nrInscEstabRural':
            ...
            # validate type nrInscEstabRuralType
            self.validate_nrInscEstabRuralType(self.nrInscEstabRural)
        elif nodeName_ == 'tpComerc':
            obj_ = tpComercType.factory()
            obj_.build(child_)
            self.tpComerc.append(obj_)
            obj_.original_tagname_ = 'tpComerc'
# end class ideEstabelType


class tpComercType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, indComerc=None, vrTotCom=None, ideAdquir=None, infoProcJud=None):
        ...
        self.validate_vrTotComType(self.vrTotCom)
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, tpComercType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if tpComercType.subclass:
            return tpComercType.subclass(*args_, **kwargs_)
        else:
            return tpComercType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_vrTotComType(self, value):
        # Validate type vrTotComType, a restriction on xs:decimal.
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 14:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on vrTotComType' % {"value" : value} )
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='tpComercType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('tpComercType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='tpComercType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='tpComercType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='tpComercType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='tpComercType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.vrTotCom is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<vrTotCom>%s</vrTotCom>%s' % (self.gds_format_float(self.vrTotCom, input_name='vrTotCom'), eol_))
        for ideAdquir_ in self.ideAdquir:
            ideAdquir_.export(outfile, level, namespaceprefix_, name_='ideAdquir', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'indComerc':
            ...
            self.validate_indComercType(self.indComerc)
        elif nodeName_ == 'vrTotCom' and child_.text:
            sval_ = child_.text
            try:
                fval_ = float(sval_)
            except (TypeError, ValueError) as exp:
            ...
            self.vrTotCom = fval_
            # validate type vrTotComType
            self.validate_vrTotComType(self.vrTotCom)
        elif nodeName_ == 'ideAdquir':
            obj_ = ideAdquirType.factory()
            obj_.build(child_)
...
# end class tpComercType


class ideAdquirType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, tpInsc=None, nrInsc=None, vrComerc=None, nfs=None):
        ...
        self.validate_vrComercType(self.vrComerc)
        if nfs is None:
            self.nfs = []
        else:
            self.nfs = nfs
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ideAdquirType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ideAdquirType.subclass:
            return ideAdquirType.subclass(*args_, **kwargs_)
        else:
            return ideAdquirType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_tpInsc(self): return self.tpInsc
    def set_tpInsc(self, tpInsc): self.tpInsc = tpInsc
    def get_nrInsc(self): return self.nrInsc
    ...
    def validate_vrComercType(self, value):
        # Validate type vrComercType, a restriction on xs:decimal.
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 14:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on vrComercType' % {"value" : value} )
    def hasContent_(self):
        if (
            self.tpInsc is not None or
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='ideAdquirType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ideAdquirType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ideAdquirType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='ideAdquirType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ideAdquirType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideAdquirType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.vrComerc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<vrComerc>%s</vrComerc>%s' % (self.gds_format_float(self.vrComerc, input_name='vrComerc'), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpInsc':
            ...
            self.validate_nrInscType2(self.nrInsc)
        elif nodeName_ == 'vrComerc' and child_.text:
            sval_ = child_.text
            try:
                fval_ = float(sval_)
            except (TypeError, ValueError) as exp:

...
#   ('-o', 'classes/evtComProd.py')
#   ('-s', 'classes/evtComProdSub.py')
#   ('--super', 'evtComProd')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtComProd.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtComProd.py" -s "classes/evtComProdSub.py" --super="evtComProd" /home/joao/Documents/teste_xsd/xsd/evtComProd.xsd
#
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtComProd=None, Signature=None):
        super(eSocialSub, self).__init__(evtComProd, Signature, )
...
class evtComProdTypeSub(supermod.evtComProdType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, infoComProd=None):
        super(evtComProdTypeSub, self).__init__(Id, ideEvento, ideEmpregador, infoComProd, )
supermod.evtComProdType.subclass = evtComProdTypeSub
# end class evtComProdTypeSub


class ideEmpregadorTypeSub(supermod.ideEmpregadorType):
    def __init__(self, tpInsc=None, nrInsc=None):
        super(ideEmpregadorTypeSub, self).__init__(tpInsc, nrInsc, )
supermod.ideEmpregadorType.subclass = ideEmpregadorTypeSub
# end class ideEmpregadorTypeSub


class infoComProdTypeSub(supermod.infoComProdType):
    def __init__(self, ideEstabel=None):
        super(infoComProdTypeSub, self).__init__(ideEstabel, )
supermod.infoComProdType.subclass = infoComProdTypeSub
# end class infoComProdTypeSub


class ideEstabelTypeSub(supermod.ideEstabelType):
    def __init__(self, nrInscEstabRural=None, tpComerc=None):
        super(ideEstabelTypeSub, self).__init__(nrInscEstabRural, tpComerc, )
supermod.ideEstabelType.subclass = ideEstabelTypeSub
# end class ideEstabelTypeSub


class tpComercTypeSub(supermod.tpComercType):
    def __init__(self, indComerc=None, vrTotCom=None, ideAdquir=None, infoProcJud=None):
        super(tpComercTypeSub, self).__init__(indComerc, vrTotCom, ideAdquir, infoProcJud, )
supermod.tpComercType.subclass = tpComercTypeSub
# end class tpComercTypeSub


class ideAdquirTypeSub(supermod.ideAdquirType):
    def __init__(self, tpInsc=None, nrInsc=None, vrComerc=None, nfs=None):
        super(ideAdquirTypeSub, self).__init__(tpInsc, nrInsc, vrComerc, nfs, )
supermod.ideAdquirType.subclass = ideAdquirTypeSub
# end class ideAdquirTypeSub


class nfsTypeSub(supermod.nfsType):
    def __init__(self, serie=None, nrDocto=None, dtEmisNF=None, vlrBruto=None, vrCPDescPR=None, vrRatDescPR=None, vrSenarDesc=None):
        super(nfsTypeSub, self).__init__(serie, nrDocto, dtEmisNF, vlrBruto, vrCPDescPR, vrRatDescPR, vrSenarDesc, )
supermod.nfsType.subclass = nfsTypeSub
# end class nfsTypeSub


class infoProcJudTypeSub(supermod.infoProcJudType):
    def __init__(self, tpProc=None, nrProc=None, codSusp=None, vrCPSusp=None, vrRatSusp=None, vrSenarSusp=None):
        super(infoProcJudTypeSub, self).__init__(tpProc, nrProc, codSusp, vrCPSusp, vrRatSusp, vrSenarSusp, )
supermod.infoProcJudType.subclass = infoProcJudTypeSub
# end class infoProcJudTypeSub

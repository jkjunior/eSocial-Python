...
class eSocial(GeneratedsSuper):
    ...
    def __init__(self, evtContrSindPatr=None, Signature=None):
        ...
        self.evtContrSindPatr = evtContrSindPatr
    ...
    def get_evtContrSindPatr(self): return self.evtContrSindPatr
    def set_evtContrSindPatr(self, evtContrSindPatr): self.evtContrSindPatr = evtContrSindPatr
    def get_Signature(self): return self.Signature
    def set_Signature(self, Signature): self.Signature = Signature
    def hasContent_(self):
        if (
            self.evtContrSindPatr is not None or
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            ...
            eol_ = ''
        if self.evtContrSindPatr is not None:
            self.evtContrSindPatr.export(outfile, level, namespaceprefix_, name_='evtContrSindPatr', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'evtContrSindPatr':
            obj_ = evtContrSindPatrType.factory()
            obj_.build(child_)
            self.evtContrSindPatr = obj_
            obj_.original_tagname_ = 'evtContrSindPatr'
...
class evtContrSindPatrType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, contribSind=None):
        ...
        if contribSind is None:
            self.contribSind = []
        else:
            self.contribSind = contribSind
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtContrSindPatrType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtContrSindPatrType.subclass:
            return evtContrSindPatrType.subclass(*args_, **kwargs_)
        else:
            return evtContrSindPatrType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def get_contribSind(self): return self.contribSind
    def set_contribSind(self, contribSind): self.contribSind = contribSind
    def add_contribSind(self, value): self.contribSind.append(value)
    def insert_contribSind_at(self, index, value): self.contribSind.insert(index, value)
    def replace_contribSind_at(self, index, value): self.contribSind[index] = value
    def get_Id(self): return self.Id
    def set_Id(self, Id): self.Id = Id
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtContrSindPatrType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtContrSindPatrType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtContrSindPatrType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtContrSindPatrType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtContrSindPatrType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtContrSindPatrType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for contribSind_ in self.contribSind:
            contribSind_.export(outfile, level, namespaceprefix_, name_='contribSind', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'contribSind':
            obj_ = contribSindType.factory()
            obj_.build(child_)
            self.contribSind.append(obj_)
            obj_.original_tagname_ = 'contribSind'
# end class evtContrSindPatrType
...
class contribSindType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, cnpjSindic=None, tpContribSind=None, vlrContribSind=None):
        self.original_tagname_ = None
        self.cnpjSindic = cnpjSindic
        self.validate_cnpjSindicType(self.cnpjSindic)
        self.tpContribSind = tpContribSind
        self.validate_tpContribSindType(self.tpContribSind)
        self.vlrContribSind = vlrContribSind
        self.validate_vlrContribSindType(self.vlrContribSind)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, contribSindType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if contribSindType.subclass:
            return contribSindType.subclass(*args_, **kwargs_)
        else:
            return contribSindType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_cnpjSindic(self): return self.cnpjSindic
    def set_cnpjSindic(self, cnpjSindic): self.cnpjSindic = cnpjSindic
    def get_tpContribSind(self): return self.tpContribSind
    def set_tpContribSind(self, tpContribSind): self.tpContribSind = tpContribSind
    def get_vlrContribSind(self): return self.vlrContribSind
    def set_vlrContribSind(self, vlrContribSind): self.vlrContribSind = vlrContribSind
    def validate_cnpjSindicType(self, value):
        # Validate type cnpjSindicType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_cnpjSindicType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_cnpjSindicType_patterns_, ))
    validate_cnpjSindicType_patterns_ = [['^\\d{8,14}$']]
    def validate_tpContribSindType(self, value):
        # Validate type tpContribSindType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tpContribSindType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_tpContribSindType_patterns_, ))
    validate_tpContribSindType_patterns_ = [['^\\d$']]
    def validate_vlrContribSindType(self, value):
        # Validate type vlrContribSindType, a restriction on xs:decimal.
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 14:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on vlrContribSindType' % {"value" : value} )
    def hasContent_(self):
        if (
            self.cnpjSindic is not None or
            self.tpContribSind is not None or
            self.vlrContribSind is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='contribSindType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('contribSindType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='contribSindType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='contribSindType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='contribSindType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='contribSindType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.cnpjSindic is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<cnpjSindic>%s</cnpjSindic>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.cnpjSindic), input_name='cnpjSindic')), eol_))
        if self.tpContribSind is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tpContribSind>%s</tpContribSind>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.tpContribSind), input_name='tpContribSind')), eol_))
        if self.vlrContribSind is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<vlrContribSind>%s</vlrContribSind>%s' % (self.gds_format_float(self.vlrContribSind, input_name='vlrContribSind'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'cnpjSindic':
            cnpjSindic_ = child_.text
            cnpjSindic_ = self.gds_validate_string(cnpjSindic_, node, 'cnpjSindic')
            self.cnpjSindic = cnpjSindic_
            # validate type cnpjSindicType
            self.validate_cnpjSindicType(self.cnpjSindic)
        elif nodeName_ == 'tpContribSind':
            tpContribSind_ = child_.text
            tpContribSind_ = self.gds_validate_string(tpContribSind_, node, 'tpContribSind')
            self.tpContribSind = tpContribSind_
            # validate type tpContribSindType
            self.validate_tpContribSindType(self.tpContribSind)
        elif nodeName_ == 'vlrContribSind' and child_.text:
            sval_ = child_.text
            try:
                fval_ = float(sval_)
            except (TypeError, ValueError) as exp:
                raise_parse_error(child_, 'requires float or double: %s' % exp)
            fval_ = self.gds_validate_float(fval_, node, 'vlrContribSind')
            self.vlrContribSind = fval_
            # validate type vlrContribSindType
            self.validate_vlrContribSindType(self.vlrContribSind)
# end class contribSindType

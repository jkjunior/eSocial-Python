...
#   ('-o', 'classes/evtContrSindPatr.py')
#   ('-s', 'classes/evtContrSindPatrSub.py')
#   ('--super', 'evtContrSindPatr')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtContrSindPatr.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtContrSindPatr.py" -s "classes/evtContrSindPatrSub.py" --super="evtContrSindPatr" /home/joao/Documents/teste_xsd/xsd/evtContrSindPatr.xsd
#
...
import evtContrSindPatr as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtContrSindPatr=None, Signature=None):
        super(eSocialSub, self).__init__(evtContrSindPatr, Signature, )
...
class evtContrSindPatrTypeSub(supermod.evtContrSindPatrType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, contribSind=None):
        super(evtContrSindPatrTypeSub, self).__init__(Id, ideEvento, ideEmpregador, contribSind, )
supermod.evtContrSindPatrType.subclass = evtContrSindPatrTypeSub
# end class evtContrSindPatrTypeSub
...
class contribSindTypeSub(supermod.contribSindType):
    def __init__(self, cnpjSindic=None, tpContribSind=None, vlrContribSind=None):
        super(contribSindTypeSub, self).__init__(cnpjSindic, tpContribSind, vlrContribSind, )
supermod.contribSindType.subclass = contribSindTypeSub
# end class contribSindTypeSub
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from evtContrSindPatr import *\n\n')
        sys.stdout.write('import evtContrSindPatr as model_\n\n')

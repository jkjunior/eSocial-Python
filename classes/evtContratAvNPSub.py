...
#   ('-o', 'classes/evtContratAvNP.py')
#   ('-s', 'classes/evtContratAvNPSub.py')
#   ('--super', 'evtContratAvNP')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtContratAvNP.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtContratAvNP.py" -s "classes/evtContratAvNPSub.py" --super="evtContratAvNP" /home/joao/Documents/teste_xsd/xsd/evtContratAvNP.xsd
#
...
import evtContratAvNP as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtContratAvNP=None, Signature=None):
        super(eSocialSub, self).__init__(evtContratAvNP, Signature, )
...
class evtContratAvNPTypeSub(supermod.evtContratAvNPType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, remunAvNP=None):
        super(evtContratAvNPTypeSub, self).__init__(Id, ideEvento, ideEmpregador, remunAvNP, )
supermod.evtContratAvNPType.subclass = evtContratAvNPTypeSub
# end class evtContratAvNPTypeSub


class remunAvNPTypeSub(supermod.remunAvNPType):
    def __init__(self, tpInsc=None, nrInsc=None, codLotacao=None, vrBcCp00=None, vrBcCp15=None, vrBcCp20=None, vrBcCp25=None, vrBcCp13=None, vrBcFgts=None, vrDescCP=None):
        super(remunAvNPTypeSub, self).__init__(tpInsc, nrInsc, codLotacao, vrBcCp00, vrBcCp15, vrBcCp20, vrBcCp25, vrBcCp13, vrBcFgts, vrDescCP, )
supermod.remunAvNPType.subclass = remunAvNPTypeSub
# end class remunAvNPTypeSub

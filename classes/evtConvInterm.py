...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtConvInterm is not None:
            self.evtConvInterm.export(outfile, level, namespaceprefix_, name_='evtConvInterm', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'evtConvInterm':
            obj_ = evtConvIntermType.factory()
            obj_.build(child_)
...
class evtConvIntermType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtConvIntermType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtConvIntermType.subclass:
            return evtConvIntermType.subclass(*args_, **kwargs_)
        else:
            return evtConvIntermType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtConvIntermType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtConvIntermType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtConvIntermType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtConvIntermType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtConvIntermType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtConvIntermType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoConvInterm is not None:
            self.infoConvInterm.export(outfile, level, namespaceprefix_, name_='infoConvInterm', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ideEvento':
            ...
            obj_ = infoConvIntermType.factory()
            obj_.build(child_)
            self.infoConvInterm = obj_
            obj_.original_tagname_ = 'infoConvInterm'
# end class evtConvIntermType


class infoConvIntermType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, codConv=None, dtInicio=None, dtFim=None, dtPrevPgto=None, jornada=None, localTrab=None):
        ...
        if isinstance(dtPrevPgto, BaseStrType_):
            initvalue_ = datetime_.datetime.strptime(dtPrevPgto, '%Y-%m-%d').date()
        else:
            initvalue_ = dtPrevPgto
        self.dtPrevPgto = initvalue_
        self.jornada = jornada
        self.localTrab = localTrab
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoConvIntermType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoConvIntermType.subclass:
            return infoConvIntermType.subclass(*args_, **kwargs_)
        else:
            return infoConvIntermType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def get_dtPrevPgto(self): return self.dtPrevPgto
    def set_dtPrevPgto(self, dtPrevPgto): self.dtPrevPgto = dtPrevPgto
    ...
    def validate_dtFimType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            pass
    def validate_dtPrevPgtoType(self, value):
        # Validate type dtPrevPgtoType, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def hasContent_(self):
        if (
            ...
            self.dtPrevPgto is not None or
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoConvIntermType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoConvIntermType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoConvIntermType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoConvIntermType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoConvIntermType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoConvIntermType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.dtPrevPgto is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtPrevPgto>%s</dtPrevPgto>%s' % (self.gds_format_date(self.dtPrevPgto, input_name='dtPrevPgto'), eol_))
        if self.jornada is not None:
            self.jornada.export(outfile, level, namespaceprefix_, name_='jornada', pretty_print=pretty_print)
        if self.localTrab is not None:
            self.localTrab.export(outfile, level, namespaceprefix_, name_='localTrab', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'dtPrevPgto':
            sval_ = child_.text
            dval_ = self.gds_parse_date(sval_)
            self.dtPrevPgto = dval_
            # validate type dtPrevPgtoType
            self.validate_dtPrevPgtoType(self.dtPrevPgto)
        elif nodeName_ == 'jornada':
            obj_ = jornadaType.factory()
            obj_.build(child_)
            self.jornada = obj_
            obj_.original_tagname_ = 'jornada'
        elif nodeName_ == 'localTrab':
            obj_ = localTrabType.factory()
            obj_.build(child_)
            self.localTrab = obj_
            obj_.original_tagname_ = 'localTrab'
# end class infoConvIntermType


class jornadaType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, codHorContrat=None, dscJornada=None):
        ...
        self.validate_dscJornadaType(self.dscJornada)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, jornadaType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if jornadaType.subclass:
            return jornadaType.subclass(*args_, **kwargs_)
        else:
            return jornadaType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_dscJornadaType(self, value):
        # Validate type dscJornadaType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 999:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on dscJornadaType' % {"value" : value.encode("utf-8")} )
            if len(value) < 3:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on dscJornadaType' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='jornadaType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('jornadaType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='jornadaType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='jornadaType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='jornadaType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='jornadaType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.dscJornada is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dscJornada>%s</dscJornada>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.dscJornada), input_name='dscJornada')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'codHorContrat':
            ...
            # validate type dscJornadaType
            self.validate_dscJornadaType(self.dscJornada)
# end class jornadaType


class localTrabType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, indLocal=None, localTrabInterm=None):
        self.original_tagname_ = None
        self.indLocal = indLocal
        self.validate_indLocalType(self.indLocal)
        self.localTrabInterm = localTrabInterm
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, localTrabType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if localTrabType.subclass:
            return localTrabType.subclass(*args_, **kwargs_)
        else:
            return localTrabType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_indLocalType(self, value):
        # Validate type indLocalType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_indLocalType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_indLocalType_patterns_, ))
    validate_indLocalType_patterns_ = [['^\\d$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='localTrabType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('localTrabType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='localTrabType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='localTrabType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='localTrabType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='localTrabType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.indLocal is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<indLocal>%s</indLocal>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.indLocal), input_name='indLocal')), eol_))
        if self.localTrabInterm is not None:
            self.localTrabInterm.export(outfile, level, namespaceprefix_, name_='localTrabInterm', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'indLocal':
            indLocal_ = child_.text
            indLocal_ = self.gds_validate_string(indLocal_, node, 'indLocal')
            self.indLocal = indLocal_
            # validate type indLocalType
            self.validate_indLocalType(self.indLocal)
        elif nodeName_ == 'localTrabInterm':
            obj_ = localTrabIntermType.factory()
            obj_.build(child_)
            self.localTrabInterm = obj_
            obj_.original_tagname_ = 'localTrabInterm'
# end class localTrabType


class localTrabIntermType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, localTrabIntermType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if localTrabIntermType.subclass:
            return localTrabIntermType.subclass(*args_, **kwargs_)
        else:
            return localTrabIntermType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='localTrabIntermType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('localTrabIntermType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='localTrabIntermType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='localTrabIntermType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='localTrabIntermType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='localTrabIntermType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''

...
#   ('-o', 'classes/evtConvInterm.py')
#   ('-s', 'classes/evtConvIntermSub.py')
#   ('--super', 'evtConvInterm')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtConvInterm.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtConvInterm.py" -s "classes/evtConvIntermSub.py" --super="evtConvInterm" /home/joao/Documents/teste_xsd/xsd/evtConvInterm.xsd
#
...
import evtConvInterm as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtConvInterm=None, Signature=None):
        super(eSocialSub, self).__init__(evtConvInterm, Signature, )
...
class evtConvIntermTypeSub(supermod.evtConvIntermType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, ideVinculo=None, infoConvInterm=None):
        super(evtConvIntermTypeSub, self).__init__(Id, ideEvento, ideEmpregador, ideVinculo, infoConvInterm, )
supermod.evtConvIntermType.subclass = evtConvIntermTypeSub
# end class evtConvIntermTypeSub


class infoConvIntermTypeSub(supermod.infoConvIntermType):
    def __init__(self, codConv=None, dtInicio=None, dtFim=None, dtPrevPgto=None, jornada=None, localTrab=None):
        super(infoConvIntermTypeSub, self).__init__(codConv, dtInicio, dtFim, dtPrevPgto, jornada, localTrab, )
supermod.infoConvIntermType.subclass = infoConvIntermTypeSub
# end class infoConvIntermTypeSub


class jornadaTypeSub(supermod.jornadaType):
    def __init__(self, codHorContrat=None, dscJornada=None):
        super(jornadaTypeSub, self).__init__(codHorContrat, dscJornada, )
supermod.jornadaType.subclass = jornadaTypeSub
# end class jornadaTypeSub


class localTrabTypeSub(supermod.localTrabType):
    def __init__(self, indLocal=None, localTrabInterm=None):
        super(localTrabTypeSub, self).__init__(indLocal, localTrabInterm, )
supermod.localTrabType.subclass = localTrabTypeSub
# end class localTrabTypeSub


class localTrabIntermTypeSub(supermod.localTrabIntermType):
    def __init__(self, tpLograd=None, dscLograd=None, nrLograd=None, complem=None, bairro=None, cep=None, codMunic=None, uf=None):
        super(localTrabIntermTypeSub, self).__init__(tpLograd, dscLograd, nrLograd, complem, bairro, cep, codMunic, uf, )
supermod.localTrabIntermType.subclass = localTrabIntermTypeSub
# end class localTrabIntermTypeSub

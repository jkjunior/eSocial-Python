...
#   ('-o', 'classes/evtExclusao.py')
#   ('-s', 'classes/evtExclusaoSub.py')
#   ('--super', 'evtExclusao')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtExclusao.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtExclusao.py" -s "classes/evtExclusaoSub.py" --super="evtExclusao" /home/joao/Documents/teste_xsd/xsd/evtExclusao.xsd
#
...
import evtExclusao as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtExclusao=None, Signature=None):
        super(eSocialSub, self).__init__(evtExclusao, Signature, )
...
class evtExclusaoTypeSub(supermod.evtExclusaoType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, infoExclusao=None):
        super(evtExclusaoTypeSub, self).__init__(Id, ideEvento, ideEmpregador, infoExclusao, )
supermod.evtExclusaoType.subclass = evtExclusaoTypeSub
# end class evtExclusaoTypeSub


class ideEventoTypeSub(supermod.ideEventoType):
    def __init__(self, tpAmb=None, procEmi=None, verProc=None):
        super(ideEventoTypeSub, self).__init__(tpAmb, procEmi, verProc, )
supermod.ideEventoType.subclass = ideEventoTypeSub
# end class ideEventoTypeSub


class infoExclusaoTypeSub(supermod.infoExclusaoType):
    def __init__(self, tpEvento=None, nrRecEvt=None, ideTrabalhador=None, ideFolhaPagto=None):
        super(infoExclusaoTypeSub, self).__init__(tpEvento, nrRecEvt, ideTrabalhador, ideFolhaPagto, )
supermod.infoExclusaoType.subclass = infoExclusaoTypeSub
# end class infoExclusaoTypeSub
...
class ideFolhaPagtoTypeSub(supermod.ideFolhaPagtoType):
    def __init__(self, indApuracao=None, perApur=None):
        super(ideFolhaPagtoTypeSub, self).__init__(indApuracao, perApur, )
supermod.ideFolhaPagtoType.subclass = ideFolhaPagtoTypeSub
# end class ideFolhaPagtoTypeSub

...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtExpRisco is not None:
            self.evtExpRisco.export(outfile, level, namespaceprefix_, name_='evtExpRisco', pretty_print=pretty_print)
...
class TIdeVincEstagCoop(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TIdeVincEstagCoop', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TIdeVincEstagCoop')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TIdeVincEstagCoop', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TIdeVincEstagCoop'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TIdeVincEstagCoop', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TinfoAmb(GeneratedsSuper):
    ...
    def __init__(self, codAmb=None, infoAtiv=None, fatRisco=None):
        self.original_tagname_ = None
        self.codAmb = codAmb
        self.validate_codAmbType1(self.codAmb)
    ...
    def validate_codAmbType1(self, value):
        # Validate type codAmbType1, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 30:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on codAmbType1' % {"value" : value.encode("utf-8")} )
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on codAmbType1' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TinfoAmb', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TinfoAmb')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TinfoAmb', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TinfoAmb'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TinfoAmb', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.codAmb is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<codAmb>%s</codAmb>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.codAmb), input_name='codAmb')), eol_))
        if self.infoAtiv is not None:
            self.infoAtiv.export(outfile, level, namespaceprefix_, name_='infoAtiv', pretty_print=pretty_print)
        for fatRisco_ in self.fatRisco:
            fatRisco_.export(outfile, level, namespaceprefix_, name_='fatRisco', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class evtExpRiscoType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtExpRiscoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtExpRiscoType.subclass:
            return evtExpRiscoType.subclass(*args_, **kwargs_)
        else:
            return evtExpRiscoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtExpRiscoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtExpRiscoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtExpRiscoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtExpRiscoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtExpRiscoType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtExpRiscoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoExpRisco is not None:
            self.infoExpRisco.export(outfile, level, namespaceprefix_, name_='infoExpRisco', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ideEvento':
            ...
            obj_ = infoExpRiscoType.factory()
            obj_.build(child_)
            self.infoExpRisco = obj_
            obj_.original_tagname_ = 'infoExpRisco'
# end class evtExpRiscoType


class infoExpRiscoType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoExpRiscoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoExpRiscoType.subclass:
            return infoExpRiscoType.subclass(*args_, **kwargs_)
        else:
            return infoExpRiscoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoExpRiscoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoExpRiscoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoExpRiscoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoExpRiscoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoExpRiscoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoExpRiscoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.iniExpRisco is not None:
            self.iniExpRisco.export(outfile, level, namespaceprefix_, name_='iniExpRisco', pretty_print=pretty_print)
        if self.altExpRisco is not None:
            self.altExpRisco.export(outfile, level, namespaceprefix_, name_='altExpRisco', pretty_print=pretty_print)
        if self.fimExpRisco is not None:
            self.fimExpRisco.export(outfile, level, namespaceprefix_, name_='fimExpRisco', pretty_print=pretty_print)
        for respReg_ in self.respReg:
            respReg_.export(outfile, level, namespaceprefix_, name_='respReg', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class iniExpRiscoType(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, iniExpRiscoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if iniExpRiscoType.subclass:
            return iniExpRiscoType.subclass(*args_, **kwargs_)
        else:
            return iniExpRiscoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_dtIniCondicaoType(self, value):
        # Validate type dtIniCondicaoType, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='iniExpRiscoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('iniExpRiscoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='iniExpRiscoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='iniExpRiscoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='iniExpRiscoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='iniExpRiscoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.dtIniCondicao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtIniCondicao>%s</dtIniCondicao>%s' % (self.gds_format_date(self.dtIniCondicao, input_name='dtIniCondicao'), eol_))
        for infoAmb_ in self.infoAmb:
            infoAmb_.export(outfile, level, namespaceprefix_, name_='infoAmb', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dtIniCondicao':
            ...
            # validate type dtIniCondicaoType
            self.validate_dtIniCondicaoType(self.dtIniCondicao)
        elif nodeName_ == 'infoAmb':
            obj_ = TinfoAmb.factory()
            obj_.build(child_)
            self.infoAmb.append(obj_)
            obj_.original_tagname_ = 'infoAmb'
# end class iniExpRiscoType


class altExpRiscoType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, altExpRiscoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if altExpRiscoType.subclass:
            return altExpRiscoType.subclass(*args_, **kwargs_)
        else:
            return altExpRiscoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def insert_infoAmb_at(self, index, value): self.infoAmb.insert(index, value)
    def replace_infoAmb_at(self, index, value): self.infoAmb[index] = value
    def validate_dtAltCondicaoType(self, value):
        # Validate type dtAltCondicaoType, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='altExpRiscoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('altExpRiscoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='altExpRiscoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='altExpRiscoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='altExpRiscoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='altExpRiscoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.dtAltCondicao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtAltCondicao>%s</dtAltCondicao>%s' % (self.gds_format_date(self.dtAltCondicao, input_name='dtAltCondicao'), eol_))
        for infoAmb_ in self.infoAmb:
            infoAmb_.export(outfile, level, namespaceprefix_, name_='infoAmb', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dtAltCondicao':
            ...
            # validate type dtAltCondicaoType
            self.validate_dtAltCondicaoType(self.dtAltCondicao)
        elif nodeName_ == 'infoAmb':
            obj_ = TinfoAmb.factory()
            obj_.build(child_)
            self.infoAmb.append(obj_)
            obj_.original_tagname_ = 'infoAmb'
# end class altExpRiscoType


class fimExpRiscoType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, fimExpRiscoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if fimExpRiscoType.subclass:
            return fimExpRiscoType.subclass(*args_, **kwargs_)
        else:
            return fimExpRiscoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def insert_infoAmb_at(self, index, value): self.infoAmb.insert(index, value)
    def replace_infoAmb_at(self, index, value): self.infoAmb[index] = value
    def validate_dtFimCondicaoType(self, value):
        # Validate type dtFimCondicaoType, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='fimExpRiscoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('fimExpRiscoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='fimExpRiscoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='fimExpRiscoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='fimExpRiscoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='fimExpRiscoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.dtFimCondicao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtFimCondicao>%s</dtFimCondicao>%s' % (self.gds_format_date(self.dtFimCondicao, input_name='dtFimCondicao'), eol_))
        for infoAmb_ in self.infoAmb:
            infoAmb_.export(outfile, level, namespaceprefix_, name_='infoAmb', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dtFimCondicao':
            ...
            # validate type dtFimCondicaoType
            self.validate_dtFimCondicaoType(self.dtFimCondicao)
        elif nodeName_ == 'infoAmb':
            obj_ = infoAmbType.factory()
            obj_.build(child_)
            self.infoAmb.append(obj_)
            obj_.original_tagname_ = 'infoAmb'
# end class fimExpRiscoType


class infoAmbType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, codAmb=None):
        self.original_tagname_ = None
        self.codAmb = codAmb
        self.validate_codAmbType(self.codAmb)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoAmbType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoAmbType.subclass:
            return infoAmbType.subclass(*args_, **kwargs_)
        else:
            return infoAmbType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_codAmb(self): return self.codAmb
    def set_codAmb(self, codAmb): self.codAmb = codAmb
    def validate_codAmbType(self, value):
        # Validate type codAmbType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 30:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on codAmbType' % {"value" : value.encode("utf-8")} )
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on codAmbType' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoAmbType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoAmbType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoAmbType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoAmbType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoAmbType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoAmbType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'codAmb':
            ...
            codAmb_ = self.gds_validate_string(codAmb_, node, 'codAmb')
            self.codAmb = codAmb_
            # validate type codAmbType
            self.validate_codAmbType(self.codAmb)
# end class infoAmbType


class respRegType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, respRegType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if respRegType.subclass:
            return respRegType.subclass(*args_, **kwargs_)
        else:
            return respRegType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_dtIniType(self, value):
        # Validate type dtIniType, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def validate_dtFimType(self, value):
        # Validate type dtFimType, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='respRegType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('respRegType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='respRegType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='respRegType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='respRegType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='respRegType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.dtIni is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtIni>%s</dtIni>%s' % (self.gds_format_date(self.dtIni, input_name='dtIni'), eol_))
        if self.dtFim is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtFim>%s</dtFim>%s' % (self.gds_format_date(self.dtFim, input_name='dtFim'), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dtIni':
            ...
            dval_ = self.gds_parse_date(sval_)
            self.dtIni = dval_
            # validate type dtIniType
            self.validate_dtIniType(self.dtIni)
        elif nodeName_ == 'dtFim':
            sval_ = child_.text
            dval_ = self.gds_parse_date(sval_)
            self.dtFim = dval_
            # validate type dtFimType
            self.validate_dtFimType(self.dtFim)
            ...
            self.validate_ufOCType(self.ufOC)
# end class respRegType


class infoAtivType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, dscAtivDes=None):
        self.original_tagname_ = None
        self.dscAtivDes = dscAtivDes
        self.validate_dscAtivDesType(self.dscAtivDes)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoAtivType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoAtivType.subclass:
            return infoAtivType.subclass(*args_, **kwargs_)
        else:
            return infoAtivType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_dscAtivDes(self): return self.dscAtivDes
    def set_dscAtivDes(self, dscAtivDes): self.dscAtivDes = dscAtivDes
    def validate_dscAtivDesType(self, value):
        # Validate type dscAtivDesType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 999:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on dscAtivDesType' % {"value" : value.encode("utf-8")} )
            if len(value) < 3:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on dscAtivDesType' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoAtivType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoAtivType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoAtivType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoAtivType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoAtivType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoAtivType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.dscAtivDes is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dscAtivDes>%s</dscAtivDes>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.dscAtivDes), input_name='dscAtivDes')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dscAtivDes':
            ...
            # validate type dscAtivDesType
            self.validate_dscAtivDesType(self.dscAtivDes)
# end class infoAtivType


class fatRiscoType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, codFatRis=None, intConc=None, tecMedicao=None, epcEpi=None):
        self.original_tagname_ = None
        self.codFatRis = codFatRis
        self.validate_codFatRisType(self.codFatRis)
        self.intConc = intConc
        self.validate_intConcType(self.intConc)
        self.tecMedicao = tecMedicao
        self.validate_tecMedicaoType(self.tecMedicao)
        self.epcEpi = epcEpi
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, fatRiscoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if fatRiscoType.subclass:
            return fatRiscoType.subclass(*args_, **kwargs_)
        else:
            return fatRiscoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_codFatRisType(self, value):
        # Validate type codFatRisType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 10:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on codFatRisType' % {"value" : value.encode("utf-8")} )
            if len(value) < 4:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on codFatRisType' % {"value" : value.encode("utf-8")} )
    def validate_intConcType(self, value):
        # Validate type intConcType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 15:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on intConcType' % {"value" : value.encode("utf-8")} )
    def validate_tecMedicaoType(self, value):
        # Validate type tecMedicaoType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 40:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tecMedicaoType' % {"value" : value.encode("utf-8")} )
            if len(value) < 2:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tecMedicaoType' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='fatRiscoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('fatRiscoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='fatRiscoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='fatRiscoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='fatRiscoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='fatRiscoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.codFatRis is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<codFatRis>%s</codFatRis>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.codFatRis), input_name='codFatRis')), eol_))
        if self.intConc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<intConc>%s</intConc>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.intConc), input_name='intConc')), eol_))
        if self.tecMedicao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tecMedicao>%s</tecMedicao>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.tecMedicao), input_name='tecMedicao')), eol_))
        if self.epcEpi is not None:
            self.epcEpi.export(outfile, level, namespaceprefix_, name_='epcEpi', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'codFatRis':
            ...
            # validate type tecMedicaoType
            self.validate_tecMedicaoType(self.tecMedicao)
        elif nodeName_ == 'epcEpi':
            obj_ = epcEpiType.factory()
            obj_.build(child_)
            self.epcEpi = obj_
            obj_.original_tagname_ = 'epcEpi'
# end class fatRiscoType


class epcEpiType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, utilizEPC=None, utilizEPI=None, epc=None, epi=None):
        self.original_tagname_ = None
        self.utilizEPC = utilizEPC
        self.validate_utilizEPCType(self.utilizEPC)
        self.utilizEPI = utilizEPI
        self.validate_utilizEPIType(self.utilizEPI)
        if epc is None:
            self.epc = []
        else:
            self.epc = epc
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, epcEpiType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if epcEpiType.subclass:
            return epcEpiType.subclass(*args_, **kwargs_)
        else:
            return epcEpiType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_utilizEPCType(self, value):
        # Validate type utilizEPCType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_utilizEPCType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_utilizEPCType_patterns_, ))
    validate_utilizEPCType_patterns_ = [['^\\d$']]
    def validate_utilizEPIType(self, value):
        # Validate type utilizEPIType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_utilizEPIType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_utilizEPIType_patterns_, ))
    validate_utilizEPIType_patterns_ = [['^\\d$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='epcEpiType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('epcEpiType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='epcEpiType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='epcEpiType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='epcEpiType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='epcEpiType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.utilizEPC is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<utilizEPC>%s</utilizEPC>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.utilizEPC), input_name='utilizEPC')), eol_))
        if self.utilizEPI is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<utilizEPI>%s</utilizEPI>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.utilizEPI), input_name='utilizEPI')), eol_))
        for epc_ in self.epc:
            epc_.export(outfile, level, namespaceprefix_, name_='epc', pretty_print=pretty_print)
        for epi_ in self.epi:
            epi_.export(outfile, level, namespaceprefix_, name_='epi', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'utilizEPC':
            utilizEPC_ = child_.text
            utilizEPC_ = self.gds_validate_string(utilizEPC_, node, 'utilizEPC')
            self.utilizEPC = utilizEPC_
            # validate type utilizEPCType
            self.validate_utilizEPCType(self.utilizEPC)
        elif nodeName_ == 'utilizEPI':
            utilizEPI_ = child_.text
            utilizEPI_ = self.gds_validate_string(utilizEPI_, node, 'utilizEPI')
            self.utilizEPI = utilizEPI_
            # validate type utilizEPIType
            self.validate_utilizEPIType(self.utilizEPI)
        elif nodeName_ == 'epc':
            obj_ = epcType.factory()
            obj_.build(child_)
            self.epc.append(obj_)
            obj_.original_tagname_ = 'epc'
        elif nodeName_ == 'epi':
            obj_ = epiType.factory()
            obj_.build(child_)
            self.epi.append(obj_)
            obj_.original_tagname_ = 'epi'
# end class epcEpiType


class epcType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, dscEpc=None, eficEpc=None):
        self.original_tagname_ = None
        self.dscEpc = dscEpc
        self.validate_dscEpcType(self.dscEpc)
        self.eficEpc = eficEpc
        self.validate_eficEpcType(self.eficEpc)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, epcType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if epcType.subclass:
            return epcType.subclass(*args_, **kwargs_)
        else:
            return epcType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_dscEpcType(self, value):
        # Validate type dscEpcType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 70:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on dscEpcType' % {"value" : value.encode("utf-8")} )
            if len(value) < 3:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on dscEpcType' % {"value" : value.encode("utf-8")} )
    def validate_eficEpcType(self, value):
        # Validate type eficEpcType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_eficEpcType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_eficEpcType_patterns_, ))
    validate_eficEpcType_patterns_ = [['^[N|S]$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='epcType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('epcType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='epcType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='epcType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='epcType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='epcType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.dscEpc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dscEpc>%s</dscEpc>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.dscEpc), input_name='dscEpc')), eol_))
        if self.eficEpc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<eficEpc>%s</eficEpc>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.eficEpc), input_name='eficEpc')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class epiType(GeneratedsSuper):
    ...
    def __init__(self, caEPI=None, eficEpi=None, medProtecao=None, condFuncto=None, przValid=None, periodicTroca=None, higienizacao=None):
        self.original_tagname_ = None
        self.caEPI = caEPI
        self.validate_caEPIType(self.caEPI)
        self.eficEpi = eficEpi
        self.validate_eficEpiType(self.eficEpi)
        self.medProtecao = medProtecao
        self.validate_medProtecaoType(self.medProtecao)
        self.condFuncto = condFuncto
        self.validate_condFunctoType(self.condFuncto)
        self.przValid = przValid
        self.validate_przValidType(self.przValid)
        self.periodicTroca = periodicTroca
        self.validate_periodicTrocaType(self.periodicTroca)
        self.higienizacao = higienizacao
        self.validate_higienizacaoType(self.higienizacao)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, epiType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if epiType.subclass:
            return epiType.subclass(*args_, **kwargs_)
        else:
            return epiType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_caEPIType(self, value):
        # Validate type caEPIType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 20:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on caEPIType' % {"value" : value.encode("utf-8")} )
    def validate_eficEpiType(self, value):
        # Validate type eficEpiType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_eficEpiType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_eficEpiType_patterns_, ))
    validate_eficEpiType_patterns_ = [['^[N|S]$']]
    def validate_medProtecaoType(self, value):
        # Validate type medProtecaoType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 1:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on medProtecaoType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_medProtecaoType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_medProtecaoType_patterns_, ))
    validate_medProtecaoType_patterns_ = [['^[N|S]$']]
    def validate_condFunctoType(self, value):
        # Validate type condFunctoType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 1:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on condFunctoType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_condFunctoType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_condFunctoType_patterns_, ))
    validate_condFunctoType_patterns_ = [['^[N|S]$']]
    def validate_przValidType(self, value):
        # Validate type przValidType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 1:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on przValidType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_przValidType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_przValidType_patterns_, ))
    validate_przValidType_patterns_ = [['^[N|S]$']]
    def validate_periodicTrocaType(self, value):
        # Validate type periodicTrocaType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 1:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on periodicTrocaType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_periodicTrocaType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_periodicTrocaType_patterns_, ))
    validate_periodicTrocaType_patterns_ = [['^[N|S]$']]
    def validate_higienizacaoType(self, value):
        # Validate type higienizacaoType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 1:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on higienizacaoType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_higienizacaoType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_higienizacaoType_patterns_, ))
    validate_higienizacaoType_patterns_ = [['^[N|S]$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='epiType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('epiType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='epiType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='epiType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='epiType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='epiType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.caEPI is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<caEPI>%s</caEPI>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.caEPI), input_name='caEPI')), eol_))
        if self.eficEpi is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<eficEpi>%s</eficEpi>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.eficEpi), input_name='eficEpi')), eol_))
        if self.medProtecao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<medProtecao>%s</medProtecao>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.medProtecao), input_name='medProtecao')), eol_))
        if self.condFuncto is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<condFuncto>%s</condFuncto>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.condFuncto), input_name='condFuncto')), eol_))
        if self.przValid is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<przValid>%s</przValid>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.przValid), input_name='przValid')), eol_))
        if self.periodicTroca is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<periodicTroca>%s</periodicTroca>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.periodicTroca), input_name='periodicTroca')), eol_))
        if self.higienizacao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<higienizacao>%s</higienizacao>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.higienizacao), input_name='higienizacao')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'caEPI':
            ...
            # validate type periodicTrocaType
            self.validate_periodicTrocaType(self.periodicTroca)
            ...
            # validate type higienizacaoType
            self.validate_higienizacaoType(self.higienizacao)
# end class epiType

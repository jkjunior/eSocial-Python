...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtFechaEvPer is not None:
            self.evtFechaEvPer.export(outfile, level, namespaceprefix_, name_='evtFechaEvPer', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'evtFechaEvPer':
            obj_ = evtFechaEvPerType.factory()
            obj_.build(child_)
...
class evtFechaEvPerType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtFechaEvPerType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtFechaEvPerType.subclass:
            return evtFechaEvPerType.subclass(*args_, **kwargs_)
        else:
            return evtFechaEvPerType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtFechaEvPerType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtFechaEvPerType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtFechaEvPerType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtFechaEvPerType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtFechaEvPerType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtFechaEvPerType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.ideRespInf is not None:
            self.ideRespInf.export(outfile, level, namespaceprefix_, name_='ideRespInf', pretty_print=pretty_print)
        if self.infoFech is not None:
            self.infoFech.export(outfile, level, namespaceprefix_, name_='infoFech', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class ideRespInfType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, nmResp=None, cpfResp=None, telefone=None, email=None):
        self.original_tagname_ = None
        self.nmResp = nmResp
        self.validate_nmRespType(self.nmResp)
        self.cpfResp = cpfResp
        self.validate_cpfRespType(self.cpfResp)
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ideRespInfType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ideRespInfType.subclass:
            return ideRespInfType.subclass(*args_, **kwargs_)
        else:
            return ideRespInfType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_nmRespType(self, value):
        # Validate type nmRespType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 70:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on nmRespType' % {"value" : value.encode("utf-8")} )
            if len(value) < 2:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on nmRespType' % {"value" : value.encode("utf-8")} )
    def validate_cpfRespType(self, value):
        # Validate type cpfRespType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 11:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on cpfRespType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_cpfRespType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_cpfRespType_patterns_, ))
    validate_cpfRespType_patterns_ = [['^\\d{11}$']]
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='ideRespInfType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ideRespInfType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ideRespInfType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='ideRespInfType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ideRespInfType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideRespInfType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.nmResp is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nmResp>%s</nmResp>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.nmResp), input_name='nmResp')), eol_))
        if self.cpfResp is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<cpfResp>%s</cpfResp>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.cpfResp), input_name='cpfResp')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'nmResp':
            ...
            self.validate_emailType(self.email)
# end class ideRespInfType


class infoFechType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, evtRemun=None, evtPgtos=None, evtAqProd=None, evtComProd=None, evtContratAvNP=None, evtInfoComplPer=None, compSemMovto=None):
        ...
        self.validate_evtRemunType(self.evtRemun)
        self.evtPgtos = evtPgtos
        self.validate_evtPgtosType(self.evtPgtos)
        self.evtAqProd = evtAqProd
        self.validate_evtAqProdType(self.evtAqProd)
        self.evtComProd = evtComProd
        self.validate_evtComProdType(self.evtComProd)
        self.evtContratAvNP = evtContratAvNP
        self.validate_evtContratAvNPType(self.evtContratAvNP)
        self.evtInfoComplPer = evtInfoComplPer
        self.validate_evtInfoComplPerType(self.evtInfoComplPer)
        self.compSemMovto = compSemMovto
        self.validate_compSemMovtoType(self.compSemMovto)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoFechType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoFechType.subclass:
            return infoFechType.subclass(*args_, **kwargs_)
        else:
            return infoFechType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_evtRemunType(self, value):
        # Validate type evtRemunType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_evtRemunType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_evtRemunType_patterns_, ))
    validate_evtRemunType_patterns_ = [['^[N|S]$']]
    def validate_evtPgtosType(self, value):
        # Validate type evtPgtosType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_evtPgtosType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_evtPgtosType_patterns_, ))
    validate_evtPgtosType_patterns_ = [['^[N|S]$']]
    def validate_evtAqProdType(self, value):
        # Validate type evtAqProdType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 1:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on evtAqProdType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_evtAqProdType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_evtAqProdType_patterns_, ))
    validate_evtAqProdType_patterns_ = [['^[N|S]$']]
    def validate_evtComProdType(self, value):
        # Validate type evtComProdType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 1:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on evtComProdType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_evtComProdType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_evtComProdType_patterns_, ))
    validate_evtComProdType_patterns_ = [['^[N|S]$']]
    def validate_evtContratAvNPType(self, value):
        # Validate type evtContratAvNPType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 1:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on evtContratAvNPType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_evtContratAvNPType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_evtContratAvNPType_patterns_, ))
    validate_evtContratAvNPType_patterns_ = [['^[N|S]$']]
    def validate_evtInfoComplPerType(self, value):
        # Validate type evtInfoComplPerType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_evtInfoComplPerType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_evtInfoComplPerType_patterns_, ))
    validate_evtInfoComplPerType_patterns_ = [['^[N|S]$']]
    def validate_compSemMovtoType(self, value):
        # Validate type compSemMovtoType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 7:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on compSemMovtoType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_compSemMovtoType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_compSemMovtoType_patterns_, ))
    validate_compSemMovtoType_patterns_ = [['^[2]{1}\\d{3}-(1[0-2]|0[1-9])$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoFechType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoFechType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoFechType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoFechType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoFechType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoFechType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.evtRemun is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<evtRemun>%s</evtRemun>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.evtRemun), input_name='evtRemun')), eol_))
        if self.evtPgtos is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<evtPgtos>%s</evtPgtos>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.evtPgtos), input_name='evtPgtos')), eol_))
        if self.evtAqProd is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<evtAqProd>%s</evtAqProd>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.evtAqProd), input_name='evtAqProd')), eol_))
        if self.evtComProd is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<evtComProd>%s</evtComProd>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.evtComProd), input_name='evtComProd')), eol_))
        if self.evtContratAvNP is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<evtContratAvNP>%s</evtContratAvNP>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.evtContratAvNP), input_name='evtContratAvNP')), eol_))
        if self.evtInfoComplPer is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<evtInfoComplPer>%s</evtInfoComplPer>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.evtInfoComplPer), input_name='evtInfoComplPer')), eol_))
        if self.compSemMovto is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<compSemMovto>%s</compSemMovto>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.compSemMovto), input_name='compSemMovto')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'evtRemun':
            ...
            # validate type evtContratAvNPType
            self.validate_evtContratAvNPType(self.evtContratAvNP)
            ...
            # validate type evtInfoComplPerType
            self.validate_evtInfoComplPerType(self.evtInfoComplPer)
            ...
            # validate type compSemMovtoType
            self.validate_compSemMovtoType(self.compSemMovto)
# end class infoFechType

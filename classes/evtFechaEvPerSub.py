...
#   ('-o', 'classes/evtFechaEvPer.py')
#   ('-s', 'classes/evtFechaEvPerSub.py')
#   ('--super', 'evtFechaEvPer')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtFechaEvPer.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtFechaEvPer.py" -s "classes/evtFechaEvPerSub.py" --super="evtFechaEvPer" /home/joao/Documents/teste_xsd/xsd/evtFechaEvPer.xsd
#
...
import evtFechaEvPer as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtFechaEvPer=None, Signature=None):
        super(eSocialSub, self).__init__(evtFechaEvPer, Signature, )
...
class evtFechaEvPerTypeSub(supermod.evtFechaEvPerType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, ideRespInf=None, infoFech=None):
        super(evtFechaEvPerTypeSub, self).__init__(Id, ideEvento, ideEmpregador, ideRespInf, infoFech, )
supermod.evtFechaEvPerType.subclass = evtFechaEvPerTypeSub
# end class evtFechaEvPerTypeSub
...
class ideRespInfTypeSub(supermod.ideRespInfType):
    def __init__(self, nmResp=None, cpfResp=None, telefone=None, email=None):
        super(ideRespInfTypeSub, self).__init__(nmResp, cpfResp, telefone, email, )
supermod.ideRespInfType.subclass = ideRespInfTypeSub
# end class ideRespInfTypeSub


class infoFechTypeSub(supermod.infoFechType):
    def __init__(self, evtRemun=None, evtPgtos=None, evtAqProd=None, evtComProd=None, evtContratAvNP=None, evtInfoComplPer=None, compSemMovto=None):
        super(infoFechTypeSub, self).__init__(evtRemun, evtPgtos, evtAqProd, evtComProd, evtContratAvNP, evtInfoComplPer, compSemMovto, )
supermod.infoFechType.subclass = infoFechTypeSub
# end class infoFechTypeSub

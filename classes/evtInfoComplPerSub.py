...
#   ('-o', 'classes/evtInfoComplPer.py')
#   ('-s', 'classes/evtInfoComplPerSub.py')
#   ('--super', 'evtInfoComplPer')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtInfoComplPer.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtInfoComplPer.py" -s "classes/evtInfoComplPerSub.py" --super="evtInfoComplPer" /home/joao/Documents/teste_xsd/xsd/evtInfoComplPer.xsd
#
...
import evtInfoComplPer as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtInfoComplPer=None, Signature=None):
        super(eSocialSub, self).__init__(evtInfoComplPer, Signature, )
...
class evtInfoComplPerTypeSub(supermod.evtInfoComplPerType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, infoSubstPatr=None, infoSubstPatrOpPort=None, infoAtivConcom=None):
        super(evtInfoComplPerTypeSub, self).__init__(Id, ideEvento, ideEmpregador, infoSubstPatr, infoSubstPatrOpPort, infoAtivConcom, )
supermod.evtInfoComplPerType.subclass = evtInfoComplPerTypeSub
# end class evtInfoComplPerTypeSub


class infoSubstPatrTypeSub(supermod.infoSubstPatrType):
    def __init__(self, indSubstPatr=None, percRedContrib=None):
        super(infoSubstPatrTypeSub, self).__init__(indSubstPatr, percRedContrib, )
supermod.infoSubstPatrType.subclass = infoSubstPatrTypeSub
# end class infoSubstPatrTypeSub
...
class infoAtivConcomTypeSub(supermod.infoAtivConcomType):
    def __init__(self, fatorMes=None, fator13=None):
        super(infoAtivConcomTypeSub, self).__init__(fatorMes, fator13, )
supermod.infoAtivConcomType.subclass = infoAtivConcomTypeSub
# end class infoAtivConcomTypeSub

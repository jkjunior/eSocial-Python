...
import evtInfoEmpregador as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtInfoEmpregador=None, Signature=None):
        super(eSocialSub, self).__init__(evtInfoEmpregador, Signature, )
...
class TIdePeriodoSub(supermod.TIdePeriodo):
    def __init__(self, iniValid=None, fimValid=None):
        super(TIdePeriodoSub, self).__init__(iniValid, fimValid, )
supermod.TIdePeriodo.subclass = TIdePeriodoSub
# end class TIdePeriodoSub


class TInfoEmpregadorSub(supermod.TInfoEmpregador):
    def __init__(self, nmRazao=None, classTrib=None, natJurid=None, indCoop=None, indConstr=None, indDesFolha=None, indOptRegEletron=None, indEntEd=None, indEtt=None, nrRegEtt=None, dadosIsencao=None, contato=None, infoOP=None, infoOrgInternacional=None, softwareHouse=None, infoComplementares=None):
        super(TInfoEmpregadorSub, self).__init__(nmRazao, classTrib, natJurid, indCoop, indConstr, indDesFolha, indOptRegEletron, indEntEd, indEtt, nrRegEtt, dadosIsencao, contato, infoOP, infoOrgInternacional, softwareHouse, infoComplementares, )
supermod.TInfoEmpregador.subclass = TInfoEmpregadorSub
# end class TInfoEmpregadorSub
...
class evtInfoEmpregadorTypeSub(supermod.evtInfoEmpregadorType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, infoEmpregador=None):
        super(evtInfoEmpregadorTypeSub, self).__init__(Id, ideEvento, ideEmpregador, infoEmpregador, )
supermod.evtInfoEmpregadorType.subclass = evtInfoEmpregadorTypeSub
# end class evtInfoEmpregadorTypeSub


class infoEmpregadorTypeSub(supermod.infoEmpregadorType):
    def __init__(self, inclusao=None, alteracao=None, exclusao=None):
        super(infoEmpregadorTypeSub, self).__init__(inclusao, alteracao, exclusao, )
supermod.infoEmpregadorType.subclass = infoEmpregadorTypeSub
# end class infoEmpregadorTypeSub


class inclusaoTypeSub(supermod.inclusaoType):
    def __init__(self, idePeriodo=None, infoCadastro=None):
        super(inclusaoTypeSub, self).__init__(idePeriodo, infoCadastro, )
...
class alteracaoTypeSub(supermod.alteracaoType):
    def __init__(self, idePeriodo=None, infoCadastro=None, novaValidade=None):
        super(alteracaoTypeSub, self).__init__(idePeriodo, infoCadastro, novaValidade, )
...
class exclusaoTypeSub(supermod.exclusaoType):
    def __init__(self, idePeriodo=None):
        super(exclusaoTypeSub, self).__init__(idePeriodo, )
supermod.exclusaoType.subclass = exclusaoTypeSub
# end class exclusaoTypeSub


class dadosIsencaoTypeSub(supermod.dadosIsencaoType):
    def __init__(self, ideMinLei=None, nrCertif=None, dtEmisCertif=None, dtVencCertif=None, nrProtRenov=None, dtProtRenov=None, dtDou=None, pagDou=None):
        super(dadosIsencaoTypeSub, self).__init__(ideMinLei, nrCertif, dtEmisCertif, dtVencCertif, nrProtRenov, dtProtRenov, dtDou, pagDou, )
supermod.dadosIsencaoType.subclass = dadosIsencaoTypeSub
# end class dadosIsencaoTypeSub


class contatoTypeSub(supermod.contatoType):
    def __init__(self, nmCtt=None, cpfCtt=None, foneFixo=None, foneCel=None, email=None):
        super(contatoTypeSub, self).__init__(nmCtt, cpfCtt, foneFixo, foneCel, email, )
supermod.contatoType.subclass = contatoTypeSub
# end class contatoTypeSub


class infoOPTypeSub(supermod.infoOPType):
    def __init__(self, nrSiafi=None, infoEFR=None, infoEnte=None):
        super(infoOPTypeSub, self).__init__(nrSiafi, infoEFR, infoEnte, )
supermod.infoOPType.subclass = infoOPTypeSub
# end class infoOPTypeSub


class infoEFRTypeSub(supermod.infoEFRType):
    def __init__(self, ideEFR=None, cnpjEFR=None):
        super(infoEFRTypeSub, self).__init__(ideEFR, cnpjEFR, )
supermod.infoEFRType.subclass = infoEFRTypeSub
# end class infoEFRTypeSub


class infoEnteTypeSub(supermod.infoEnteType):
    def __init__(self, nmEnte=None, uf=None, codMunic=None, indRPPS=None, subteto=None, vrSubteto=None):
        super(infoEnteTypeSub, self).__init__(nmEnte, uf, codMunic, indRPPS, subteto, vrSubteto, )
supermod.infoEnteType.subclass = infoEnteTypeSub
# end class infoEnteTypeSub


class infoOrgInternacionalTypeSub(supermod.infoOrgInternacionalType):
    def __init__(self, indAcordoIsenMulta=None):
        super(infoOrgInternacionalTypeSub, self).__init__(indAcordoIsenMulta, )
supermod.infoOrgInternacionalType.subclass = infoOrgInternacionalTypeSub
# end class infoOrgInternacionalTypeSub


class softwareHouseTypeSub(supermod.softwareHouseType):
    def __init__(self, cnpjSoftHouse=None, nmRazao=None, nmCont=None, telefone=None, email=None):
        super(softwareHouseTypeSub, self).__init__(cnpjSoftHouse, nmRazao, nmCont, telefone, email, )
supermod.softwareHouseType.subclass = softwareHouseTypeSub
# end class softwareHouseTypeSub


class infoComplementaresTypeSub(supermod.infoComplementaresType):
    def __init__(self, situacaoPJ=None, situacaoPF=None):
        super(infoComplementaresTypeSub, self).__init__(situacaoPJ, situacaoPF, )
supermod.infoComplementaresType.subclass = infoComplementaresTypeSub
# end class infoComplementaresTypeSub


class situacaoPJTypeSub(supermod.situacaoPJType):
    def __init__(self, indSitPJ=None):
        super(situacaoPJTypeSub, self).__init__(indSitPJ, )
supermod.situacaoPJType.subclass = situacaoPJTypeSub
# end class situacaoPJTypeSub


class situacaoPFTypeSub(supermod.situacaoPFType):
    def __init__(self, indSitPF=None):
        super(situacaoPFTypeSub, self).__init__(indSitPF, )
supermod.situacaoPFType.subclass = situacaoPFTypeSub
# end class situacaoPFTypeSub

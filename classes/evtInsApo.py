...
class eSocial(GeneratedsSuper):
    ...
    def get_evtInsApo(self): return self.evtInsApo
    def set_evtInsApo(self, evtInsApo): self.evtInsApo = evtInsApo
    def get_Signature(self): return self.Signature
    def set_Signature(self, Signature): self.Signature = Signature
    def hasContent_(self):
        if (
            self.evtInsApo is not None or
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            ...
            eol_ = ''
        if self.evtInsApo is not None:
            self.evtInsApo.export(outfile, level, namespaceprefix_, name_='evtInsApo', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'evtInsApo':
            obj_ = evtInsApoType.factory()
            obj_.build(child_)
            self.evtInsApo = obj_
            obj_.original_tagname_ = 'evtInsApo'
...
class TinfoAmbiente(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TinfoAmbiente)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TinfoAmbiente.subclass:
            return TinfoAmbiente.subclass(*args_, **kwargs_)
        else:
            return TinfoAmbiente(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_codAmbType6(self, value):
        # Validate type codAmbType6, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 30:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on codAmbType6' % {"value" : value.encode("utf-8")} )
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on codAmbType6' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TinfoAmbiente', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('TinfoAmbiente')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TinfoAmbiente')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TinfoAmbiente', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TinfoAmbiente'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TinfoAmbiente', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class evtInsApoType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, ideVinculo=None, insalPeric=None, aposentEsp=None):
        ...
        self.insalPeric = insalPeric
        self.aposentEsp = aposentEsp
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtInsApoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtInsApoType.subclass:
            return evtInsApoType.subclass(*args_, **kwargs_)
        else:
            return evtInsApoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def get_insalPeric(self): return self.insalPeric
    def set_insalPeric(self, insalPeric): self.insalPeric = insalPeric
    def get_aposentEsp(self): return self.aposentEsp
    def set_aposentEsp(self, aposentEsp): self.aposentEsp = aposentEsp
    def get_Id(self): return self.Id
    def set_Id(self, Id): self.Id = Id
    def hasContent_(self):
        if (
            ...
            self.insalPeric is not None or
            self.aposentEsp is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtInsApoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtInsApoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtInsApoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtInsApoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtInsApoType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtInsApoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.insalPeric is not None:
            self.insalPeric.export(outfile, level, namespaceprefix_, name_='insalPeric', pretty_print=pretty_print)
        if self.aposentEsp is not None:
            self.aposentEsp.export(outfile, level, namespaceprefix_, name_='aposentEsp', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'insalPeric':
            obj_ = insalPericType.factory()
            obj_.build(child_)
            self.insalPeric = obj_
            obj_.original_tagname_ = 'insalPeric'
        elif nodeName_ == 'aposentEsp':
            obj_ = aposentEspType.factory()
            obj_.build(child_)
            self.aposentEsp = obj_
            obj_.original_tagname_ = 'aposentEsp'
# end class evtInsApoType


class insalPericType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, iniInsalPeric=None, altInsalPeric=None, fimInsalPeric=None):
        self.original_tagname_ = None
        self.iniInsalPeric = iniInsalPeric
        self.altInsalPeric = altInsalPeric
        self.fimInsalPeric = fimInsalPeric
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, insalPericType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if insalPericType.subclass:
            return insalPericType.subclass(*args_, **kwargs_)
        else:
            return insalPericType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_iniInsalPeric(self): return self.iniInsalPeric
    def set_iniInsalPeric(self, iniInsalPeric): self.iniInsalPeric = iniInsalPeric
    def get_altInsalPeric(self): return self.altInsalPeric
    def set_altInsalPeric(self, altInsalPeric): self.altInsalPeric = altInsalPeric
    def get_fimInsalPeric(self): return self.fimInsalPeric
    def set_fimInsalPeric(self, fimInsalPeric): self.fimInsalPeric = fimInsalPeric
    def hasContent_(self):
        if (
            self.iniInsalPeric is not None or
            self.altInsalPeric is not None or
            self.fimInsalPeric is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='insalPericType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('insalPericType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='insalPericType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='insalPericType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='insalPericType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='insalPericType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.iniInsalPeric is not None:
            self.iniInsalPeric.export(outfile, level, namespaceprefix_, name_='iniInsalPeric', pretty_print=pretty_print)
        if self.altInsalPeric is not None:
            self.altInsalPeric.export(outfile, level, namespaceprefix_, name_='altInsalPeric', pretty_print=pretty_print)
        if self.fimInsalPeric is not None:
            self.fimInsalPeric.export(outfile, level, namespaceprefix_, name_='fimInsalPeric', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'iniInsalPeric':
            obj_ = iniInsalPericType.factory()
            obj_.build(child_)
            self.iniInsalPeric = obj_
            obj_.original_tagname_ = 'iniInsalPeric'
        elif nodeName_ == 'altInsalPeric':
            obj_ = altInsalPericType.factory()
            obj_.build(child_)
            self.altInsalPeric = obj_
            obj_.original_tagname_ = 'altInsalPeric'
        elif nodeName_ == 'fimInsalPeric':
            obj_ = fimInsalPericType.factory()
            obj_.build(child_)
            self.fimInsalPeric = obj_
            obj_.original_tagname_ = 'fimInsalPeric'
# end class insalPericType


class iniInsalPericType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, iniInsalPericType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if iniInsalPericType.subclass:
            return iniInsalPericType.subclass(*args_, **kwargs_)
        else:
            return iniInsalPericType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='iniInsalPericType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('iniInsalPericType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='iniInsalPericType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='iniInsalPericType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='iniInsalPericType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='iniInsalPericType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dtIniCondicao':
            ...
            obj_ = TinfoAmbiente.factory()
            obj_.build(child_)
            self.infoAmb.append(obj_)
            obj_.original_tagname_ = 'infoAmb'
# end class iniInsalPericType


class altInsalPericType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, altInsalPericType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if altInsalPericType.subclass:
            return altInsalPericType.subclass(*args_, **kwargs_)
        else:
            return altInsalPericType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='altInsalPericType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('altInsalPericType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='altInsalPericType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='altInsalPericType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='altInsalPericType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='altInsalPericType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dtAltCondicao':
            ...
            self.infoamb.append(obj_)
            obj_.original_tagname_ = 'infoamb'
# end class altInsalPericType


class fimInsalPericType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, fimInsalPericType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if fimInsalPericType.subclass:
            return fimInsalPericType.subclass(*args_, **kwargs_)
        else:
            return fimInsalPericType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='fimInsalPericType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('fimInsalPericType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='fimInsalPericType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='fimInsalPericType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='fimInsalPericType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='fimInsalPericType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class aposentEspType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, iniAposentEsp=None, altAposentEsp=None, fimAposentEsp=None):
        self.original_tagname_ = None
        self.iniAposentEsp = iniAposentEsp
        self.altAposentEsp = altAposentEsp
        self.fimAposentEsp = fimAposentEsp
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, aposentEspType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if aposentEspType.subclass:
            return aposentEspType.subclass(*args_, **kwargs_)
        else:
            return aposentEspType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_iniAposentEsp(self): return self.iniAposentEsp
    def set_iniAposentEsp(self, iniAposentEsp): self.iniAposentEsp = iniAposentEsp
    def get_altAposentEsp(self): return self.altAposentEsp
    def set_altAposentEsp(self, altAposentEsp): self.altAposentEsp = altAposentEsp
    def get_fimAposentEsp(self): return self.fimAposentEsp
    def set_fimAposentEsp(self, fimAposentEsp): self.fimAposentEsp = fimAposentEsp
    def hasContent_(self):
        if (
            self.iniAposentEsp is not None or
            self.altAposentEsp is not None or
            self.fimAposentEsp is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='aposentEspType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('aposentEspType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='aposentEspType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='aposentEspType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='aposentEspType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='aposentEspType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.iniAposentEsp is not None:
            self.iniAposentEsp.export(outfile, level, namespaceprefix_, name_='iniAposentEsp', pretty_print=pretty_print)
        if self.altAposentEsp is not None:
            self.altAposentEsp.export(outfile, level, namespaceprefix_, name_='altAposentEsp', pretty_print=pretty_print)
        if self.fimAposentEsp is not None:
            self.fimAposentEsp.export(outfile, level, namespaceprefix_, name_='fimAposentEsp', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'iniAposentEsp':
            obj_ = iniAposentEspType.factory()
            obj_.build(child_)
            self.iniAposentEsp = obj_
            obj_.original_tagname_ = 'iniAposentEsp'
        elif nodeName_ == 'altAposentEsp':
            obj_ = altAposentEspType.factory()
            obj_.build(child_)
            self.altAposentEsp = obj_
            obj_.original_tagname_ = 'altAposentEsp'
        elif nodeName_ == 'fimAposentEsp':
            obj_ = fimAposentEspType.factory()
            obj_.build(child_)
            self.fimAposentEsp = obj_
            obj_.original_tagname_ = 'fimAposentEsp'
# end class aposentEspType


class iniAposentEspType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, dtIniCondicao=None, infoAmb=None):
        self.original_tagname_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, iniAposentEspType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if iniAposentEspType.subclass:
            return iniAposentEspType.subclass(*args_, **kwargs_)
        else:
            return iniAposentEspType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_dtIniCondicao(self): return self.dtIniCondicao
    def set_dtIniCondicao(self, dtIniCondicao): self.dtIniCondicao = dtIniCondicao
    def get_infoAmb(self): return self.infoAmb
    ...
    def insert_infoAmb_at(self, index, value): self.infoAmb.insert(index, value)
    def replace_infoAmb_at(self, index, value): self.infoAmb[index] = value
    def validate_dtIniCondicaoType1(self, value):
        # Validate type dtIniCondicaoType1, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='iniAposentEspType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('iniAposentEspType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='iniAposentEspType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='iniAposentEspType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='iniAposentEspType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='iniAposentEspType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dtIniCondicao':
            ...
            dval_ = self.gds_parse_date(sval_)
            self.dtIniCondicao = dval_
            # validate type dtIniCondicaoType1
            self.validate_dtIniCondicaoType1(self.dtIniCondicao)
        elif nodeName_ == 'infoAmb':
            obj_ = TinfoAmbiente.factory()
            obj_.build(child_)
            self.infoAmb.append(obj_)
            obj_.original_tagname_ = 'infoAmb'
# end class iniAposentEspType


class altAposentEspType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, dtAltCondicao=None, infoamb=None):
        self.original_tagname_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, altAposentEspType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if altAposentEspType.subclass:
            return altAposentEspType.subclass(*args_, **kwargs_)
        else:
            return altAposentEspType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_dtAltCondicao(self): return self.dtAltCondicao
    def set_dtAltCondicao(self, dtAltCondicao): self.dtAltCondicao = dtAltCondicao
    def get_infoamb(self): return self.infoamb
    ...
    def insert_infoamb_at(self, index, value): self.infoamb.insert(index, value)
    def replace_infoamb_at(self, index, value): self.infoamb[index] = value
    def validate_dtAltCondicaoType2(self, value):
        # Validate type dtAltCondicaoType2, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='altAposentEspType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('altAposentEspType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='altAposentEspType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='altAposentEspType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='altAposentEspType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='altAposentEspType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dtAltCondicao':
            ...
            dval_ = self.gds_parse_date(sval_)
            self.dtAltCondicao = dval_
            # validate type dtAltCondicaoType2
            self.validate_dtAltCondicaoType2(self.dtAltCondicao)
        elif nodeName_ == 'infoamb':
            obj_ = TinfoAmbiente.factory()
            obj_.build(child_)
            self.infoamb.append(obj_)
            obj_.original_tagname_ = 'infoamb'
# end class altAposentEspType


class fimAposentEspType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, dtFimCondicao=None, infoAmb=None):
        self.original_tagname_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, fimAposentEspType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if fimAposentEspType.subclass:
            return fimAposentEspType.subclass(*args_, **kwargs_)
        else:
            return fimAposentEspType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_dtFimCondicao(self): return self.dtFimCondicao
    def set_dtFimCondicao(self, dtFimCondicao): self.dtFimCondicao = dtFimCondicao
    def get_infoAmb(self): return self.infoAmb
    ...
    def insert_infoAmb_at(self, index, value): self.infoAmb.insert(index, value)
    def replace_infoAmb_at(self, index, value): self.infoAmb[index] = value
    def validate_dtFimCondicaoType3(self, value):
        # Validate type dtFimCondicaoType3, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='fimAposentEspType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('fimAposentEspType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='fimAposentEspType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='fimAposentEspType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='fimAposentEspType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='fimAposentEspType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dtFimCondicao':
            ...
            dval_ = self.gds_parse_date(sval_)
            self.dtFimCondicao = dval_
            # validate type dtFimCondicaoType3
            self.validate_dtFimCondicaoType3(self.dtFimCondicao)
        elif nodeName_ == 'infoAmb':
            obj_ = infoAmbType4.factory()
            obj_.build(child_)
            self.infoAmb.append(obj_)
            obj_.original_tagname_ = 'infoAmb'
# end class fimAposentEspType


class infoAmbType4(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, codAmb=None):
        self.original_tagname_ = None
        self.codAmb = codAmb
        self.validate_codAmbType5(self.codAmb)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoAmbType4)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoAmbType4.subclass:
            return infoAmbType4.subclass(*args_, **kwargs_)
        else:
            return infoAmbType4(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_codAmb(self): return self.codAmb
    def set_codAmb(self, codAmb): self.codAmb = codAmb
    def validate_codAmbType5(self, value):
        # Validate type codAmbType5, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 30:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on codAmbType5' % {"value" : value.encode("utf-8")} )
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on codAmbType5' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            self.codAmb is not None
        ):
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoAmbType4', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoAmbType4')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoAmbType4')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoAmbType4', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoAmbType4'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoAmbType4', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'codAmb':
            ...
            codAmb_ = self.gds_validate_string(codAmb_, node, 'codAmb')
            self.codAmb = codAmb_
            # validate type codAmbType5
            self.validate_codAmbType5(self.codAmb)
# end class infoAmbType4

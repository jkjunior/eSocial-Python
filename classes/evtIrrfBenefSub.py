...
#   ('-o', 'classes/evtIrrfBenef.py')
#   ('-s', 'classes/evtIrrfBenefSub.py')
#   ('--super', 'evtIrrfBenef')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtIrrfBenef.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtIrrfBenef.py" -s "classes/evtIrrfBenefSub.py" --super="evtIrrfBenef" /home/joao/Documents/teste_xsd/xsd/evtIrrfBenef.xsd
#
...
import evtIrrfBenef as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtIrrfBenef=None, Signature=None):
        super(eSocialSub, self).__init__(evtIrrfBenef, Signature, )
...
class evtIrrfBenefTypeSub(supermod.evtIrrfBenefType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, ideTrabalhador=None, infoDep=None, infoIrrf=None):
        super(evtIrrfBenefTypeSub, self).__init__(Id, ideEvento, ideEmpregador, ideTrabalhador, infoDep, infoIrrf, )
supermod.evtIrrfBenefType.subclass = evtIrrfBenefTypeSub
# end class evtIrrfBenefTypeSub


class ideEventoTypeSub(supermod.ideEventoType):
    def __init__(self, nrRecArqBase=None, perApur=None):
        super(ideEventoTypeSub, self).__init__(nrRecArqBase, perApur, )
...
class infoDepTypeSub(supermod.infoDepType):
    def __init__(self, vrDedDep=None):
        super(infoDepTypeSub, self).__init__(vrDedDep, )
supermod.infoDepType.subclass = infoDepTypeSub
# end class infoDepTypeSub


class infoIrrfTypeSub(supermod.infoIrrfType):
    def __init__(self, codCateg=None, indResBr=None, basesIrrf=None, irrf=None, idePgtoExt=None):
        super(infoIrrfTypeSub, self).__init__(codCateg, indResBr, basesIrrf, irrf, idePgtoExt, )
supermod.infoIrrfType.subclass = infoIrrfTypeSub
# end class infoIrrfTypeSub


class basesIrrfTypeSub(supermod.basesIrrfType):
    def __init__(self, tpValor=None, valor=None):
        super(basesIrrfTypeSub, self).__init__(tpValor, valor, )
supermod.basesIrrfType.subclass = basesIrrfTypeSub
# end class basesIrrfTypeSub


class irrfTypeSub(supermod.irrfType):
    def __init__(self, tpCR=None, vrIrrfDesc=None):
        super(irrfTypeSub, self).__init__(tpCR, vrIrrfDesc, )
supermod.irrfType.subclass = irrfTypeSub
# end class irrfTypeSub

...
#   ('-o', 'classes/evtIrrf.py')
#   ('-s', 'classes/evtIrrfSub.py')
#   ('--super', 'evtIrrf')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtIrrf.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtIrrf.py" -s "classes/evtIrrfSub.py" --super="evtIrrf" /home/joao/Documents/teste_xsd/xsd/evtIrrf.xsd
#
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtIrrf=None, Signature=None):
        super(eSocialSub, self).__init__(evtIrrf, Signature, )
...
class evtIrrfTypeSub(supermod.evtIrrfType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, infoIRRF=None):
        super(evtIrrfTypeSub, self).__init__(Id, ideEvento, ideEmpregador, infoIRRF, )
supermod.evtIrrfType.subclass = evtIrrfTypeSub
# end class evtIrrfTypeSub


class ideEventoTypeSub(supermod.ideEventoType):
    def __init__(self, perApur=None):
        super(ideEventoTypeSub, self).__init__(perApur, )
...
class infoIRRFTypeSub(supermod.infoIRRFType):
    def __init__(self, nrRecArqBase=None, indExistInfo=None, infoCRContrib=None):
        super(infoIRRFTypeSub, self).__init__(nrRecArqBase, indExistInfo, infoCRContrib, )
...
class infoCRContribTypeSub(supermod.infoCRContribType):
    def __init__(self, tpCR=None, vrCR=None):
        super(infoCRContribTypeSub, self).__init__(tpCR, vrCR, )

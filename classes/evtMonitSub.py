...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtMonit=None, Signature=None):
        super(eSocialSub, self).__init__(evtMonit, Signature, )
...
class TIdeVinculoEstagSub(supermod.TIdeVinculoEstag):
    def __init__(self, cpfTrab=None, nisTrab=None, matricula=None):
        super(TIdeVinculoEstagSub, self).__init__(cpfTrab, nisTrab, matricula, )
supermod.TIdeVinculoEstag.subclass = TIdeVinculoEstagSub
# end class TIdeVinculoEstagSub


class TMedicoSub(supermod.TMedico):
    def __init__(self, nmMed=None, crm=None):
        super(TMedicoSub, self).__init__(nmMed, crm, )
supermod.TMedico.subclass = TMedicoSub
# end class TMedicoSub


class TCrmSub(supermod.TCrm):
    def __init__(self, nrCRM=None, ufCRM=None):
        super(TCrmSub, self).__init__(nrCRM, ufCRM, )
supermod.TCrm.subclass = TCrmSub
# end class TCrmSub
...
class evtMonitTypeSub(supermod.evtMonitType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, ideVinculo=None, aso=None):
        super(evtMonitTypeSub, self).__init__(Id, ideEvento, ideEmpregador, ideVinculo, aso, )
supermod.evtMonitType.subclass = evtMonitTypeSub
# end class evtMonitTypeSub


class asoTypeSub(supermod.asoType):
    def __init__(self, dtAso=None, tpAso=None, resAso=None, exame=None, ideServSaude=None):
        super(asoTypeSub, self).__init__(dtAso, tpAso, resAso, exame, ideServSaude, )
supermod.asoType.subclass = asoTypeSub
# end class asoTypeSub


class exameTypeSub(supermod.exameType):
    def __init__(self, dtExm=None, procRealizado=None, obsProc=None, interprExm=None, ordExame=None, dtIniMonit=None, dtFimMonit=None, indResult=None, respMonit=None):
        super(exameTypeSub, self).__init__(dtExm, procRealizado, obsProc, interprExm, ordExame, dtIniMonit, dtFimMonit, indResult, respMonit, )
supermod.exameType.subclass = exameTypeSub
# end class exameTypeSub


class respMonitTypeSub(supermod.respMonitType):
    def __init__(self, nisResp=None, nrConsClasse=None, ufConsClasse=None):
        super(respMonitTypeSub, self).__init__(nisResp, nrConsClasse, ufConsClasse, )
supermod.respMonitType.subclass = respMonitTypeSub
# end class respMonitTypeSub


class ideServSaudeTypeSub(supermod.ideServSaudeType):
    def __init__(self, codCNES=None, frmCtt=None, email=None, medico=None):
        super(ideServSaudeTypeSub, self).__init__(codCNES, frmCtt, email, medico, )
supermod.ideServSaudeType.subclass = ideServSaudeTypeSub
# end class ideServSaudeTypeSub

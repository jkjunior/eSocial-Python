...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtReintegr is not None:
            self.evtReintegr.export(outfile, level, namespaceprefix_, name_='evtReintegr', pretty_print=pretty_print)
...
class evtReintegrType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtReintegrType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtReintegrType.subclass:
            return evtReintegrType.subclass(*args_, **kwargs_)
        else:
            return evtReintegrType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtReintegrType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtReintegrType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtReintegrType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtReintegrType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtReintegrType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtReintegrType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoReintegr is not None:
            self.infoReintegr.export(outfile, level, namespaceprefix_, name_='infoReintegr', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ideEvento':
            ...
            obj_ = infoReintegrType.factory()
            obj_.build(child_)
            self.infoReintegr = obj_
            obj_.original_tagname_ = 'infoReintegr'
# end class evtReintegrType


class infoReintegrType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, tpReint=None, nrProcJud=None, nrLeiAnistia=None, dtEfetRetorno=None, dtEfeito=None, indPagtoJuizo=None):
        ...
        self.validate_indPagtoJuizoType(self.indPagtoJuizo)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoReintegrType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoReintegrType.subclass:
            return infoReintegrType.subclass(*args_, **kwargs_)
        else:
            return infoReintegrType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_tpReintType(self, value):
        # Validate type tpReintType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tpReintType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_tpReintType_patterns_, ))
    validate_tpReintType_patterns_ = [['^\\d$']]
    ...
    def validate_nrLeiAnistiaType(self, value):
        # Validate type nrLeiAnistiaType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_nrLeiAnistiaType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_nrLeiAnistiaType_patterns_, ))
    validate_nrLeiAnistiaType_patterns_ = [['^\\w{5,13}$']]
    def validate_dtEfetRetornoType(self, value):
        # Validate type dtEfetRetornoType, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def validate_dtEfeitoType(self, value):
        # Validate type dtEfeitoType, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def validate_indPagtoJuizoType(self, value):
        # Validate type indPagtoJuizoType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_indPagtoJuizoType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_indPagtoJuizoType_patterns_, ))
    validate_indPagtoJuizoType_patterns_ = [['^[N|S]$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoReintegrType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoReintegrType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoReintegrType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoReintegrType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoReintegrType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoReintegrType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.tpReint is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tpReint>%s</tpReint>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.tpReint), input_name='tpReint')), eol_))
        ...
        if self.nrLeiAnistia is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nrLeiAnistia>%s</nrLeiAnistia>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.nrLeiAnistia), input_name='nrLeiAnistia')), eol_))
        if self.dtEfetRetorno is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtEfetRetorno>%s</dtEfetRetorno>%s' % (self.gds_format_date(self.dtEfetRetorno, input_name='dtEfetRetorno'), eol_))
        if self.dtEfeito is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtEfeito>%s</dtEfeito>%s' % (self.gds_format_date(self.dtEfeito, input_name='dtEfeito'), eol_))
        if self.indPagtoJuizo is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<indPagtoJuizo>%s</indPagtoJuizo>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.indPagtoJuizo), input_name='indPagtoJuizo')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpReint':
            tpReint_ = child_.text
            tpReint_ = self.gds_validate_string(tpReint_, node, 'tpReint')
            self.tpReint = tpReint_
            # validate type tpReintType
            self.validate_tpReintType(self.tpReint)
            ...
            # validate type nrLeiAnistiaType
            self.validate_nrLeiAnistiaType(self.nrLeiAnistia)
        elif nodeName_ == 'dtEfetRetorno':
            sval_ = child_.text
            dval_ = self.gds_parse_date(sval_)
            self.dtEfetRetorno = dval_
            # validate type dtEfetRetornoType
            self.validate_dtEfetRetornoType(self.dtEfetRetorno)
        elif nodeName_ == 'dtEfeito':
            sval_ = child_.text
            dval_ = self.gds_parse_date(sval_)
            self.dtEfeito = dval_
            # validate type dtEfeitoType
            self.validate_dtEfeitoType(self.dtEfeito)
            ...
            # validate type indPagtoJuizoType
            self.validate_indPagtoJuizoType(self.indPagtoJuizo)
# end class infoReintegrType

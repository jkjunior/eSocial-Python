...
#   ('-o', 'classes/evtReintegr.py')
#   ('-s', 'classes/evtReintegrSub.py')
#   ('--super', 'evtReintegr')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtReintegr.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtReintegr.py" -s "classes/evtReintegrSub.py" --super="evtReintegr" /home/joao/Documents/teste_xsd/xsd/evtReintegr.xsd
#
...
import evtReintegr as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtReintegr=None, Signature=None):
        super(eSocialSub, self).__init__(evtReintegr, Signature, )
...
class evtReintegrTypeSub(supermod.evtReintegrType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, ideVinculo=None, infoReintegr=None):
        super(evtReintegrTypeSub, self).__init__(Id, ideEvento, ideEmpregador, ideVinculo, infoReintegr, )
supermod.evtReintegrType.subclass = evtReintegrTypeSub
# end class evtReintegrTypeSub


class infoReintegrTypeSub(supermod.infoReintegrType):
    def __init__(self, tpReint=None, nrProcJud=None, nrLeiAnistia=None, dtEfetRetorno=None, dtEfeito=None, indPagtoJuizo=None):
        super(infoReintegrTypeSub, self).__init__(tpReint, nrProcJud, nrLeiAnistia, dtEfetRetorno, dtEfeito, indPagtoJuizo, )
supermod.infoReintegrType.subclass = infoReintegrTypeSub
# end class infoReintegrTypeSub

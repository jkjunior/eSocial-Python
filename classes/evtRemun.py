...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtRemun is not None:
            self.evtRemun.export(outfile, level, namespaceprefix_, name_='evtRemun', pretty_print=pretty_print)
...
class TEmpregador(GeneratedsSuper):
    ...
    def __init__(self, tpInsc=None, nrInsc=None):
        self.original_tagname_ = None
        self.tpInsc = tpInsc
        self.validate_tpInscType11(self.tpInsc)
        self.nrInsc = nrInsc
        self.validate_nrInscType12(self.nrInsc)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def validate_tpInscType11(self, value):
        # Validate type tpInscType11, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tpInscType11_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_tpInscType11_patterns_, ))
    validate_tpInscType11_patterns_ = [['^\\d$']]
    def validate_nrInscType12(self, value):
        # Validate type nrInscType12, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_nrInscType12_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_nrInscType12_patterns_, ))
    validate_nrInscType12_patterns_ = [['^\\d{8,15}$']]
    def hasContent_(self):
        if (
...
class TRemunOutrasEmpresas(GeneratedsSuper):
    ...
    def __init__(self, tpInsc=None, nrInsc=None, codCateg=None, vlrRemunOE=None):
        self.original_tagname_ = None
        self.tpInsc = tpInsc
        self.validate_tpInscType13(self.tpInsc)
        self.nrInsc = nrInsc
        self.validate_nrInscType14(self.nrInsc)
        self.codCateg = codCateg
        self.validate_codCategType15(self.codCateg)
    ...
    def validate_tpInscType13(self, value):
        # Validate type tpInscType13, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tpInscType13_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_tpInscType13_patterns_, ))
    validate_tpInscType13_patterns_ = [['^\\d$']]
    def validate_nrInscType14(self, value):
        # Validate type nrInscType14, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_nrInscType14_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_nrInscType14_patterns_, ))
    validate_nrInscType14_patterns_ = [['^\\d{8,15}$']]
    def validate_codCategType15(self, value):
        # Validate type codCategType15, a restriction on xs:integer.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_codCategType15_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_codCategType15_patterns_, ))
    validate_codCategType15_patterns_ = [['^\\d{3}$']]
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpInsc':
            ...
            tpInsc_ = self.gds_validate_string(tpInsc_, node, 'tpInsc')
            self.tpInsc = tpInsc_
            # validate type tpInscType13
            self.validate_tpInscType13(self.tpInsc)
        elif nodeName_ == 'nrInsc':
            nrInsc_ = child_.text
            nrInsc_ = self.gds_validate_string(nrInsc_, node, 'nrInsc')
            self.nrInsc = nrInsc_
            # validate type nrInscType14
            self.validate_nrInscType14(self.nrInsc)
...
class TItemRemuneracao(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TItemRemuneracao', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TItemRemuneracao')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TItemRemuneracao', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TItemRemuneracao'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TItemRemuneracao', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class evtRemunType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtRemunType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtRemunType.subclass:
            return evtRemunType.subclass(*args_, **kwargs_)
        else:
            return evtRemunType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtRemunType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtRemunType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtRemunType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtRemunType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtRemunType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtRemunType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ideTrabalhadorType(GeneratedsSuper):
    ...
    def get_infoInterm(self): return self.infoInterm
    def set_infoInterm(self, infoInterm): self.infoInterm = infoInterm
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideTrabalhadorType', fromsubclass_=False, pretty_print=True):
        ...
        if self.infoComplem is not None:
            self.infoComplem.export(outfile, level, namespaceprefix_, name_='infoComplem', pretty_print=pretty_print)
        ...
        if self.infoInterm is not None:
            self.infoInterm.export(outfile, level, namespaceprefix_, name_='infoInterm', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'infoInterm':
            obj_ = infoIntermType.factory()
            obj_.build(child_)
            self.infoInterm = obj_
            obj_.original_tagname_ = 'infoInterm'
...
class infoComplemType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoComplemType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoComplemType.subclass:
            return infoComplemType.subclass(*args_, **kwargs_)
        else:
            return infoComplemType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoComplemType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoComplemType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoComplemType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoComplemType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoComplemType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoComplemType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infoIntermType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoIntermType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoIntermType.subclass:
            return infoIntermType.subclass(*args_, **kwargs_)
        else:
            return infoIntermType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            self.qtdDiasInterm is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoIntermType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoIntermType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoIntermType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoIntermType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoIntermType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoIntermType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class dmDevType(GeneratedsSuper):
    ...
    def __init__(self, ideDmDev=None, codCateg=None, infoPerApur=None, infoPerAnt=None, infoComplCont=None):
        ...
        self.infoComplCont = infoComplCont
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def get_infoComplCont(self): return self.infoComplCont
    def set_infoComplCont(self, infoComplCont): self.infoComplCont = infoComplCont
    ...
    def hasContent_(self):
        if (
            ...
            self.infoComplCont is not None
        ):
            return True
        else:
            return False
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='dmDevType', fromsubclass_=False, pretty_print=True):
        ...
        if self.infoComplCont is not None:
            self.infoComplCont.export(outfile, level, namespaceprefix_, name_='infoComplCont', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'infoComplCont':
            obj_ = infoComplContType.factory()
            obj_.build(child_)
            self.infoComplCont = obj_
            obj_.original_tagname_ = 'infoComplCont'
# end class dmDevType
...
class ideEstabLotType(GeneratedsSuper):
    ...
    def __init__(self, tpInsc=None, nrInsc=None, codLotacao=None, qtdDiasAv=None, remunPerApur=None):
        ...
        self.validate_qtdDiasAvType(self.qtdDiasAv)
    ...
    def validate_qtdDiasAvType(self, value):
        # Validate type qtdDiasAvType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_qtdDiasAvType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_qtdDiasAvType_patterns_, ))
    validate_qtdDiasAvType_patterns_ = [['^\\d{1,2}$']]
    def hasContent_(self):
        if (
            self.tpInsc is not None or
            self.nrInsc is not None or
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideEstabLotType', fromsubclass_=False, pretty_print=True):
        ...
        if self.qtdDiasAv is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<qtdDiasAv>%s</qtdDiasAv>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.qtdDiasAv), input_name='qtdDiasAv')), eol_))
        for remunPerApur_ in self.remunPerApur:
            remunPerApur_.export(outfile, level, namespaceprefix_, name_='remunPerApur', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpInsc':
            ...
            qtdDiasAv_ = child_.text
            qtdDiasAv_ = self.gds_validate_string(qtdDiasAv_, node, 'qtdDiasAv')
            self.qtdDiasAv = qtdDiasAv_
            # validate type qtdDiasAvType
            self.validate_qtdDiasAvType(self.qtdDiasAv)
        elif nodeName_ == 'remunPerApur':
            obj_ = remunPerApurType.factory()
            obj_.build(child_)
...
class remunPerApurType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, remunPerApurType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if remunPerApurType.subclass:
            return remunPerApurType.subclass(*args_, **kwargs_)
        else:
            return remunPerApurType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='remunPerApurType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('remunPerApurType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='remunPerApurType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='remunPerApurType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='remunPerApurType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='remunPerApurType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for itensRemun_ in self.itensRemun:
            itensRemun_.export(outfile, level, namespaceprefix_, name_='itensRemun', pretty_print=pretty_print)
...
class ideADCType(GeneratedsSuper):
    ...
    def __init__(self, dtAcConv=None, tpAcConv=None, compAcConv=None, dtEfAcConv=None, dsc=None, remunSuc=None, idePeriodo=None):
        ...
        self.validate_remunSucType(self.remunSuc)
    ...
    def validate_remunSucType(self, value):
        # Validate type remunSucType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_remunSucType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_remunSucType_patterns_, ))
    validate_remunSucType_patterns_ = [['^[N|S]$']]
    def hasContent_(self):
        if (
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideADCType', fromsubclass_=False, pretty_print=True):
        ...
        if self.remunSuc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<remunSuc>%s</remunSuc>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.remunSuc), input_name='remunSuc')), eol_))
...
class ideEstabLotType1(GeneratedsSuper):
    ...
    def get_codLotacao(self): return self.codLotacao
    def set_codLotacao(self, codLotacao): self.codLotacao = codLotacao
    def get_remunPerAnt(self): return self.remunPerAnt
    def set_remunPerAnt(self, remunPerAnt): self.remunPerAnt = remunPerAnt
    def add_remunPerAnt(self, value): self.remunPerAnt.append(value)
    def insert_remunPerAnt_at(self, index, value): self.remunPerAnt.insert(index, value)
    def replace_remunPerAnt_at(self, index, value): self.remunPerAnt[index] = value
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideEstabLotType1', fromsubclass_=False, pretty_print=True):
        ...
        if self.codLotacao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<codLotacao>%s</codLotacao>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.codLotacao), input_name='codLotacao')), eol_))
        for remunPerAnt_ in self.remunPerAnt:
            remunPerAnt_.export(outfile, level, namespaceprefix_, name_='remunPerAnt', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpInsc':
            ...
            self.validate_codLotacaoType4(self.codLotacao)
        elif nodeName_ == 'remunPerAnt':
            obj_ = remunPerAntType.factory()
            obj_.build(child_)
            self.remunPerAnt.append(obj_)
            obj_.original_tagname_ = 'remunPerAnt'
# end class ideEstabLotType1


class remunPerAntType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, matricula=None, indSimples=None, itensRemun=None, infoAgNocivo=None, infoTrabInterm=None):
        self.original_tagname_ = None
        self.matricula = matricula
        self.validate_matriculaType5(self.matricula)
        self.indSimples = indSimples
        self.validate_indSimplesType6(self.indSimples)
        if itensRemun is None:
            self.itensRemun = []
        else:
            self.itensRemun = itensRemun
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, remunPerAntType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if remunPerAntType.subclass:
            return remunPerAntType.subclass(*args_, **kwargs_)
        else:
            return remunPerAntType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_matricula(self): return self.matricula
    def set_matricula(self, matricula): self.matricula = matricula
    def get_indSimples(self): return self.indSimples
    ...
    def insert_infoTrabInterm_at(self, index, value): self.infoTrabInterm.insert(index, value)
    def replace_infoTrabInterm_at(self, index, value): self.infoTrabInterm[index] = value
    def validate_matriculaType5(self, value):
        # Validate type matriculaType5, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 30:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on matriculaType5' % {"value" : value.encode("utf-8")} )
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on matriculaType5' % {"value" : value.encode("utf-8")} )
    def validate_indSimplesType6(self, value):
        # Validate type indSimplesType6, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_indSimplesType6_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_indSimplesType6_patterns_, ))
    validate_indSimplesType6_patterns_ = [['^\\d$']]
    def hasContent_(self):
        if (
            self.matricula is not None or
            self.indSimples is not None or
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='remunPerAntType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('remunPerAntType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='remunPerAntType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='remunPerAntType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='remunPerAntType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='remunPerAntType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'matricula':
            ...
            matricula_ = self.gds_validate_string(matricula_, node, 'matricula')
            self.matricula = matricula_
            # validate type matriculaType5
            self.validate_matriculaType5(self.matricula)
        elif nodeName_ == 'indSimples':
            indSimples_ = child_.text
            indSimples_ = self.gds_validate_string(indSimples_, node, 'indSimples')
            self.indSimples = indSimples_
            # validate type indSimplesType6
            self.validate_indSimplesType6(self.indSimples)
        elif nodeName_ == 'itensRemun':
            obj_ = TItemRemuneracao.factory()
            obj_.build(child_)
            ...
            obj_ = infoAgNocivoType7.factory()
            obj_.build(child_)
            self.infoAgNocivo = obj_
            obj_.original_tagname_ = 'infoAgNocivo'
        elif nodeName_ == 'infoTrabInterm':
            obj_ = infoTrabIntermType9.factory()
            obj_.build(child_)
            self.infoTrabInterm.append(obj_)
            obj_.original_tagname_ = 'infoTrabInterm'
# end class remunPerAntType


class infoAgNocivoType7(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, grauExp=None):
        self.original_tagname_ = None
        self.grauExp = grauExp
        self.validate_grauExpType8(self.grauExp)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoAgNocivoType7)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoAgNocivoType7.subclass:
            return infoAgNocivoType7.subclass(*args_, **kwargs_)
        else:
            return infoAgNocivoType7(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_grauExp(self): return self.grauExp
    def set_grauExp(self, grauExp): self.grauExp = grauExp
    def validate_grauExpType8(self, value):
        # Validate type grauExpType8, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_grauExpType8_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_grauExpType8_patterns_, ))
    validate_grauExpType8_patterns_ = [['^\\d$']]
    def hasContent_(self):
        if (
            self.grauExp is not None
        ):
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoAgNocivoType7', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoAgNocivoType7')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoAgNocivoType7')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoAgNocivoType7', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoAgNocivoType7'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoAgNocivoType7', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'grauExp':
            ...
            grauExp_ = self.gds_validate_string(grauExp_, node, 'grauExp')
            self.grauExp = grauExp_
            # validate type grauExpType8
            self.validate_grauExpType8(self.grauExp)
# end class infoAgNocivoType7


class infoTrabIntermType9(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, codConv=None):
        self.original_tagname_ = None
        self.codConv = codConv
        self.validate_codConvType10(self.codConv)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoTrabIntermType9)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoTrabIntermType9.subclass:
            return infoTrabIntermType9.subclass(*args_, **kwargs_)
        else:
            return infoTrabIntermType9(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_codConv(self): return self.codConv
    def set_codConv(self, codConv): self.codConv = codConv
    def validate_codConvType10(self, value):
        # Validate type codConvType10, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 30:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on codConvType10' % {"value" : value.encode("utf-8")} )
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on codConvType10' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            self.codConv is not None
        ):
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoTrabIntermType9', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoTrabIntermType9')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoTrabIntermType9')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoTrabIntermType9', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoTrabIntermType9'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoTrabIntermType9', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'codConv':
            ...
            codConv_ = self.gds_validate_string(codConv_, node, 'codConv')
            self.codConv = codConv_
            # validate type codConvType10
            self.validate_codConvType10(self.codConv)
# end class infoTrabIntermType9


class infoComplContType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, codCBO=None, natAtividade=None, qtdDiasTrab=None):
        self.original_tagname_ = None
        self.codCBO = codCBO
        self.validate_codCBOType(self.codCBO)
        self.natAtividade = natAtividade
        self.validate_natAtividadeType(self.natAtividade)
        self.qtdDiasTrab = qtdDiasTrab
        self.validate_qtdDiasTrabType(self.qtdDiasTrab)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoComplContType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoComplContType.subclass:
            return infoComplContType.subclass(*args_, **kwargs_)
        else:
            return infoComplContType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_codCBOType(self, value):
        # Validate type codCBOType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_codCBOType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_codCBOType_patterns_, ))
    validate_codCBOType_patterns_ = [['^\\d{4,6}$']]
    ...
    def validate_qtdDiasTrabType(self, value):
        # Validate type qtdDiasTrabType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_qtdDiasTrabType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_qtdDiasTrabType_patterns_, ))
    validate_qtdDiasTrabType_patterns_ = [['^\\d{1,2}$']]
    def hasContent_(self):
        if (
            self.codCBO is not None or
            self.natAtividade is not None or
            self.qtdDiasTrab is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoComplContType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoComplContType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoComplContType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoComplContType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoComplContType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoComplContType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.codCBO is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<codCBO>%s</codCBO>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.codCBO), input_name='codCBO')), eol_))
        ...
        if self.qtdDiasTrab is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<qtdDiasTrab>%s</qtdDiasTrab>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.qtdDiasTrab), input_name='qtdDiasTrab')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'codCBO':
            ...
            qtdDiasTrab_ = child_.text
            qtdDiasTrab_ = self.gds_validate_string(qtdDiasTrab_, node, 'qtdDiasTrab')
            self.qtdDiasTrab = qtdDiasTrab_
            # validate type qtdDiasTrabType
            self.validate_qtdDiasTrabType(self.qtdDiasTrab)
# end class infoComplContType
...
class detPlanoType(GeneratedsSuper):
    ...
    def validate_dtNasctoType16(self, value):
        # Validate type dtNasctoType16, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpDep':
            ...
            dval_ = self.gds_parse_date(sval_)
            self.dtNascto = dval_
            # validate type dtNasctoType16
            self.validate_dtNasctoType16(self.dtNascto)

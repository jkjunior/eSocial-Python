...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtRmnRPPS is not None:
            self.evtRmnRPPS.export(outfile, level, namespaceprefix_, name_='evtRmnRPPS', pretty_print=pretty_print)
...
class TIdeEveFopag(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TIdeEveFopag', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TIdeEveFopag')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TIdeEveFopag', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TIdeEveFopag'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TIdeEveFopag', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TEmprPJ(GeneratedsSuper):
    ...
    def __init__(self, tpInsc=None, nrInsc=None):
        self.original_tagname_ = None
        self.tpInsc = tpInsc
        self.validate_tpInscType6(self.tpInsc)
        self.nrInsc = nrInsc
        self.validate_nrInscType7(self.nrInsc)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def validate_tpInscType6(self, value):
        # Validate type tpInscType6, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tpInscType6_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_tpInscType6_patterns_, ))
    validate_tpInscType6_patterns_ = [['^\\d$']]
    def validate_nrInscType7(self, value):
        # Validate type nrInscType7, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_nrInscType7_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_nrInscType7_patterns_, ))
    validate_nrInscType7_patterns_ = [['^\\d{8,15}$']]
    def hasContent_(self):
        if (
...
class TItemRemunRPPS(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TItemRemunRPPS', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TItemRemunRPPS')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TItemRemunRPPS', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TItemRemunRPPS'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TItemRemunRPPS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class evtRmnRPPSType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtRmnRPPSType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtRmnRPPSType.subclass:
            return evtRmnRPPSType.subclass(*args_, **kwargs_)
        else:
            return evtRmnRPPSType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtRmnRPPSType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtRmnRPPSType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtRmnRPPSType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtRmnRPPSType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtRmnRPPSType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtRmnRPPSType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ideTrabalhadorType(GeneratedsSuper):
    ...
    def __init__(self, cpfTrab=None, nisTrab=None, qtdDepFP=None, procJudTrab=None):
        ...
        self.validate_qtdDepFPType(self.qtdDepFP)
    ...
    def validate_qtdDepFPType(self, value):
        # Validate type qtdDepFPType, a restriction on xs:nonNegativeInteger.
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 2:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on qtdDepFPType' % {"value" : value} )
    def hasContent_(self):
        if (
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideTrabalhadorType', fromsubclass_=False, pretty_print=True):
        ...
        if self.qtdDepFP is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<qtdDepFP>%s</qtdDepFP>%s' % (self.gds_format_integer(self.qtdDepFP, input_name='qtdDepFP'), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'cpfTrab':
            ...
            self.validate_nisTrabType(self.nisTrab)
        elif nodeName_ == 'qtdDepFP' and child_.text:
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
...
class ideEstabType1(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ideEstabType1)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ideEstabType1.subclass:
            return ideEstabType1.subclass(*args_, **kwargs_)
        else:
            return ideEstabType1(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_tpInsc(self): return self.tpInsc
    def set_tpInsc(self, tpInsc): self.tpInsc = tpInsc
    def get_nrInsc(self): return self.nrInsc
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='ideEstabType1', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ideEstabType1')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ideEstabType1')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='ideEstabType1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ideEstabType1'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideEstabType1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class remunPerAntType(GeneratedsSuper):
    ...
    def __init__(self, matricula=None, codCateg=None, itensRemun=None):
        self.original_tagname_ = None
        self.matricula = matricula
        self.validate_matriculaType4(self.matricula)
        self.codCateg = codCateg
    ...
    def insert_itensRemun_at(self, index, value): self.itensRemun.insert(index, value)
    def replace_itensRemun_at(self, index, value): self.itensRemun[index] = value
    def validate_matriculaType4(self, value):
        # Validate type matriculaType4, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 30:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on matriculaType4' % {"value" : value.encode("utf-8")} )
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on matriculaType4' % {"value" : value.encode("utf-8")} )

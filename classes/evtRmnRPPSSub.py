...
#   ('-o', 'classes/evtRmnRPPS.py')
#   ('-s', 'classes/evtRmnRPPSSub.py')
#   ('--super', 'evtRmnRPPS')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtRmnRPPS.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtRmnRPPS.py" -s "classes/evtRmnRPPSSub.py" --super="evtRmnRPPS" /home/joao/Documents/teste_xsd/xsd/evtRmnRPPS.xsd
#
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtRmnRPPS=None, Signature=None):
        super(eSocialSub, self).__init__(evtRmnRPPS, Signature, )
supermod.eSocial.subclass = eSocialSub
# end class eSocialSub


class TIdeEveFopagSub(supermod.TIdeEveFopag):
    def __init__(self, indRetif=None, nrRecibo=None, indApuracao=None, perApur=None, tpAmb=None, procEmi=None, verProc=None):
        super(TIdeEveFopagSub, self).__init__(indRetif, nrRecibo, indApuracao, perApur, tpAmb, procEmi, verProc, )
supermod.TIdeEveFopag.subclass = TIdeEveFopagSub
# end class TIdeEveFopagSub
...
class TItemRemunRPPSSub(supermod.TItemRemunRPPS):
    def __init__(self, codRubr=None, ideTabRubr=None, qtdRubr=None, fatorRubr=None, vrUnit=None, vrRubr=None):
        super(TItemRemunRPPSSub, self).__init__(codRubr, ideTabRubr, qtdRubr, fatorRubr, vrUnit, vrRubr, )
supermod.TItemRemunRPPS.subclass = TItemRemunRPPSSub
# end class TItemRemunRPPSSub
...
class evtRmnRPPSTypeSub(supermod.evtRmnRPPSType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, ideTrabalhador=None, dmDev=None):
        super(evtRmnRPPSTypeSub, self).__init__(Id, ideEvento, ideEmpregador, ideTrabalhador, dmDev, )
supermod.evtRmnRPPSType.subclass = evtRmnRPPSTypeSub
# end class evtRmnRPPSTypeSub
...
class ideTrabalhadorTypeSub(supermod.ideTrabalhadorType):
    def __init__(self, cpfTrab=None, nisTrab=None, qtdDepFP=None, procJudTrab=None):
        super(ideTrabalhadorTypeSub, self).__init__(cpfTrab, nisTrab, qtdDepFP, procJudTrab, )
...
class dmDevTypeSub(supermod.dmDevType):
    def __init__(self, ideDmDev=None, infoPerApur=None, infoPerAnt=None):
        super(dmDevTypeSub, self).__init__(ideDmDev, infoPerApur, infoPerAnt, )
...
class infoPerApurTypeSub(supermod.infoPerApurType):
    def __init__(self, ideEstab=None):
        super(infoPerApurTypeSub, self).__init__(ideEstab, )
...
class ideEstabTypeSub(supermod.ideEstabType):
    def __init__(self, tpInsc=None, nrInsc=None, remunPerApur=None):
        super(ideEstabTypeSub, self).__init__(tpInsc, nrInsc, remunPerApur, )
...
class remunPerApurTypeSub(supermod.remunPerApurType):
    def __init__(self, matricula=None, codCateg=None, itensRemun=None, infoSaudeColet=None):
        super(remunPerApurTypeSub, self).__init__(matricula, codCateg, itensRemun, infoSaudeColet, )
...
class ideADCTypeSub(supermod.ideADCType):
    def __init__(self, dtLei=None, nrLei=None, dtEf=None, idePeriodo=None):
        super(ideADCTypeSub, self).__init__(dtLei, nrLei, dtEf, idePeriodo, )
...
class idePeriodoTypeSub(supermod.idePeriodoType):
    def __init__(self, perRef=None, ideEstab=None):
        super(idePeriodoTypeSub, self).__init__(perRef, ideEstab, )
supermod.idePeriodoType.subclass = idePeriodoTypeSub
# end class idePeriodoTypeSub


class ideEstabType1Sub(supermod.ideEstabType1):
    def __init__(self, tpInsc=None, nrInsc=None, remunPerAnt=None):
        super(ideEstabType1Sub, self).__init__(tpInsc, nrInsc, remunPerAnt, )
supermod.ideEstabType1.subclass = ideEstabType1Sub
# end class ideEstabType1Sub


class remunPerAntTypeSub(supermod.remunPerAntType):
    def __init__(self, matricula=None, codCateg=None, itensRemun=None):
        super(remunPerAntTypeSub, self).__init__(matricula, codCateg, itensRemun, )

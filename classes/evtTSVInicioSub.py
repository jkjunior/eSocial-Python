...
import evtTSVInicio as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtTSVInicio=None, Signature=None):
        super(eSocialSub, self).__init__(evtTSVInicio, Signature, )
...
class TCessaoTrabSub(supermod.TCessaoTrab):
    def __init__(self, categOrig=None, cnpjCednt=None, matricCed=None, dtAdmCed=None, tpRegTrab=None, tpRegPrev=None, infOnus=None):
        super(TCessaoTrabSub, self).__init__(categOrig, cnpjCednt, matricCed, dtAdmCed, tpRegTrab, tpRegPrev, infOnus, )
supermod.TCessaoTrab.subclass = TCessaoTrabSub
# end class TCessaoTrabSub
...
class evtTSVInicioTypeSub(supermod.evtTSVInicioType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, trabalhador=None, infoTSVInicio=None):
        super(evtTSVInicioTypeSub, self).__init__(Id, ideEvento, ideEmpregador, trabalhador, infoTSVInicio, )
supermod.evtTSVInicioType.subclass = evtTSVInicioTypeSub
# end class evtTSVInicioTypeSub
...
class trabalhadorTypeSub(supermod.trabalhadorType):
    def __init__(self, cpfTrab=None, nisTrab=None, nmTrab=None, sexo=None, racaCor=None, estCiv=None, grauInstr=None, nmSoc=None, nascimento=None, documentos=None, endereco=None, trabEstrangeiro=None, infoDeficiencia=None, dependente=None, contato=None):
        super(trabalhadorTypeSub, self).__init__(cpfTrab, nisTrab, nmTrab, sexo, racaCor, estCiv, grauInstr, nmSoc, nascimento, documentos, endereco, trabEstrangeiro, infoDeficiencia, dependente, contato, )
...
class infoDeficienciaTypeSub(supermod.infoDeficienciaType):
    def __init__(self, defFisica=None, defVisual=None, defAuditiva=None, defMental=None, defIntelectual=None, reabReadap=None, observacao=None):
        super(infoDeficienciaTypeSub, self).__init__(defFisica, defVisual, defAuditiva, defMental, defIntelectual, reabReadap, observacao, )
supermod.infoDeficienciaType.subclass = infoDeficienciaTypeSub
# end class infoDeficienciaTypeSub


class infoTSVInicioTypeSub(supermod.infoTSVInicioType):
    def __init__(self, cadIni=None, codCateg=None, dtInicio=None, natAtividade=None, infoComplementares=None, afastamento=None, termino=None):
        super(infoTSVInicioTypeSub, self).__init__(cadIni, codCateg, dtInicio, natAtividade, infoComplementares, afastamento, termino, )
supermod.infoTSVInicioType.subclass = infoTSVInicioTypeSub
# end class infoTSVInicioTypeSub
...
class infoComplementaresTypeSub(supermod.infoComplementaresType):
    def __init__(self, cargoFuncao=None, remuneracao=None, fgts=None, infoDirigenteSindical=None, infoTrabCedido=None, infoEstagiario=None):
        super(infoComplementaresTypeSub, self).__init__(cargoFuncao, remuneracao, fgts, infoDirigenteSindical, infoTrabCedido, infoEstagiario, )
...
class fgtsTypeSub(supermod.fgtsType):
    def __init__(self, opcFGTS=None, dtOpcFGTS=None):
        super(fgtsTypeSub, self).__init__(opcFGTS, dtOpcFGTS, )
supermod.fgtsType.subclass = fgtsTypeSub
# end class fgtsTypeSub


class infoDirigenteSindicalTypeSub(supermod.infoDirigenteSindicalType):
    def __init__(self, categOrig=None, cnpjOrigem=None, dtAdmOrig=None, matricOrig=None):
        super(infoDirigenteSindicalTypeSub, self).__init__(categOrig, cnpjOrigem, dtAdmOrig, matricOrig, )
supermod.infoDirigenteSindicalType.subclass = infoDirigenteSindicalTypeSub
# end class infoDirigenteSindicalTypeSub
...
class terminoTypeSub(supermod.terminoType):
    def __init__(self, dtTerm=None):
        super(terminoTypeSub, self).__init__(dtTerm, )
supermod.terminoType.subclass = terminoTypeSub
# end class terminoTypeSub

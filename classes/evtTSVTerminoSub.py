...
import evtTSVTermino as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtTSVTermino=None, Signature=None):
        super(eSocialSub, self).__init__(evtTSVTermino, Signature, )
...
class evtTSVTerminoTypeSub(supermod.evtTSVTerminoType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, ideTrabSemVinculo=None, infoTSVTermino=None):
        super(evtTSVTerminoTypeSub, self).__init__(Id, ideEvento, ideEmpregador, ideTrabSemVinculo, infoTSVTermino, )
supermod.evtTSVTerminoType.subclass = evtTSVTerminoTypeSub
# end class evtTSVTerminoTypeSub
...
class infoTSVTerminoTypeSub(supermod.infoTSVTerminoType):
    def __init__(self, dtTerm=None, mtvDesligTSV=None, verbasResc=None, quarentena=None):
        super(infoTSVTerminoTypeSub, self).__init__(dtTerm, mtvDesligTSV, verbasResc, quarentena, )
supermod.infoTSVTerminoType.subclass = infoTSVTerminoTypeSub
# end class infoTSVTerminoTypeSub


class verbasRescTypeSub(supermod.verbasRescType):
    def __init__(self, dmDev=None, procJudTrab=None, infoMV=None):
        super(verbasRescTypeSub, self).__init__(dmDev, procJudTrab, infoMV, )
...
class dmDevTypeSub(supermod.dmDevType):
    def __init__(self, ideDmDev=None, ideEstabLot=None):
        super(dmDevTypeSub, self).__init__(ideDmDev, ideEstabLot, )

...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtTabAmbiente is not None:
            self.evtTabAmbiente.export(outfile, level, namespaceprefix_, name_='evtTabAmbiente', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'evtTabAmbiente':
            obj_ = evtTabAmbienteType.factory()
            obj_.build(child_)
...
class TIdeAmbiente(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TIdeAmbiente', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TIdeAmbiente')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TIdeAmbiente', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TIdeAmbiente'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TIdeAmbiente', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TDadosAmbiente(GeneratedsSuper):
    ...
    def __init__(self, dscAmb=None, localAmb=None, tpInsc=None, nrInsc=None, fatorRisco=None):
        self.original_tagname_ = None
        self.dscAmb = dscAmb
        self.validate_dscAmbType(self.dscAmb)
        self.localAmb = localAmb
        self.validate_localAmbType(self.localAmb)
        self.tpInsc = tpInsc
    ...
    def validate_dscAmbType(self, value):
        # Validate type dscAmbType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 999:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on dscAmbType' % {"value" : value.encode("utf-8")} )
            if len(value) < 3:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on dscAmbType' % {"value" : value.encode("utf-8")} )
    def validate_localAmbType(self, value):
        # Validate type localAmbType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_localAmbType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_localAmbType_patterns_, ))
    validate_localAmbType_patterns_ = [['^\\d$']]
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TDadosAmbiente', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TDadosAmbiente')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TDadosAmbiente', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TDadosAmbiente'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TDadosAmbiente', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.dscAmb is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dscAmb>%s</dscAmb>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.dscAmb), input_name='dscAmb')), eol_))
        if self.localAmb is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<localAmb>%s</localAmb>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.localAmb), input_name='localAmb')), eol_))
        if self.tpInsc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tpInsc>%s</tpInsc>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.tpInsc), input_name='tpInsc')), eol_))
        if self.nrInsc is not None:
        ...
        for fatorRisco_ in self.fatorRisco:
            fatorRisco_.export(outfile, level, namespaceprefix_, name_='fatorRisco', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dscAmb':
            ...
            self.dscAmb = dscAmb_
            # validate type dscAmbType
            self.validate_dscAmbType(self.dscAmb)
        elif nodeName_ == 'localAmb':
            localAmb_ = child_.text
            localAmb_ = self.gds_validate_string(localAmb_, node, 'localAmb')
            self.localAmb = localAmb_
            # validate type localAmbType
            self.validate_localAmbType(self.localAmb)
...
class evtTabAmbienteType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtTabAmbienteType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtTabAmbienteType.subclass:
            return evtTabAmbienteType.subclass(*args_, **kwargs_)
        else:
            return evtTabAmbienteType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtTabAmbienteType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtTabAmbienteType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtTabAmbienteType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtTabAmbienteType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtTabAmbienteType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtTabAmbienteType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoAmbiente is not None:
            self.infoAmbiente.export(outfile, level, namespaceprefix_, name_='infoAmbiente', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ideEvento':
            ...
            obj_ = infoAmbienteType.factory()
            obj_.build(child_)
            self.infoAmbiente = obj_
            obj_.original_tagname_ = 'infoAmbiente'
# end class evtTabAmbienteType


class infoAmbienteType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoAmbienteType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoAmbienteType.subclass:
            return infoAmbienteType.subclass(*args_, **kwargs_)
        else:
            return infoAmbienteType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoAmbienteType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoAmbienteType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoAmbienteType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoAmbienteType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoAmbienteType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoAmbienteType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class inclusaoType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='inclusaoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.ideAmbiente is not None:
            self.ideAmbiente.export(outfile, level, namespaceprefix_, name_='ideAmbiente', pretty_print=pretty_print)
        if self.dadosAmbiente is not None:
            self.dadosAmbiente.export(outfile, level, namespaceprefix_, name_='dadosAmbiente', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class fatorRiscoType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, fatorRiscoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if fatorRiscoType.subclass:
            return fatorRiscoType.subclass(*args_, **kwargs_)
        else:
            return fatorRiscoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='fatorRiscoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('fatorRiscoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='fatorRiscoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='fatorRiscoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='fatorRiscoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='fatorRiscoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''

...
#   ('-o', 'classes/evtTabAmbiente.py')
#   ('-s', 'classes/evtTabAmbienteSub.py')
#   ('--super', 'evtTabAmbiente')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtTabAmbiente.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtTabAmbiente.py" -s "classes/evtTabAmbienteSub.py" --super="evtTabAmbiente" /home/joao/Documents/teste_xsd/xsd/evtTabAmbiente.xsd
#
...
import evtTabAmbiente as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtTabAmbiente=None, Signature=None):
        super(eSocialSub, self).__init__(evtTabAmbiente, Signature, )
...
class TIdeAmbienteSub(supermod.TIdeAmbiente):
    def __init__(self, codAmb=None, iniValid=None, fimValid=None):
        super(TIdeAmbienteSub, self).__init__(codAmb, iniValid, fimValid, )
supermod.TIdeAmbiente.subclass = TIdeAmbienteSub
# end class TIdeAmbienteSub


class TDadosAmbienteSub(supermod.TDadosAmbiente):
    def __init__(self, dscAmb=None, localAmb=None, tpInsc=None, nrInsc=None, fatorRisco=None):
        super(TDadosAmbienteSub, self).__init__(dscAmb, localAmb, tpInsc, nrInsc, fatorRisco, )
supermod.TDadosAmbiente.subclass = TDadosAmbienteSub
# end class TDadosAmbienteSub
...
class evtTabAmbienteTypeSub(supermod.evtTabAmbienteType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, infoAmbiente=None):
        super(evtTabAmbienteTypeSub, self).__init__(Id, ideEvento, ideEmpregador, infoAmbiente, )
supermod.evtTabAmbienteType.subclass = evtTabAmbienteTypeSub
# end class evtTabAmbienteTypeSub


class infoAmbienteTypeSub(supermod.infoAmbienteType):
    def __init__(self, inclusao=None, alteracao=None, exclusao=None):
        super(infoAmbienteTypeSub, self).__init__(inclusao, alteracao, exclusao, )
supermod.infoAmbienteType.subclass = infoAmbienteTypeSub
# end class infoAmbienteTypeSub


class inclusaoTypeSub(supermod.inclusaoType):
    def __init__(self, ideAmbiente=None, dadosAmbiente=None):
        super(inclusaoTypeSub, self).__init__(ideAmbiente, dadosAmbiente, )
...
class alteracaoTypeSub(supermod.alteracaoType):
    def __init__(self, ideAmbiente=None, dadosAmbiente=None, novaValidade=None):
        super(alteracaoTypeSub, self).__init__(ideAmbiente, dadosAmbiente, novaValidade, )
...
class exclusaoTypeSub(supermod.exclusaoType):
    def __init__(self, ideAmbiente=None):
        super(exclusaoTypeSub, self).__init__(ideAmbiente, )
supermod.exclusaoType.subclass = exclusaoTypeSub
# end class exclusaoTypeSub


class fatorRiscoTypeSub(supermod.fatorRiscoType):
    def __init__(self, codFatRis=None):
        super(fatorRiscoTypeSub, self).__init__(codFatRis, )
supermod.fatorRiscoType.subclass = fatorRiscoTypeSub
# end class fatorRiscoTypeSub

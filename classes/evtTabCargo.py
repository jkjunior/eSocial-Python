...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtTabCargo is not None:
            self.evtTabCargo.export(outfile, level, namespaceprefix_, name_='evtTabCargo', pretty_print=pretty_print)
...
class TideCargo(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TideCargo', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TideCargo')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TideCargo', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TideCargo'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TideCargo', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TDadosCargo(GeneratedsSuper):
    ...
    def __init__(self, nmCargo=None, codCBO=None, cargoPublico=None):
        ...
        self.validate_nmCargoType(self.nmCargo)
        self.codCBO = codCBO
    ...
    def validate_nmCargoType(self, value):
        # Validate type nmCargoType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 100:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on nmCargoType' % {"value" : value.encode("utf-8")} )
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on nmCargoType' % {"value" : value.encode("utf-8")} )
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TDadosCargo', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TDadosCargo')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TDadosCargo', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TDadosCargo'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TDadosCargo', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.nmCargo is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nmCargo>%s</nmCargo>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.nmCargo), input_name='nmCargo')), eol_))
        ...
        if self.cargoPublico is not None:
            self.cargoPublico.export(outfile, level, namespaceprefix_, name_='cargoPublico', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class evtTabCargoType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtTabCargoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtTabCargoType.subclass:
            return evtTabCargoType.subclass(*args_, **kwargs_)
        else:
            return evtTabCargoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtTabCargoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtTabCargoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtTabCargoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtTabCargoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtTabCargoType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtTabCargoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoCargo is not None:
            self.infoCargo.export(outfile, level, namespaceprefix_, name_='infoCargo', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ideEvento':
            ...
            obj_ = infoCargoType.factory()
            obj_.build(child_)
            self.infoCargo = obj_
            obj_.original_tagname_ = 'infoCargo'
# end class evtTabCargoType


class infoCargoType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoCargoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoCargoType.subclass:
            return infoCargoType.subclass(*args_, **kwargs_)
        else:
            return infoCargoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoCargoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoCargoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoCargoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoCargoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoCargoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoCargoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class inclusaoType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='inclusaoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.ideCargo is not None:
            self.ideCargo.export(outfile, level, namespaceprefix_, name_='ideCargo', pretty_print=pretty_print)
        if self.dadosCargo is not None:
            self.dadosCargo.export(outfile, level, namespaceprefix_, name_='dadosCargo', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class cargoPublicoType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, acumCargo=None, contagemEsp=None, dedicExcl=None, leiCargo=None):
        self.original_tagname_ = None
        self.acumCargo = acumCargo
        self.validate_acumCargoType(self.acumCargo)
        self.contagemEsp = contagemEsp
        self.validate_contagemEspType(self.contagemEsp)
        self.dedicExcl = dedicExcl
        self.validate_dedicExclType(self.dedicExcl)
        self.leiCargo = leiCargo
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, cargoPublicoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if cargoPublicoType.subclass:
            return cargoPublicoType.subclass(*args_, **kwargs_)
        else:
            return cargoPublicoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_acumCargoType(self, value):
        # Validate type acumCargoType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_acumCargoType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_acumCargoType_patterns_, ))
    validate_acumCargoType_patterns_ = [['^\\d$']]
    def validate_contagemEspType(self, value):
        # Validate type contagemEspType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_contagemEspType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_contagemEspType_patterns_, ))
    validate_contagemEspType_patterns_ = [['^\\d$']]
    def validate_dedicExclType(self, value):
        # Validate type dedicExclType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_dedicExclType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_dedicExclType_patterns_, ))
    validate_dedicExclType_patterns_ = [['^[N|S]$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='cargoPublicoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('cargoPublicoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='cargoPublicoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='cargoPublicoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='cargoPublicoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='cargoPublicoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.acumCargo is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<acumCargo>%s</acumCargo>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.acumCargo), input_name='acumCargo')), eol_))
        if self.contagemEsp is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<contagemEsp>%s</contagemEsp>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.contagemEsp), input_name='contagemEsp')), eol_))
        if self.dedicExcl is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dedicExcl>%s</dedicExcl>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.dedicExcl), input_name='dedicExcl')), eol_))
        if self.leiCargo is not None:
            self.leiCargo.export(outfile, level, namespaceprefix_, name_='leiCargo', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'acumCargo':
            acumCargo_ = child_.text
            acumCargo_ = self.gds_validate_string(acumCargo_, node, 'acumCargo')
            self.acumCargo = acumCargo_
            # validate type acumCargoType
            self.validate_acumCargoType(self.acumCargo)
        elif nodeName_ == 'contagemEsp':
            contagemEsp_ = child_.text
            contagemEsp_ = self.gds_validate_string(contagemEsp_, node, 'contagemEsp')
            self.contagemEsp = contagemEsp_
            # validate type contagemEspType
            self.validate_contagemEspType(self.contagemEsp)
            ...
            # validate type dedicExclType
            self.validate_dedicExclType(self.dedicExcl)
        elif nodeName_ == 'leiCargo':
            obj_ = leiCargoType.factory()
            obj_.build(child_)
            self.leiCargo = obj_
            obj_.original_tagname_ = 'leiCargo'
# end class cargoPublicoType


class leiCargoType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, nrLei=None, dtLei=None, sitCargo=None):
        self.original_tagname_ = None
        self.nrLei = nrLei
        self.validate_nrLeiType(self.nrLei)
        ...
        self.validate_sitCargoType(self.sitCargo)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, leiCargoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if leiCargoType.subclass:
            return leiCargoType.subclass(*args_, **kwargs_)
        else:
            return leiCargoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_nrLeiType(self, value):
        # Validate type nrLeiType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 12:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on nrLeiType' % {"value" : value.encode("utf-8")} )
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on nrLeiType' % {"value" : value.encode("utf-8")} )
    def validate_dtLeiType(self, value):
        # Validate type dtLeiType, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def validate_sitCargoType(self, value):
        # Validate type sitCargoType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_sitCargoType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_sitCargoType_patterns_, ))
    validate_sitCargoType_patterns_ = [['^\\d$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='leiCargoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('leiCargoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='leiCargoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='leiCargoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='leiCargoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='leiCargoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.nrLei is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nrLei>%s</nrLei>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.nrLei), input_name='nrLei')), eol_))
        if self.dtLei is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtLei>%s</dtLei>%s' % (self.gds_format_date(self.dtLei, input_name='dtLei'), eol_))
        if self.sitCargo is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<sitCargo>%s</sitCargo>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.sitCargo), input_name='sitCargo')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'nrLei':
            ...
            self.nrLei = nrLei_
            # validate type nrLeiType
            self.validate_nrLeiType(self.nrLei)
        elif nodeName_ == 'dtLei':
            sval_ = child_.text
            dval_ = self.gds_parse_date(sval_)
            self.dtLei = dval_
            # validate type dtLeiType
            self.validate_dtLeiType(self.dtLei)
        elif nodeName_ == 'sitCargo':
            sitCargo_ = child_.text
            sitCargo_ = self.gds_validate_string(sitCargo_, node, 'sitCargo')
            self.sitCargo = sitCargo_
            # validate type sitCargoType
            self.validate_sitCargoType(self.sitCargo)
# end class leiCargoType

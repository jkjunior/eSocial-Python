...
#   ('-o', 'classes/evtTabCargo.py')
#   ('-s', 'classes/evtTabCargoSub.py')
#   ('--super', 'evtTabCargo')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtTabCargo.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtTabCargo.py" -s "classes/evtTabCargoSub.py" --super="evtTabCargo" /home/joao/Documents/teste_xsd/xsd/evtTabCargo.xsd
#
...
import evtTabCargo as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtTabCargo=None, Signature=None):
        super(eSocialSub, self).__init__(evtTabCargo, Signature, )
...
class TideCargoSub(supermod.TideCargo):
    def __init__(self, codCargo=None, iniValid=None, fimValid=None):
        super(TideCargoSub, self).__init__(codCargo, iniValid, fimValid, )
supermod.TideCargo.subclass = TideCargoSub
# end class TideCargoSub


class TDadosCargoSub(supermod.TDadosCargo):
    def __init__(self, nmCargo=None, codCBO=None, cargoPublico=None):
        super(TDadosCargoSub, self).__init__(nmCargo, codCBO, cargoPublico, )
supermod.TDadosCargo.subclass = TDadosCargoSub
# end class TDadosCargoSub
...
class evtTabCargoTypeSub(supermod.evtTabCargoType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, infoCargo=None):
        super(evtTabCargoTypeSub, self).__init__(Id, ideEvento, ideEmpregador, infoCargo, )
supermod.evtTabCargoType.subclass = evtTabCargoTypeSub
# end class evtTabCargoTypeSub


class infoCargoTypeSub(supermod.infoCargoType):
    def __init__(self, inclusao=None, alteracao=None, exclusao=None):
        super(infoCargoTypeSub, self).__init__(inclusao, alteracao, exclusao, )
supermod.infoCargoType.subclass = infoCargoTypeSub
# end class infoCargoTypeSub


class inclusaoTypeSub(supermod.inclusaoType):
    def __init__(self, ideCargo=None, dadosCargo=None):
        super(inclusaoTypeSub, self).__init__(ideCargo, dadosCargo, )
...
class alteracaoTypeSub(supermod.alteracaoType):
    def __init__(self, ideCargo=None, dadosCargo=None, novaValidade=None):
        super(alteracaoTypeSub, self).__init__(ideCargo, dadosCargo, novaValidade, )
...
class exclusaoTypeSub(supermod.exclusaoType):
    def __init__(self, ideCargo=None):
        super(exclusaoTypeSub, self).__init__(ideCargo, )
supermod.exclusaoType.subclass = exclusaoTypeSub
# end class exclusaoTypeSub


class cargoPublicoTypeSub(supermod.cargoPublicoType):
    def __init__(self, acumCargo=None, contagemEsp=None, dedicExcl=None, leiCargo=None):
        super(cargoPublicoTypeSub, self).__init__(acumCargo, contagemEsp, dedicExcl, leiCargo, )
supermod.cargoPublicoType.subclass = cargoPublicoTypeSub
# end class cargoPublicoTypeSub


class leiCargoTypeSub(supermod.leiCargoType):
    def __init__(self, nrLei=None, dtLei=None, sitCargo=None):
        super(leiCargoTypeSub, self).__init__(nrLei, dtLei, sitCargo, )
supermod.leiCargoType.subclass = leiCargoTypeSub
# end class leiCargoTypeSub

...
class eSocial(GeneratedsSuper):
    ...
    def __init__(self, evtTabCarreira=None, Signature=None):
        ...
        self.evtTabCarreira = evtTabCarreira
    ...
    def get_evtTabCarreira(self): return self.evtTabCarreira
    def set_evtTabCarreira(self, evtTabCarreira): self.evtTabCarreira = evtTabCarreira
    def get_Signature(self): return self.Signature
    def set_Signature(self, Signature): self.Signature = Signature
    def hasContent_(self):
        if (
            self.evtTabCarreira is not None or
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            ...
            eol_ = ''
        if self.evtTabCarreira is not None:
            self.evtTabCarreira.export(outfile, level, namespaceprefix_, name_='evtTabCarreira', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'evtTabCarreira':
            obj_ = evtTabCarreiraType.factory()
            obj_.build(child_)
            self.evtTabCarreira = obj_
            obj_.original_tagname_ = 'evtTabCarreira'
...
class TIdeCarreira(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TIdeCarreira)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TIdeCarreira.subclass:
            return TIdeCarreira.subclass(*args_, **kwargs_)
        else:
            return TIdeCarreira(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TIdeCarreira', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('TIdeCarreira')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TIdeCarreira')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TIdeCarreira', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TIdeCarreira'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TIdeCarreira', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'codCarreira':
            ...
            self.validate_fimValidType(self.fimValid)
# end class TIdeCarreira


class TDadosCarreira(GeneratedsSuper):
    """Informações da Carreira"""
    subclass = None
    superclass = None
    def __init__(self, dscCarreira=None, leiCarr=None, dtLeiCarr=None, sitCarr=None):
        self.original_tagname_ = None
        self.dscCarreira = dscCarreira
        self.validate_dscCarreiraType(self.dscCarreira)
        self.leiCarr = leiCarr
        self.validate_leiCarrType(self.leiCarr)
        if isinstance(dtLeiCarr, BaseStrType_):
            initvalue_ = datetime_.datetime.strptime(dtLeiCarr, '%Y-%m-%d').date()
        else:
            initvalue_ = dtLeiCarr
        self.dtLeiCarr = initvalue_
        self.sitCarr = sitCarr
        self.validate_sitCarrType(self.sitCarr)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TDadosCarreira)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TDadosCarreira.subclass:
            return TDadosCarreira.subclass(*args_, **kwargs_)
        else:
            return TDadosCarreira(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_dscCarreira(self): return self.dscCarreira
    def set_dscCarreira(self, dscCarreira): self.dscCarreira = dscCarreira
    def get_leiCarr(self): return self.leiCarr
    def set_leiCarr(self, leiCarr): self.leiCarr = leiCarr
    def get_dtLeiCarr(self): return self.dtLeiCarr
    def set_dtLeiCarr(self, dtLeiCarr): self.dtLeiCarr = dtLeiCarr
    def get_sitCarr(self): return self.sitCarr
    def set_sitCarr(self, sitCarr): self.sitCarr = sitCarr
    def validate_dscCarreiraType(self, value):
        # Validate type dscCarreiraType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 100:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on dscCarreiraType' % {"value" : value.encode("utf-8")} )
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on dscCarreiraType' % {"value" : value.encode("utf-8")} )
    def validate_leiCarrType(self, value):
        # Validate type leiCarrType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 12:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on leiCarrType' % {"value" : value.encode("utf-8")} )
            if len(value) < 3:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on leiCarrType' % {"value" : value.encode("utf-8")} )
    def validate_dtLeiCarrType(self, value):
        # Validate type dtLeiCarrType, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def validate_sitCarrType(self, value):
        # Validate type sitCarrType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_sitCarrType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_sitCarrType_patterns_, ))
    validate_sitCarrType_patterns_ = [['^\\d$']]
    def hasContent_(self):
        if (
            self.dscCarreira is not None or
            self.leiCarr is not None or
            self.dtLeiCarr is not None or
            self.sitCarr is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TDadosCarreira', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('TDadosCarreira')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TDadosCarreira')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TDadosCarreira', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TDadosCarreira'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TDadosCarreira', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.dscCarreira is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dscCarreira>%s</dscCarreira>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.dscCarreira), input_name='dscCarreira')), eol_))
        if self.leiCarr is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<leiCarr>%s</leiCarr>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.leiCarr), input_name='leiCarr')), eol_))
        if self.dtLeiCarr is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtLeiCarr>%s</dtLeiCarr>%s' % (self.gds_format_date(self.dtLeiCarr, input_name='dtLeiCarr'), eol_))
        if self.sitCarr is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<sitCarr>%s</sitCarr>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.sitCarr), input_name='sitCarr')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dscCarreira':
            dscCarreira_ = child_.text
            dscCarreira_ = self.gds_validate_string(dscCarreira_, node, 'dscCarreira')
            self.dscCarreira = dscCarreira_
            # validate type dscCarreiraType
            self.validate_dscCarreiraType(self.dscCarreira)
        elif nodeName_ == 'leiCarr':
            leiCarr_ = child_.text
            leiCarr_ = self.gds_validate_string(leiCarr_, node, 'leiCarr')
            self.leiCarr = leiCarr_
            # validate type leiCarrType
            self.validate_leiCarrType(self.leiCarr)
        elif nodeName_ == 'dtLeiCarr':
            sval_ = child_.text
            dval_ = self.gds_parse_date(sval_)
            self.dtLeiCarr = dval_
            # validate type dtLeiCarrType
            self.validate_dtLeiCarrType(self.dtLeiCarr)
        elif nodeName_ == 'sitCarr':
            sitCarr_ = child_.text
            sitCarr_ = self.gds_validate_string(sitCarr_, node, 'sitCarr')
            self.sitCarr = sitCarr_
            # validate type sitCarrType
            self.validate_sitCarrType(self.sitCarr)
# end class TDadosCarreira
...
class evtTabCarreiraType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, infoCarreira=None):
        ...
        self.infoCarreira = infoCarreira
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtTabCarreiraType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtTabCarreiraType.subclass:
            return evtTabCarreiraType.subclass(*args_, **kwargs_)
        else:
            return evtTabCarreiraType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def get_infoCarreira(self): return self.infoCarreira
    def set_infoCarreira(self, infoCarreira): self.infoCarreira = infoCarreira
    def get_Id(self): return self.Id
    def set_Id(self, Id): self.Id = Id
    def hasContent_(self):
        if (
            ...
            self.infoCarreira is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtTabCarreiraType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtTabCarreiraType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtTabCarreiraType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtTabCarreiraType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtTabCarreiraType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtTabCarreiraType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoCarreira is not None:
            self.infoCarreira.export(outfile, level, namespaceprefix_, name_='infoCarreira', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'infoCarreira':
            obj_ = infoCarreiraType.factory()
            obj_.build(child_)
            self.infoCarreira = obj_
            obj_.original_tagname_ = 'infoCarreira'
# end class evtTabCarreiraType


class infoCarreiraType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoCarreiraType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoCarreiraType.subclass:
            return infoCarreiraType.subclass(*args_, **kwargs_)
        else:
            return infoCarreiraType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoCarreiraType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoCarreiraType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoCarreiraType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoCarreiraType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoCarreiraType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoCarreiraType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class inclusaoType(GeneratedsSuper):
    ...
    def __init__(self, ideCarreira=None, dadosCarreira=None):
        self.original_tagname_ = None
        self.ideCarreira = ideCarreira
        self.dadosCarreira = dadosCarreira
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    factory = staticmethod(factory)
    def get_ideCarreira(self): return self.ideCarreira
    def set_ideCarreira(self, ideCarreira): self.ideCarreira = ideCarreira
    def get_dadosCarreira(self): return self.dadosCarreira
    def set_dadosCarreira(self, dadosCarreira): self.dadosCarreira = dadosCarreira
    def hasContent_(self):
        if (
            self.ideCarreira is not None or
            self.dadosCarreira is not None
        ):
            return True
        else:
            return False
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='inclusaoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            ...
            eol_ = ''
        if self.ideCarreira is not None:
            self.ideCarreira.export(outfile, level, namespaceprefix_, name_='ideCarreira', pretty_print=pretty_print)
        if self.dadosCarreira is not None:
            self.dadosCarreira.export(outfile, level, namespaceprefix_, name_='dadosCarreira', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ideCarreira':
            obj_ = TIdeCarreira.factory()
            obj_.build(child_)
            self.ideCarreira = obj_
            obj_.original_tagname_ = 'ideCarreira'
        elif nodeName_ == 'dadosCarreira':
            obj_ = TDadosCarreira.factory()
            obj_.build(child_)
            self.dadosCarreira = obj_
            obj_.original_tagname_ = 'dadosCarreira'
...
class alteracaoType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            self.ideCarreira is not None or
            self.dadosCarreira is not None or

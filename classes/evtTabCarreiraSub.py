...
#   ('-o', 'classes/evtTabCarreira.py')
#   ('-s', 'classes/evtTabCarreiraSub.py')
#   ('--super', 'evtTabCarreira')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtTabCarreira.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtTabCarreira.py" -s "classes/evtTabCarreiraSub.py" --super="evtTabCarreira" /home/joao/Documents/teste_xsd/xsd/evtTabCarreira.xsd
#
...
import evtTabCarreira as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtTabCarreira=None, Signature=None):
        super(eSocialSub, self).__init__(evtTabCarreira, Signature, )
...
class TEmprPJSub(supermod.TEmprPJ):
    def __init__(self, tpInsc=None, nrInsc=None):
        super(TEmprPJSub, self).__init__(tpInsc, nrInsc, )
supermod.TEmprPJ.subclass = TEmprPJSub
# end class TEmprPJSub


class TIdeCarreiraSub(supermod.TIdeCarreira):
    def __init__(self, codCarreira=None, iniValid=None, fimValid=None):
        super(TIdeCarreiraSub, self).__init__(codCarreira, iniValid, fimValid, )
supermod.TIdeCarreira.subclass = TIdeCarreiraSub
# end class TIdeCarreiraSub


class TDadosCarreiraSub(supermod.TDadosCarreira):
    def __init__(self, dscCarreira=None, leiCarr=None, dtLeiCarr=None, sitCarr=None):
        super(TDadosCarreiraSub, self).__init__(dscCarreira, leiCarr, dtLeiCarr, sitCarr, )
supermod.TDadosCarreira.subclass = TDadosCarreiraSub
# end class TDadosCarreiraSub
...
class evtTabCarreiraTypeSub(supermod.evtTabCarreiraType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, infoCarreira=None):
        super(evtTabCarreiraTypeSub, self).__init__(Id, ideEvento, ideEmpregador, infoCarreira, )
supermod.evtTabCarreiraType.subclass = evtTabCarreiraTypeSub
# end class evtTabCarreiraTypeSub


class infoCarreiraTypeSub(supermod.infoCarreiraType):
    def __init__(self, inclusao=None, alteracao=None, exclusao=None):
        super(infoCarreiraTypeSub, self).__init__(inclusao, alteracao, exclusao, )
supermod.infoCarreiraType.subclass = infoCarreiraTypeSub
# end class infoCarreiraTypeSub


class inclusaoTypeSub(supermod.inclusaoType):
    def __init__(self, ideCarreira=None, dadosCarreira=None):
        super(inclusaoTypeSub, self).__init__(ideCarreira, dadosCarreira, )
supermod.inclusaoType.subclass = inclusaoTypeSub
# end class inclusaoTypeSub


class alteracaoTypeSub(supermod.alteracaoType):
    def __init__(self, ideCarreira=None, dadosCarreira=None, novaValidade=None):
        super(alteracaoTypeSub, self).__init__(ideCarreira, dadosCarreira, novaValidade, )
supermod.alteracaoType.subclass = alteracaoTypeSub
# end class alteracaoTypeSub


class exclusaoTypeSub(supermod.exclusaoType):
    def __init__(self, ideCarreira=None):
        super(exclusaoTypeSub, self).__init__(ideCarreira, )
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from evtTabCarreira import *\n\n')
        sys.stdout.write('import evtTabCarreira as model_\n\n')

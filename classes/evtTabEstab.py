...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtTabEstab is not None:
            self.evtTabEstab.export(outfile, level, namespaceprefix_, name_='evtTabEstab', pretty_print=pretty_print)
...
class TIdeEstab(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TIdeEstab', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TIdeEstab')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TIdeEstab', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TIdeEstab'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TIdeEstab', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TDadosEstab(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TDadosEstab', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TDadosEstab')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TDadosEstab', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TDadosEstab'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TDadosEstab', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.aliqGilrat is not None:
            self.aliqGilrat.export(outfile, level, namespaceprefix_, name_='aliqGilrat', pretty_print=pretty_print)
        if self.infoCaepf is not None:
            self.infoCaepf.export(outfile, level, namespaceprefix_, name_='infoCaepf', pretty_print=pretty_print)
        if self.infoObra is not None:
            self.infoObra.export(outfile, level, namespaceprefix_, name_='infoObra', pretty_print=pretty_print)
        if self.infoTrab is not None:
            self.infoTrab.export(outfile, level, namespaceprefix_, name_='infoTrab', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class TPeriodoValidade(GeneratedsSuper):
    ...
    def __init__(self, iniValid=None, fimValid=None):
        self.original_tagname_ = None
        self.iniValid = iniValid
        self.validate_iniValidType8(self.iniValid)
        self.fimValid = fimValid
        self.validate_fimValidType9(self.fimValid)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def get_fimValid(self): return self.fimValid
    def set_fimValid(self, fimValid): self.fimValid = fimValid
    def validate_iniValidType8(self, value):
        # Validate type iniValidType8, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_iniValidType8_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_iniValidType8_patterns_, ))
    validate_iniValidType8_patterns_ = [['^[2]{1}\\d{3}-(1[0-2]|0[1-9])$']]
    def validate_fimValidType9(self, value):
        # Validate type fimValidType9, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_fimValidType9_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_fimValidType9_patterns_, ))
    validate_fimValidType9_patterns_ = [['^[2]{1}\\d{3}-(1[0-2]|0[1-9])$']]
    def hasContent_(self):
        if (
            self.iniValid is not None or
            self.fimValid is not None
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'iniValid':
            ...
            iniValid_ = self.gds_validate_string(iniValid_, node, 'iniValid')
            self.iniValid = iniValid_
            # validate type iniValidType8
            self.validate_iniValidType8(self.iniValid)
        elif nodeName_ == 'fimValid':
            fimValid_ = child_.text
            fimValid_ = self.gds_validate_string(fimValid_, node, 'fimValid')
            self.fimValid = fimValid_
            # validate type fimValidType9
            self.validate_fimValidType9(self.fimValid)
...
class evtTabEstabType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtTabEstabType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtTabEstabType.subclass:
            return evtTabEstabType.subclass(*args_, **kwargs_)
        else:
            return evtTabEstabType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtTabEstabType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtTabEstabType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtTabEstabType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtTabEstabType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtTabEstabType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtTabEstabType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class inclusaoType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='inclusaoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.ideEstab is not None:
            self.ideEstab.export(outfile, level, namespaceprefix_, name_='ideEstab', pretty_print=pretty_print)
        if self.dadosEstab is not None:
            self.dadosEstab.export(outfile, level, namespaceprefix_, name_='dadosEstab', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class aliqGilratType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, aliqGilratType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if aliqGilratType.subclass:
            return aliqGilratType.subclass(*args_, **kwargs_)
        else:
            return aliqGilratType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='aliqGilratType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('aliqGilratType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='aliqGilratType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='aliqGilratType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='aliqGilratType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='aliqGilratType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.procAdmJudRat is not None:
            self.procAdmJudRat.export(outfile, level, namespaceprefix_, name_='procAdmJudRat', pretty_print=pretty_print)
        if self.procAdmJudFap is not None:
            self.procAdmJudFap.export(outfile, level, namespaceprefix_, name_='procAdmJudFap', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'aliqRat' and child_.text:
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
            ...
            obj_ = procAdmJudRatType.factory()
            obj_.build(child_)
            self.procAdmJudRat = obj_
            obj_.original_tagname_ = 'procAdmJudRat'
        elif nodeName_ == 'procAdmJudFap':
            obj_ = procAdmJudFapType.factory()
            obj_.build(child_)
            self.procAdmJudFap = obj_
            obj_.original_tagname_ = 'procAdmJudFap'
# end class aliqGilratType


class procAdmJudRatType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, tpProc=None, nrProc=None, codSusp=None):
        self.original_tagname_ = None
        self.tpProc = tpProc
        self.validate_tpProcType(self.tpProc)
        self.nrProc = nrProc
        self.validate_nrProcType(self.nrProc)
        self.codSusp = codSusp
        self.validate_codSuspType(self.codSusp)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, procAdmJudRatType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if procAdmJudRatType.subclass:
            return procAdmJudRatType.subclass(*args_, **kwargs_)
        else:
            return procAdmJudRatType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_tpProcType(self, value):
        # Validate type tpProcType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tpProcType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_tpProcType_patterns_, ))
    validate_tpProcType_patterns_ = [['^\\d$']]
    def validate_nrProcType(self, value):
        # Validate type nrProcType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 21:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on nrProcType' % {"value" : value.encode("utf-8")} )
            if len(value) < 3:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on nrProcType' % {"value" : value.encode("utf-8")} )
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='procAdmJudRatType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('procAdmJudRatType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='procAdmJudRatType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='procAdmJudRatType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='procAdmJudRatType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='procAdmJudRatType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.tpProc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tpProc>%s</tpProc>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.tpProc), input_name='tpProc')), eol_))
        if self.nrProc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nrProc>%s</nrProc>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.nrProc), input_name='nrProc')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpProc':
            tpProc_ = child_.text
            tpProc_ = self.gds_validate_string(tpProc_, node, 'tpProc')
            self.tpProc = tpProc_
            # validate type tpProcType
            self.validate_tpProcType(self.tpProc)
        elif nodeName_ == 'nrProc':
            nrProc_ = child_.text
            nrProc_ = self.gds_validate_string(nrProc_, node, 'nrProc')
            self.nrProc = nrProc_
            # validate type nrProcType
            self.validate_nrProcType(self.nrProc)
            ...
            self.validate_codSuspType(self.codSusp)
# end class procAdmJudRatType


class procAdmJudFapType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, tpProc=None, nrProc=None, codSusp=None):
        self.original_tagname_ = None
        self.tpProc = tpProc
        self.validate_tpProcType3(self.tpProc)
        self.nrProc = nrProc
        self.validate_nrProcType4(self.nrProc)
        self.codSusp = codSusp
        self.validate_codSuspType5(self.codSusp)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, procAdmJudFapType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if procAdmJudFapType.subclass:
            return procAdmJudFapType.subclass(*args_, **kwargs_)
        else:
            return procAdmJudFapType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_tpProc(self): return self.tpProc
    def set_tpProc(self, tpProc): self.tpProc = tpProc
    def get_nrProc(self): return self.nrProc
    ...
    def get_codSusp(self): return self.codSusp
    def set_codSusp(self, codSusp): self.codSusp = codSusp
    def validate_tpProcType3(self, value):
        # Validate type tpProcType3, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tpProcType3_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_tpProcType3_patterns_, ))
    validate_tpProcType3_patterns_ = [['^\\d$']]
    def validate_nrProcType4(self, value):
        # Validate type nrProcType4, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 21:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on nrProcType4' % {"value" : value.encode("utf-8")} )
            if len(value) < 3:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on nrProcType4' % {"value" : value.encode("utf-8")} )
    def validate_codSuspType5(self, value):
        # Validate type codSuspType5, a restriction on xs:integer.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_codSuspType5_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_codSuspType5_patterns_, ))
    validate_codSuspType5_patterns_ = [['^\\d{1,14}$']]
    def hasContent_(self):
        if (
            self.tpProc is not None or
            self.nrProc is not None or
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='procAdmJudFapType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('procAdmJudFapType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='procAdmJudFapType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='procAdmJudFapType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='procAdmJudFapType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='procAdmJudFapType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpProc':
            ...
            tpProc_ = self.gds_validate_string(tpProc_, node, 'tpProc')
            self.tpProc = tpProc_
            # validate type tpProcType3
            self.validate_tpProcType3(self.tpProc)
        elif nodeName_ == 'nrProc':
            nrProc_ = child_.text
            nrProc_ = self.gds_validate_string(nrProc_, node, 'nrProc')
            self.nrProc = nrProc_
            # validate type nrProcType4
            self.validate_nrProcType4(self.nrProc)
        elif nodeName_ == 'codSusp' and child_.text:
            sval_ = child_.text
            try:
            ...
            ival_ = self.gds_validate_integer(ival_, node, 'codSusp')
            self.codSusp = ival_
            # validate type codSuspType5
            self.validate_codSuspType5(self.codSusp)
# end class procAdmJudFapType


class infoCaepfType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, tpCaepf=None):
        self.original_tagname_ = None
        self.tpCaepf = tpCaepf
        self.validate_tpCaepfType(self.tpCaepf)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoCaepfType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoCaepfType.subclass:
            return infoCaepfType.subclass(*args_, **kwargs_)
        else:
            return infoCaepfType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_tpCaepf(self): return self.tpCaepf
    def set_tpCaepf(self, tpCaepf): self.tpCaepf = tpCaepf
    def validate_tpCaepfType(self, value):
        # Validate type tpCaepfType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tpCaepfType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_tpCaepfType_patterns_, ))
    validate_tpCaepfType_patterns_ = [['^\\d$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoCaepfType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoCaepfType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoCaepfType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoCaepfType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoCaepfType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoCaepfType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.tpCaepf is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tpCaepf>%s</tpCaepf>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.tpCaepf), input_name='tpCaepf')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpCaepf':
            tpCaepf_ = child_.text
            tpCaepf_ = self.gds_validate_string(tpCaepf_, node, 'tpCaepf')
            self.tpCaepf = tpCaepf_
            # validate type tpCaepfType
            self.validate_tpCaepfType(self.tpCaepf)
# end class infoCaepfType


class infoObraType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoObraType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoObraType.subclass:
            return infoObraType.subclass(*args_, **kwargs_)
        else:
            return infoObraType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoObraType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoObraType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoObraType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoObraType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoObraType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoObraType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'indSubstPatrObra':
            ...
            self.validate_indSubstPatrObraType(self.indSubstPatrObra)
# end class infoObraType


class infoTrabType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, regPt=None, infoApr=None, infoPCD=None):
        self.original_tagname_ = None
        self.regPt = regPt
        self.validate_regPtType(self.regPt)
        self.infoApr = infoApr
        self.infoPCD = infoPCD
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoTrabType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoTrabType.subclass:
            return infoTrabType.subclass(*args_, **kwargs_)
        else:
            return infoTrabType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_regPtType(self, value):
        # Validate type regPtType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_regPtType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_regPtType_patterns_, ))
    validate_regPtType_patterns_ = [['^\\d$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoTrabType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoTrabType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoTrabType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoTrabType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoTrabType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoTrabType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.regPt is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<regPt>%s</regPt>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.regPt), input_name='regPt')), eol_))
        if self.infoApr is not None:
            self.infoApr.export(outfile, level, namespaceprefix_, name_='infoApr', pretty_print=pretty_print)
        if self.infoPCD is not None:
            self.infoPCD.export(outfile, level, namespaceprefix_, name_='infoPCD', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class infoAprType(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoAprType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoAprType.subclass:
            return infoAprType.subclass(*args_, **kwargs_)
        else:
            return infoAprType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_contAprType(self, value):
        # Validate type contAprType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_contAprType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_contAprType_patterns_, ))
    validate_contAprType_patterns_ = [['^\\d$']]
    ...
    def validate_contEntEdType(self, value):
        # Validate type contEntEdType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_contEntEdType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_contEntEdType_patterns_, ))
    validate_contEntEdType_patterns_ = [['^[N|S]$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoAprType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoAprType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoAprType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoAprType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoAprType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoAprType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.contApr is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<contApr>%s</contApr>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.contApr), input_name='contApr')), eol_))
        ...
        if self.contEntEd is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<contEntEd>%s</contEntEd>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.contEntEd), input_name='contEntEd')), eol_))
        for infoEntEduc_ in self.infoEntEduc:
            infoEntEduc_.export(outfile, level, namespaceprefix_, name_='infoEntEduc', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'contApr':
            contApr_ = child_.text
            contApr_ = self.gds_validate_string(contApr_, node, 'contApr')
            self.contApr = contApr_
            # validate type contAprType
            self.validate_contAprType(self.contApr)
            ...
            # validate type contEntEdType
            self.validate_contEntEdType(self.contEntEd)
        elif nodeName_ == 'infoEntEduc':
            obj_ = infoEntEducType.factory()
            obj_.build(child_)
            self.infoEntEduc.append(obj_)
            obj_.original_tagname_ = 'infoEntEduc'
# end class infoAprType


class infoEntEducType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, nrInsc=None):
        self.original_tagname_ = None
        self.nrInsc = nrInsc
        self.validate_nrInscType6(self.nrInsc)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoEntEducType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoEntEducType.subclass:
            return infoEntEducType.subclass(*args_, **kwargs_)
        else:
            return infoEntEducType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_nrInsc(self): return self.nrInsc
    def set_nrInsc(self, nrInsc): self.nrInsc = nrInsc
    def validate_nrInscType6(self, value):
        # Validate type nrInscType6, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_nrInscType6_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_nrInscType6_patterns_, ))
    validate_nrInscType6_patterns_ = [['^\\d{8,15}$']]
    def hasContent_(self):
        if (
            self.nrInsc is not None
        ):
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoEntEducType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoEntEducType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoEntEducType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoEntEducType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoEntEducType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoEntEducType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'nrInsc':
            ...
            nrInsc_ = self.gds_validate_string(nrInsc_, node, 'nrInsc')
            self.nrInsc = nrInsc_
            # validate type nrInscType6
            self.validate_nrInscType6(self.nrInsc)
# end class infoEntEducType


class infoPCDType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, contPCD=None, nrProcJud=None):
        self.original_tagname_ = None
        self.contPCD = contPCD
        self.validate_contPCDType(self.contPCD)
        self.nrProcJud = nrProcJud
        self.validate_nrProcJudType7(self.nrProcJud)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoPCDType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoPCDType.subclass:
            return infoPCDType.subclass(*args_, **kwargs_)
        else:
            return infoPCDType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_contPCD(self): return self.contPCD
    def set_contPCD(self, contPCD): self.contPCD = contPCD
    def get_nrProcJud(self): return self.nrProcJud
    def set_nrProcJud(self, nrProcJud): self.nrProcJud = nrProcJud
    def validate_contPCDType(self, value):
        # Validate type contPCDType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_contPCDType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_contPCDType_patterns_, ))
    validate_contPCDType_patterns_ = [['^\\d$']]
    def validate_nrProcJudType7(self, value):
        # Validate type nrProcJudType7, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 21:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on nrProcJudType7' % {"value" : value.encode("utf-8")} )
            if len(value) < 3:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on nrProcJudType7' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoPCDType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoPCDType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoPCDType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoPCDType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoPCDType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoPCDType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.contPCD is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<contPCD>%s</contPCD>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.contPCD), input_name='contPCD')), eol_))
        if self.nrProcJud is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<nrProcJud>%s</nrProcJud>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.nrProcJud), input_name='nrProcJud')), eol_))
    def build(self, node):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'contPCD':
            contPCD_ = child_.text
            contPCD_ = self.gds_validate_string(contPCD_, node, 'contPCD')
            self.contPCD = contPCD_
            # validate type contPCDType
            self.validate_contPCDType(self.contPCD)
        elif nodeName_ == 'nrProcJud':
            nrProcJud_ = child_.text
            nrProcJud_ = self.gds_validate_string(nrProcJud_, node, 'nrProcJud')
            self.nrProcJud = nrProcJud_
            # validate type nrProcJudType7
            self.validate_nrProcJudType7(self.nrProcJud)
# end class infoPCDType

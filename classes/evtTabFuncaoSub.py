...
#   ('-o', 'classes/evtTabFuncao.py')
#   ('-s', 'classes/evtTabFuncaoSub.py')
#   ('--super', 'evtTabFuncao')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtTabFuncao.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtTabFuncao.py" -s "classes/evtTabFuncaoSub.py" --super="evtTabFuncao" /home/joao/Documents/teste_xsd/xsd/evtTabFuncao.xsd
#
...
import evtTabFuncao as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtTabFuncao=None, Signature=None):
        super(eSocialSub, self).__init__(evtTabFuncao, Signature, )
...
class TIdeFuncaoSub(supermod.TIdeFuncao):
    def __init__(self, codFuncao=None, iniValid=None, fimValid=None):
        super(TIdeFuncaoSub, self).__init__(codFuncao, iniValid, fimValid, )
supermod.TIdeFuncao.subclass = TIdeFuncaoSub
# end class TIdeFuncaoSub


class TDadosFuncaoSub(supermod.TDadosFuncao):
    def __init__(self, dscFuncao=None, codCBO=None):
        super(TDadosFuncaoSub, self).__init__(dscFuncao, codCBO, )
supermod.TDadosFuncao.subclass = TDadosFuncaoSub
# end class TDadosFuncaoSub
...
class evtTabFuncaoTypeSub(supermod.evtTabFuncaoType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, infoFuncao=None):
        super(evtTabFuncaoTypeSub, self).__init__(Id, ideEvento, ideEmpregador, infoFuncao, )
supermod.evtTabFuncaoType.subclass = evtTabFuncaoTypeSub
# end class evtTabFuncaoTypeSub


class infoFuncaoTypeSub(supermod.infoFuncaoType):
    def __init__(self, inclusao=None, alteracao=None, exclusao=None):
        super(infoFuncaoTypeSub, self).__init__(inclusao, alteracao, exclusao, )
supermod.infoFuncaoType.subclass = infoFuncaoTypeSub
# end class infoFuncaoTypeSub


class inclusaoTypeSub(supermod.inclusaoType):
    def __init__(self, ideFuncao=None, dadosFuncao=None):
        super(inclusaoTypeSub, self).__init__(ideFuncao, dadosFuncao, )
...
class alteracaoTypeSub(supermod.alteracaoType):
    def __init__(self, ideFuncao=None, dadosFuncao=None, novaValidade=None):
        super(alteracaoTypeSub, self).__init__(ideFuncao, dadosFuncao, novaValidade, )
...
class exclusaoTypeSub(supermod.exclusaoType):
    def __init__(self, ideFuncao=None):
        super(exclusaoTypeSub, self).__init__(ideFuncao, )

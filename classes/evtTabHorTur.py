...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtTabHorTur is not None:
            self.evtTabHorTur.export(outfile, level, namespaceprefix_, name_='evtTabHorTur', pretty_print=pretty_print)
...
class TIdeHorContratual(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TIdeHorContratual', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TIdeHorContratual')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TIdeHorContratual', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TIdeHorContratual'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TIdeHorContratual', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TDadosHorContratual(GeneratedsSuper):
    ...
    def __init__(self, hrEntr=None, hrSaida=None, durJornada=None, perHorFlexivel=None, horarioIntervalo=None):
        self.original_tagname_ = None
        self.hrEntr = hrEntr
        self.validate_hrEntrType(self.hrEntr)
        self.hrSaida = hrSaida
        self.validate_hrSaidaType(self.hrSaida)
        self.durJornada = durJornada
        self.validate_durJornadaType(self.durJornada)
        self.perHorFlexivel = perHorFlexivel
        self.validate_perHorFlexivelType(self.perHorFlexivel)
    ...
    def validate_hrEntrType(self, value):
        # Validate type hrEntrType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 4:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on hrEntrType' % {"value" : value.encode("utf-8")} )
    def validate_hrSaidaType(self, value):
        # Validate type hrSaidaType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 4:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on hrSaidaType' % {"value" : value.encode("utf-8")} )
    def validate_durJornadaType(self, value):
        # Validate type durJornadaType, a restriction on xs:integer.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_durJornadaType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_durJornadaType_patterns_, ))
    validate_durJornadaType_patterns_ = [['^\\d{1,4}$']]
    def validate_perHorFlexivelType(self, value):
        # Validate type perHorFlexivelType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 1:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on perHorFlexivelType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_perHorFlexivelType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_perHorFlexivelType_patterns_, ))
    validate_perHorFlexivelType_patterns_ = [['^[N|S]$']]
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TDadosHorContratual', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TDadosHorContratual')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TDadosHorContratual', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TDadosHorContratual'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TDadosHorContratual', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.hrEntr is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<hrEntr>%s</hrEntr>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.hrEntr), input_name='hrEntr')), eol_))
        if self.hrSaida is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<hrSaida>%s</hrSaida>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.hrSaida), input_name='hrSaida')), eol_))
        if self.durJornada is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<durJornada>%s</durJornada>%s' % (self.gds_format_integer(self.durJornada, input_name='durJornada'), eol_))
        if self.perHorFlexivel is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<perHorFlexivel>%s</perHorFlexivel>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.perHorFlexivel), input_name='perHorFlexivel')), eol_))
        for horarioIntervalo_ in self.horarioIntervalo:
            horarioIntervalo_.export(outfile, level, namespaceprefix_, name_='horarioIntervalo', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'hrEntr':
            ...
            # validate type perHorFlexivelType
            self.validate_perHorFlexivelType(self.perHorFlexivel)
        elif nodeName_ == 'horarioIntervalo':
            obj_ = horarioIntervaloType.factory()
            obj_.build(child_)
...
class evtTabHorTurType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtTabHorTurType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtTabHorTurType.subclass:
            return evtTabHorTurType.subclass(*args_, **kwargs_)
        else:
            return evtTabHorTurType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtTabHorTurType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtTabHorTurType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtTabHorTurType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtTabHorTurType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtTabHorTurType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtTabHorTurType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoHorContratual is not None:
            self.infoHorContratual.export(outfile, level, namespaceprefix_, name_='infoHorContratual', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ideEvento':
            ...
            obj_ = infoHorContratualType.factory()
            obj_.build(child_)
            self.infoHorContratual = obj_
            obj_.original_tagname_ = 'infoHorContratual'
# end class evtTabHorTurType


class infoHorContratualType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoHorContratualType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoHorContratualType.subclass:
            return infoHorContratualType.subclass(*args_, **kwargs_)
        else:
            return infoHorContratualType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoHorContratualType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoHorContratualType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoHorContratualType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoHorContratualType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoHorContratualType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoHorContratualType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
# end class infoHorContratualType
...
class inclusaoType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='inclusaoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.ideHorContratual is not None:
            self.ideHorContratual.export(outfile, level, namespaceprefix_, name_='ideHorContratual', pretty_print=pretty_print)
        if self.dadosHorContratual is not None:
            self.dadosHorContratual.export(outfile, level, namespaceprefix_, name_='dadosHorContratual', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class horarioIntervaloType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, tpInterv=None, durInterv=None, iniInterv=None, termInterv=None):
        self.original_tagname_ = None
        self.tpInterv = tpInterv
        self.validate_tpIntervType(self.tpInterv)
        self.durInterv = durInterv
        self.validate_durIntervType(self.durInterv)
        self.iniInterv = iniInterv
        self.validate_iniIntervType(self.iniInterv)
        self.termInterv = termInterv
        self.validate_termIntervType(self.termInterv)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, horarioIntervaloType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if horarioIntervaloType.subclass:
            return horarioIntervaloType.subclass(*args_, **kwargs_)
        else:
            return horarioIntervaloType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_tpIntervType(self, value):
        # Validate type tpIntervType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tpIntervType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_tpIntervType_patterns_, ))
    validate_tpIntervType_patterns_ = [['^\\d$']]
    def validate_durIntervType(self, value):
        # Validate type durIntervType, a restriction on xs:integer.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_durIntervType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_durIntervType_patterns_, ))
    validate_durIntervType_patterns_ = [['^\\d{1,3}$']]
    def validate_iniIntervType(self, value):
        # Validate type iniIntervType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 4:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on iniIntervType' % {"value" : value.encode("utf-8")} )
    def validate_termIntervType(self, value):
        # Validate type termIntervType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 4:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on termIntervType' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='horarioIntervaloType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('horarioIntervaloType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='horarioIntervaloType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='horarioIntervaloType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='horarioIntervaloType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='horarioIntervaloType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.tpInterv is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tpInterv>%s</tpInterv>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.tpInterv), input_name='tpInterv')), eol_))
        if self.durInterv is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<durInterv>%s</durInterv>%s' % (self.gds_format_integer(self.durInterv, input_name='durInterv'), eol_))
        if self.iniInterv is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<iniInterv>%s</iniInterv>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.iniInterv), input_name='iniInterv')), eol_))
        if self.termInterv is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<termInterv>%s</termInterv>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.termInterv), input_name='termInterv')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpInterv':
            tpInterv_ = child_.text
            tpInterv_ = self.gds_validate_string(tpInterv_, node, 'tpInterv')
            self.tpInterv = tpInterv_
            # validate type tpIntervType
            self.validate_tpIntervType(self.tpInterv)
        elif nodeName_ == 'durInterv' and child_.text:
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
            ...
            # validate type termIntervType
            self.validate_termIntervType(self.termInterv)
# end class horarioIntervaloType
...
__all__ = [
    ...
    "evtTabHorTurType",
    "exclusaoType",
    "horarioIntervaloType",
    "inclusaoType",
    "infoHorContratualType"
]

...
#   ('-o', 'classes/evtTabHorTur.py')
#   ('-s', 'classes/evtTabHorTurSub.py')
#   ('--super', 'evtTabHorTur')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtTabHorTur.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtTabHorTur.py" -s "classes/evtTabHorTurSub.py" --super="evtTabHorTur" /home/joao/Documents/teste_xsd/xsd/evtTabHorTur.xsd
#
...
import evtTabHorTur as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtTabHorTur=None, Signature=None):
        super(eSocialSub, self).__init__(evtTabHorTur, Signature, )
...
class TIdeHorContratualSub(supermod.TIdeHorContratual):
    def __init__(self, codHorContrat=None, iniValid=None, fimValid=None):
        super(TIdeHorContratualSub, self).__init__(codHorContrat, iniValid, fimValid, )
supermod.TIdeHorContratual.subclass = TIdeHorContratualSub
# end class TIdeHorContratualSub


class TDadosHorContratualSub(supermod.TDadosHorContratual):
    def __init__(self, hrEntr=None, hrSaida=None, durJornada=None, perHorFlexivel=None, horarioIntervalo=None):
        super(TDadosHorContratualSub, self).__init__(hrEntr, hrSaida, durJornada, perHorFlexivel, horarioIntervalo, )
supermod.TDadosHorContratual.subclass = TDadosHorContratualSub
# end class TDadosHorContratualSub
...
class evtTabHorTurTypeSub(supermod.evtTabHorTurType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, infoHorContratual=None):
        super(evtTabHorTurTypeSub, self).__init__(Id, ideEvento, ideEmpregador, infoHorContratual, )
supermod.evtTabHorTurType.subclass = evtTabHorTurTypeSub
# end class evtTabHorTurTypeSub


class infoHorContratualTypeSub(supermod.infoHorContratualType):
    def __init__(self, inclusao=None, alteracao=None, exclusao=None):
        super(infoHorContratualTypeSub, self).__init__(inclusao, alteracao, exclusao, )
supermod.infoHorContratualType.subclass = infoHorContratualTypeSub
# end class infoHorContratualTypeSub


class inclusaoTypeSub(supermod.inclusaoType):
    def __init__(self, ideHorContratual=None, dadosHorContratual=None):
        super(inclusaoTypeSub, self).__init__(ideHorContratual, dadosHorContratual, )
...
class alteracaoTypeSub(supermod.alteracaoType):
    def __init__(self, ideHorContratual=None, dadosHorContratual=None, novaValidade=None):
        super(alteracaoTypeSub, self).__init__(ideHorContratual, dadosHorContratual, novaValidade, )
...
class exclusaoTypeSub(supermod.exclusaoType):
    def __init__(self, ideHorContratual=None):
        super(exclusaoTypeSub, self).__init__(ideHorContratual, )
supermod.exclusaoType.subclass = exclusaoTypeSub
# end class exclusaoTypeSub


class horarioIntervaloTypeSub(supermod.horarioIntervaloType):
    def __init__(self, tpInterv=None, durInterv=None, iniInterv=None, termInterv=None):
        super(horarioIntervaloTypeSub, self).__init__(tpInterv, durInterv, iniInterv, termInterv, )
supermod.horarioIntervaloType.subclass = horarioIntervaloTypeSub
# end class horarioIntervaloTypeSub

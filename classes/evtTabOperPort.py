...
class eSocial(GeneratedsSuper):
    ...
    def __init__(self, evtTabOperPort=None, Signature=None):
        ...
        self.evtTabOperPort = evtTabOperPort
    ...
    def get_evtTabOperPort(self): return self.evtTabOperPort
    def set_evtTabOperPort(self, evtTabOperPort): self.evtTabOperPort = evtTabOperPort
    def get_Signature(self): return self.Signature
    def set_Signature(self, Signature): self.Signature = Signature
    def hasContent_(self):
        if (
            self.evtTabOperPort is not None or
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            ...
            eol_ = ''
        if self.evtTabOperPort is not None:
            self.evtTabOperPort.export(outfile, level, namespaceprefix_, name_='evtTabOperPort', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'evtTabOperPort':
            obj_ = evtTabOperPortType.factory()
            obj_.build(child_)
            self.evtTabOperPort = obj_
            obj_.original_tagname_ = 'evtTabOperPort'
...
class TIdeOperPortuario(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TIdeOperPortuario)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TIdeOperPortuario.subclass:
            return TIdeOperPortuario.subclass(*args_, **kwargs_)
        else:
            return TIdeOperPortuario(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TIdeOperPortuario', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('TIdeOperPortuario')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TIdeOperPortuario')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TIdeOperPortuario', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TIdeOperPortuario'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TIdeOperPortuario', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'cnpjOpPortuario':
            ...
            self.validate_fimValidType(self.fimValid)
# end class TIdeOperPortuario


class TDadosOperPortuario(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TDadosOperPortuario)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TDadosOperPortuario.subclass:
            return TDadosOperPortuario.subclass(*args_, **kwargs_)
        else:
            return TDadosOperPortuario(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TDadosOperPortuario', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('TDadosOperPortuario')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TDadosOperPortuario')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TDadosOperPortuario', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TDadosOperPortuario'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TDadosOperPortuario', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class evtTabOperPortType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, infoOperPortuario=None):
        ...
        self.infoOperPortuario = infoOperPortuario
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtTabOperPortType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtTabOperPortType.subclass:
            return evtTabOperPortType.subclass(*args_, **kwargs_)
        else:
            return evtTabOperPortType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def get_infoOperPortuario(self): return self.infoOperPortuario
    def set_infoOperPortuario(self, infoOperPortuario): self.infoOperPortuario = infoOperPortuario
    def get_Id(self): return self.Id
    def set_Id(self, Id): self.Id = Id
    def hasContent_(self):
        if (
            ...
            self.infoOperPortuario is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtTabOperPortType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtTabOperPortType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtTabOperPortType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtTabOperPortType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtTabOperPortType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtTabOperPortType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoOperPortuario is not None:
            self.infoOperPortuario.export(outfile, level, namespaceprefix_, name_='infoOperPortuario', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'infoOperPortuario':
            obj_ = infoOperPortuarioType.factory()
            obj_.build(child_)
            self.infoOperPortuario = obj_
            obj_.original_tagname_ = 'infoOperPortuario'
# end class evtTabOperPortType


class infoOperPortuarioType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoOperPortuarioType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoOperPortuarioType.subclass:
            return infoOperPortuarioType.subclass(*args_, **kwargs_)
        else:
            return infoOperPortuarioType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoOperPortuarioType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoOperPortuarioType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoOperPortuarioType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoOperPortuarioType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoOperPortuarioType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoOperPortuarioType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
# end class infoOperPortuarioType
...
class inclusaoType(GeneratedsSuper):
    ...
    def __init__(self, ideOperPortuario=None, dadosOperPortuario=None):
        self.original_tagname_ = None
        self.ideOperPortuario = ideOperPortuario
        self.dadosOperPortuario = dadosOperPortuario
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    factory = staticmethod(factory)
    def get_ideOperPortuario(self): return self.ideOperPortuario
    def set_ideOperPortuario(self, ideOperPortuario): self.ideOperPortuario = ideOperPortuario
    def get_dadosOperPortuario(self): return self.dadosOperPortuario
    def set_dadosOperPortuario(self, dadosOperPortuario): self.dadosOperPortuario = dadosOperPortuario
    def hasContent_(self):
        if (
            self.ideOperPortuario is not None or
            self.dadosOperPortuario is not None
        ):
            return True
        else:
            return False
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='inclusaoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            ...
            eol_ = ''
        if self.ideOperPortuario is not None:
            self.ideOperPortuario.export(outfile, level, namespaceprefix_, name_='ideOperPortuario', pretty_print=pretty_print)
        if self.dadosOperPortuario is not None:
            self.dadosOperPortuario.export(outfile, level, namespaceprefix_, name_='dadosOperPortuario', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ideOperPortuario':
            obj_ = TIdeOperPortuario.factory()
            obj_.build(child_)
            self.ideOperPortuario = obj_
            obj_.original_tagname_ = 'ideOperPortuario'
        elif nodeName_ == 'dadosOperPortuario':
            obj_ = TDadosOperPortuario.factory()
            obj_.build(child_)
            self.dadosOperPortuario = obj_
            obj_.original_tagname_ = 'dadosOperPortuario'
...
class alteracaoType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            self.ideOperPortuario is not None or
            self.dadosOperPortuario is not None or
...
class exclusaoType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            self.ideOperPortuario is not None
        ):
            return True
        else:
            return False

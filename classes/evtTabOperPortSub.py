...
#   ('-o', 'classes/evtTabOperPort.py')
#   ('-s', 'classes/evtTabOperPortSub.py')
#   ('--super', 'evtTabOperPort')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtTabOperPort.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtTabOperPort.py" -s "classes/evtTabOperPortSub.py" --super="evtTabOperPort" /home/joao/Documents/teste_xsd/xsd/evtTabOperPort.xsd
#
...
import evtTabOperPort as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtTabOperPort=None, Signature=None):
        super(eSocialSub, self).__init__(evtTabOperPort, Signature, )
...
class TIdeOperPortuarioSub(supermod.TIdeOperPortuario):
    def __init__(self, cnpjOpPortuario=None, iniValid=None, fimValid=None):
        super(TIdeOperPortuarioSub, self).__init__(cnpjOpPortuario, iniValid, fimValid, )
supermod.TIdeOperPortuario.subclass = TIdeOperPortuarioSub
# end class TIdeOperPortuarioSub


class TDadosOperPortuarioSub(supermod.TDadosOperPortuario):
    def __init__(self, aliqRat=None, fap=None, aliqRatAjust=None):
        super(TDadosOperPortuarioSub, self).__init__(aliqRat, fap, aliqRatAjust, )
supermod.TDadosOperPortuario.subclass = TDadosOperPortuarioSub
# end class TDadosOperPortuarioSub
...
class evtTabOperPortTypeSub(supermod.evtTabOperPortType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, infoOperPortuario=None):
        super(evtTabOperPortTypeSub, self).__init__(Id, ideEvento, ideEmpregador, infoOperPortuario, )
supermod.evtTabOperPortType.subclass = evtTabOperPortTypeSub
# end class evtTabOperPortTypeSub


class infoOperPortuarioTypeSub(supermod.infoOperPortuarioType):
    def __init__(self, inclusao=None, alteracao=None, exclusao=None):
        super(infoOperPortuarioTypeSub, self).__init__(inclusao, alteracao, exclusao, )
supermod.infoOperPortuarioType.subclass = infoOperPortuarioTypeSub
# end class infoOperPortuarioTypeSub


class inclusaoTypeSub(supermod.inclusaoType):
    def __init__(self, ideOperPortuario=None, dadosOperPortuario=None):
        super(inclusaoTypeSub, self).__init__(ideOperPortuario, dadosOperPortuario, )
supermod.inclusaoType.subclass = inclusaoTypeSub
# end class inclusaoTypeSub


class alteracaoTypeSub(supermod.alteracaoType):
    def __init__(self, ideOperPortuario=None, dadosOperPortuario=None, novaValidade=None):
        super(alteracaoTypeSub, self).__init__(ideOperPortuario, dadosOperPortuario, novaValidade, )
supermod.alteracaoType.subclass = alteracaoTypeSub
# end class alteracaoTypeSub


class exclusaoTypeSub(supermod.exclusaoType):
    def __init__(self, ideOperPortuario=None):
        super(exclusaoTypeSub, self).__init__(ideOperPortuario, )
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from evtTabOperPort import *\n\n')
        sys.stdout.write('import evtTabOperPort as model_\n\n')

...
class eSocial(GeneratedsSuper):
    ...
    def __init__(self, evtTabProcesso=None, Signature=None):
        ...
        self.evtTabProcesso = evtTabProcesso
    ...
    def get_evtTabProcesso(self): return self.evtTabProcesso
    def set_evtTabProcesso(self, evtTabProcesso): self.evtTabProcesso = evtTabProcesso
    def get_Signature(self): return self.Signature
    def set_Signature(self, Signature): self.Signature = Signature
    def hasContent_(self):
        if (
            self.evtTabProcesso is not None or
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            ...
            eol_ = ''
        if self.evtTabProcesso is not None:
            self.evtTabProcesso.export(outfile, level, namespaceprefix_, name_='evtTabProcesso', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'evtTabProcesso':
            obj_ = evtTabProcessoType.factory()
            obj_.build(child_)
            self.evtTabProcesso = obj_
            obj_.original_tagname_ = 'evtTabProcesso'
...
class TIdeProcesso(GeneratedsSuper):
    """Informações de Identificação do Processo Administrativo/Judicial e
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TIdeProcesso)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TIdeProcesso.subclass:
            return TIdeProcesso.subclass(*args_, **kwargs_)
        else:
            return TIdeProcesso(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TIdeProcesso', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('TIdeProcesso')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TIdeProcesso')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TIdeProcesso', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TIdeProcesso'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TIdeProcesso', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpProc':
            ...
            self.validate_fimValidType(self.fimValid)
# end class TIdeProcesso


class TDadosProc(GeneratedsSuper):
    """Dados do processo"""
    subclass = None
    superclass = None
    def __init__(self, indAutoria=None, indMatProc=None, observacao=None, dadosProcJud=None, infoSusp=None):
        self.original_tagname_ = None
        self.indAutoria = indAutoria
        self.validate_indAutoriaType(self.indAutoria)
        self.indMatProc = indMatProc
        self.validate_indMatProcType(self.indMatProc)
        self.observacao = observacao
        self.validate_observacaoType(self.observacao)
        self.dadosProcJud = dadosProcJud
        if infoSusp is None:
            self.infoSusp = []
        else:
            self.infoSusp = infoSusp
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TDadosProc)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TDadosProc.subclass:
            return TDadosProc.subclass(*args_, **kwargs_)
        else:
            return TDadosProc(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_indAutoria(self): return self.indAutoria
    def set_indAutoria(self, indAutoria): self.indAutoria = indAutoria
    def get_indMatProc(self): return self.indMatProc
    def set_indMatProc(self, indMatProc): self.indMatProc = indMatProc
    def get_observacao(self): return self.observacao
    def set_observacao(self, observacao): self.observacao = observacao
    def get_dadosProcJud(self): return self.dadosProcJud
    def set_dadosProcJud(self, dadosProcJud): self.dadosProcJud = dadosProcJud
    def get_infoSusp(self): return self.infoSusp
    def set_infoSusp(self, infoSusp): self.infoSusp = infoSusp
    def add_infoSusp(self, value): self.infoSusp.append(value)
    def insert_infoSusp_at(self, index, value): self.infoSusp.insert(index, value)
    def replace_infoSusp_at(self, index, value): self.infoSusp[index] = value
    def validate_indAutoriaType(self, value):
        # Validate type indAutoriaType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_indAutoriaType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_indAutoriaType_patterns_, ))
    validate_indAutoriaType_patterns_ = [['^\\d$']]
    def validate_indMatProcType(self, value):
        # Validate type indMatProcType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_indMatProcType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_indMatProcType_patterns_, ))
    validate_indMatProcType_patterns_ = [['^\\d{1,2}$']]
    ...
    def hasContent_(self):
        if (
            self.indAutoria is not None or
            self.indMatProc is not None or
            self.observacao is not None or
            self.dadosProcJud is not None or
            self.infoSusp
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TDadosProc', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('TDadosProc')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TDadosProc')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TDadosProc', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TDadosProc'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TDadosProc', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.indAutoria is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<indAutoria>%s</indAutoria>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.indAutoria), input_name='indAutoria')), eol_))
        if self.indMatProc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<indMatProc>%s</indMatProc>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.indMatProc), input_name='indMatProc')), eol_))
        ...
        if self.dadosProcJud is not None:
            self.dadosProcJud.export(outfile, level, namespaceprefix_, name_='dadosProcJud', pretty_print=pretty_print)
        for infoSusp_ in self.infoSusp:
            infoSusp_.export(outfile, level, namespaceprefix_, name_='infoSusp', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'indAutoria':
            indAutoria_ = child_.text
            indAutoria_ = self.gds_validate_string(indAutoria_, node, 'indAutoria')
            self.indAutoria = indAutoria_
            # validate type indAutoriaType
            self.validate_indAutoriaType(self.indAutoria)
        elif nodeName_ == 'indMatProc':
            indMatProc_ = child_.text
            indMatProc_ = self.gds_validate_string(indMatProc_, node, 'indMatProc')
            self.indMatProc = indMatProc_
            # validate type indMatProcType
            self.validate_indMatProcType(self.indMatProc)
            ...
            self.validate_observacaoType(self.observacao)
        elif nodeName_ == 'dadosProcJud':
            obj_ = dadosProcJudType.factory()
            obj_.build(child_)
            self.dadosProcJud = obj_
            obj_.original_tagname_ = 'dadosProcJud'
        elif nodeName_ == 'infoSusp':
            obj_ = infoSuspType.factory()
            obj_.build(child_)
            self.infoSusp.append(obj_)
            obj_.original_tagname_ = 'infoSusp'
# end class TDadosProc
...
class TPeriodoValidade(GeneratedsSuper):
    ...
    def __init__(self, iniValid=None, fimValid=None):
        self.original_tagname_ = None
        self.iniValid = iniValid
        self.validate_iniValidType1(self.iniValid)
        self.fimValid = fimValid
        self.validate_fimValidType2(self.fimValid)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def get_fimValid(self): return self.fimValid
    def set_fimValid(self, fimValid): self.fimValid = fimValid
    def validate_iniValidType1(self, value):
        # Validate type iniValidType1, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_iniValidType1_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_iniValidType1_patterns_, ))
    validate_iniValidType1_patterns_ = [['^[2]{1}\\d{3}-(1[0-2]|0[1-9])$']]
    def validate_fimValidType2(self, value):
        # Validate type fimValidType2, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_fimValidType2_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_fimValidType2_patterns_, ))
    validate_fimValidType2_patterns_ = [['^[2]{1}\\d{3}-(1[0-2]|0[1-9])$']]
    def hasContent_(self):
        if (
            self.iniValid is not None or
            self.fimValid is not None
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'iniValid':
            ...
            iniValid_ = self.gds_validate_string(iniValid_, node, 'iniValid')
            self.iniValid = iniValid_
            # validate type iniValidType1
            self.validate_iniValidType1(self.iniValid)
        elif nodeName_ == 'fimValid':
            fimValid_ = child_.text
            fimValid_ = self.gds_validate_string(fimValid_, node, 'fimValid')
            self.fimValid = fimValid_
            # validate type fimValidType2
            self.validate_fimValidType2(self.fimValid)
...
class evtTabProcessoType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtTabProcessoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtTabProcessoType.subclass:
            return evtTabProcessoType.subclass(*args_, **kwargs_)
        else:
            return evtTabProcessoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def get_infoProcesso(self): return self.infoProcesso
    def set_infoProcesso(self, infoProcesso): self.infoProcesso = infoProcesso
    def get_Id(self): return self.Id
    def set_Id(self, Id): self.Id = Id
    def hasContent_(self):
        if (
            ...
            self.infoProcesso is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtTabProcessoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtTabProcessoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtTabProcessoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtTabProcessoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtTabProcessoType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtTabProcessoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoProcesso is not None:
            self.infoProcesso.export(outfile, level, namespaceprefix_, name_='infoProcesso', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'infoProcesso':
            obj_ = infoProcessoType.factory()
            obj_.build(child_)
            self.infoProcesso = obj_
            obj_.original_tagname_ = 'infoProcesso'
# end class evtTabProcessoType


class infoProcessoType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoProcessoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoProcessoType.subclass:
            return infoProcessoType.subclass(*args_, **kwargs_)
        else:
            return infoProcessoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoProcessoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoProcessoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoProcessoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoProcessoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoProcessoType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoProcessoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class inclusaoType(GeneratedsSuper):
    ...
    def __init__(self, ideProcesso=None, dadosProc=None):
        self.original_tagname_ = None
        self.ideProcesso = ideProcesso
        self.dadosProc = dadosProc
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    factory = staticmethod(factory)
    def get_ideProcesso(self): return self.ideProcesso
    def set_ideProcesso(self, ideProcesso): self.ideProcesso = ideProcesso
    def get_dadosProc(self): return self.dadosProc
    def set_dadosProc(self, dadosProc): self.dadosProc = dadosProc
    def hasContent_(self):
        if (
            self.ideProcesso is not None or
            self.dadosProc is not None
        ):
            return True
        else:
            return False
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='inclusaoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            ...
            eol_ = ''
        if self.ideProcesso is not None:
            self.ideProcesso.export(outfile, level, namespaceprefix_, name_='ideProcesso', pretty_print=pretty_print)
        if self.dadosProc is not None:
            self.dadosProc.export(outfile, level, namespaceprefix_, name_='dadosProc', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ideProcesso':
            obj_ = TIdeProcesso.factory()
            obj_.build(child_)
            self.ideProcesso = obj_
            obj_.original_tagname_ = 'ideProcesso'
        elif nodeName_ == 'dadosProc':
            obj_ = TDadosProc.factory()
            obj_.build(child_)
            self.dadosProc = obj_
            obj_.original_tagname_ = 'dadosProc'
...
class dadosProcJudType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, ufVara=None, codMunic=None, idVara=None):
        self.original_tagname_ = None
        self.ufVara = ufVara
        self.validate_ufVaraType(self.ufVara)
        self.codMunic = codMunic
        self.validate_codMunicType(self.codMunic)
        self.idVara = idVara
        self.validate_idVaraType(self.idVara)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, dadosProcJudType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if dadosProcJudType.subclass:
            return dadosProcJudType.subclass(*args_, **kwargs_)
        else:
            return dadosProcJudType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ufVara(self): return self.ufVara
    def set_ufVara(self, ufVara): self.ufVara = ufVara
    def get_codMunic(self): return self.codMunic
    def set_codMunic(self, codMunic): self.codMunic = codMunic
    def get_idVara(self): return self.idVara
    def set_idVara(self, idVara): self.idVara = idVara
    def validate_ufVaraType(self, value):
        # Validate type ufVaraType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            value = str(value)
            ...
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on ufVaraType' % {"value" : value.encode("utf-8")} )
    def validate_codMunicType(self, value):
        # Validate type codMunicType, a restriction on xs:integer.
        if value is not None and Validate_simpletypes_:
            pass
    def validate_idVaraType(self, value):
        # Validate type idVaraType, a restriction on xs:integer.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_idVaraType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_idVaraType_patterns_, ))
    validate_idVaraType_patterns_ = [['^\\d{1,4}$']]
    def hasContent_(self):
        if (
            self.ufVara is not None or
            self.codMunic is not None or
            self.idVara is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='dadosProcJudType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('dadosProcJudType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='dadosProcJudType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='dadosProcJudType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='dadosProcJudType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='dadosProcJudType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.ufVara is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ufVara>%s</ufVara>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ufVara), input_name='ufVara')), eol_))
        ...
        if self.idVara is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<idVara>%s</idVara>%s' % (self.gds_format_integer(self.idVara, input_name='idVara'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ufVara':
            ufVara_ = child_.text
            ufVara_ = self.gds_validate_string(ufVara_, node, 'ufVara')
            self.ufVara = ufVara_
            # validate type ufVaraType
            self.validate_ufVaraType(self.ufVara)
            ...
            self.validate_codMunicType(self.codMunic)
        elif nodeName_ == 'idVara' and child_.text:
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'idVara')
            self.idVara = ival_
            # validate type idVaraType
            self.validate_idVaraType(self.idVara)
# end class dadosProcJudType


class infoSuspType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, codSusp=None, indSusp=None, dtDecisao=None, indDeposito=None):
        ...
        self.indSusp = indSusp
        self.validate_indSuspType(self.indSusp)
        if isinstance(dtDecisao, BaseStrType_):
            initvalue_ = datetime_.datetime.strptime(dtDecisao, '%Y-%m-%d').date()
        else:
            initvalue_ = dtDecisao
        self.dtDecisao = initvalue_
        self.indDeposito = indDeposito
        self.validate_indDepositoType(self.indDeposito)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoSuspType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoSuspType.subclass:
            return infoSuspType.subclass(*args_, **kwargs_)
        else:
            return infoSuspType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_codSusp(self): return self.codSusp
    def set_codSusp(self, codSusp): self.codSusp = codSusp
    def get_indSusp(self): return self.indSusp
    def set_indSusp(self, indSusp): self.indSusp = indSusp
    def get_dtDecisao(self): return self.dtDecisao
    def set_dtDecisao(self, dtDecisao): self.dtDecisao = dtDecisao
    def get_indDeposito(self): return self.indDeposito
    def set_indDeposito(self, indDeposito): self.indDeposito = indDeposito
    ...
    def validate_indSuspType(self, value):
        # Validate type indSuspType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_indSuspType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_indSuspType_patterns_, ))
    validate_indSuspType_patterns_ = [['^\\d{2}$']]
    def validate_dtDecisaoType(self, value):
        # Validate type dtDecisaoType, a restriction on xs:date.
        if value is not None and Validate_simpletypes_:
            pass
    def validate_indDepositoType(self, value):
        # Validate type indDepositoType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 1:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on indDepositoType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_indDepositoType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_indDepositoType_patterns_, ))
    validate_indDepositoType_patterns_ = [['^[N|S]$']]
    def hasContent_(self):
        if (
            self.codSusp is not None or
            self.indSusp is not None or
            self.dtDecisao is not None or
            self.indDeposito is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoSuspType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoSuspType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoSuspType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoSuspType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoSuspType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoSuspType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.indSusp is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<indSusp>%s</indSusp>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.indSusp), input_name='indSusp')), eol_))
        if self.dtDecisao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dtDecisao>%s</dtDecisao>%s' % (self.gds_format_date(self.dtDecisao, input_name='dtDecisao'), eol_))
        if self.indDeposito is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<indDeposito>%s</indDeposito>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.indDeposito), input_name='indDeposito')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'codSusp' and child_.text:
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
            ...
            self.validate_codSuspType(self.codSusp)
        elif nodeName_ == 'indSusp':
            indSusp_ = child_.text
            indSusp_ = self.gds_validate_string(indSusp_, node, 'indSusp')
            self.indSusp = indSusp_
            # validate type indSuspType
            self.validate_indSuspType(self.indSusp)
        elif nodeName_ == 'dtDecisao':
            sval_ = child_.text
            dval_ = self.gds_parse_date(sval_)
            self.dtDecisao = dval_
            # validate type dtDecisaoType
            self.validate_dtDecisaoType(self.dtDecisao)
        elif nodeName_ == 'indDeposito':
            indDeposito_ = child_.text
            indDeposito_ = self.gds_validate_string(indDeposito_, node, 'indDeposito')
            self.indDeposito = indDeposito_
            # validate type indDepositoType
            self.validate_indDepositoType(self.indDeposito)
# end class infoSuspType

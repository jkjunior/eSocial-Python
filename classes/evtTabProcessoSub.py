...
#
# Generated Wed Oct 10 14:18:12 2018 by generateDS.py version 2.29.24.
# Python 3.6.5 (default, May 11 2018, 13:30:17)  [GCC 7.3.0]
#
# Command line options:
#   ('-o', 'classes/evtTabProcesso.py')
#   ('-s', 'classes/evtTabProcessoSub.py')
#   ('--super', 'evtTabProcesso')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtTabProcesso.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtTabProcesso.py" -s "classes/evtTabProcessoSub.py" --super="evtTabProcesso" /home/joao/Documents/teste_xsd/xsd/evtTabProcesso.xsd
#
...
import evtTabProcesso as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtTabProcesso=None, Signature=None):
        super(eSocialSub, self).__init__(evtTabProcesso, Signature, )
...
class TIdeProcessoSub(supermod.TIdeProcesso):
    def __init__(self, tpProc=None, nrProc=None, iniValid=None, fimValid=None):
        super(TIdeProcessoSub, self).__init__(tpProc, nrProc, iniValid, fimValid, )
supermod.TIdeProcesso.subclass = TIdeProcessoSub
# end class TIdeProcessoSub


class TDadosProcSub(supermod.TDadosProc):
    def __init__(self, indAutoria=None, indMatProc=None, observacao=None, dadosProcJud=None, infoSusp=None):
        super(TDadosProcSub, self).__init__(indAutoria, indMatProc, observacao, dadosProcJud, infoSusp, )
supermod.TDadosProc.subclass = TDadosProcSub
# end class TDadosProcSub
...
class evtTabProcessoTypeSub(supermod.evtTabProcessoType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, infoProcesso=None):
        super(evtTabProcessoTypeSub, self).__init__(Id, ideEvento, ideEmpregador, infoProcesso, )
supermod.evtTabProcessoType.subclass = evtTabProcessoTypeSub
# end class evtTabProcessoTypeSub


class infoProcessoTypeSub(supermod.infoProcessoType):
    def __init__(self, inclusao=None, alteracao=None, exclusao=None):
        super(infoProcessoTypeSub, self).__init__(inclusao, alteracao, exclusao, )
supermod.infoProcessoType.subclass = infoProcessoTypeSub
# end class infoProcessoTypeSub


class inclusaoTypeSub(supermod.inclusaoType):
    def __init__(self, ideProcesso=None, dadosProc=None):
        super(inclusaoTypeSub, self).__init__(ideProcesso, dadosProc, )
supermod.inclusaoType.subclass = inclusaoTypeSub
# end class inclusaoTypeSub


class alteracaoTypeSub(supermod.alteracaoType):
    def __init__(self, ideProcesso=None, dadosProc=None, novaValidade=None):
        super(alteracaoTypeSub, self).__init__(ideProcesso, dadosProc, novaValidade, )
supermod.alteracaoType.subclass = alteracaoTypeSub
# end class alteracaoTypeSub


class exclusaoTypeSub(supermod.exclusaoType):
    def __init__(self, ideProcesso=None):
        super(exclusaoTypeSub, self).__init__(ideProcesso, )
supermod.exclusaoType.subclass = exclusaoTypeSub
# end class exclusaoTypeSub


class dadosProcJudTypeSub(supermod.dadosProcJudType):
    def __init__(self, ufVara=None, codMunic=None, idVara=None):
        super(dadosProcJudTypeSub, self).__init__(ufVara, codMunic, idVara, )
supermod.dadosProcJudType.subclass = dadosProcJudTypeSub
# end class dadosProcJudTypeSub


class infoSuspTypeSub(supermod.infoSuspType):
    def __init__(self, codSusp=None, indSusp=None, dtDecisao=None, indDeposito=None):
        super(infoSuspTypeSub, self).__init__(codSusp, indSusp, dtDecisao, indDeposito, )
supermod.infoSuspType.subclass = infoSuspTypeSub
# end class infoSuspTypeSub
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from evtTabProcesso import *\n\n')
        sys.stdout.write('import evtTabProcesso as model_\n\n')

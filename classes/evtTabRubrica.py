...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtTabRubrica is not None:
            self.evtTabRubrica.export(outfile, level, namespaceprefix_, name_='evtTabRubrica', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'evtTabRubrica':
            obj_ = evtTabRubricaType.factory()
            obj_.build(child_)
...
class TIdeRubrica(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TIdeRubrica', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TIdeRubrica')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TIdeRubrica', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TIdeRubrica'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TIdeRubrica', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TDadosRubrica(GeneratedsSuper):
    ...
    def __init__(self, dscRubr=None, natRubr=None, tpRubr=None, codIncCP=None, codIncIRRF=None, codIncFGTS=None, codIncSIND=None, observacao=None, ideProcessoCP=None, ideProcessoIRRF=None, ideProcessoFGTS=None, ideProcessoSIND=None):
        ...
        self.validate_dscRubrType(self.dscRubr)
        self.natRubr = natRubr
        self.validate_natRubrType(self.natRubr)
        self.tpRubr = tpRubr
        self.validate_tpRubrType(self.tpRubr)
        self.codIncCP = codIncCP
        self.validate_codIncCPType(self.codIncCP)
        self.codIncIRRF = codIncIRRF
        self.validate_codIncIRRFType(self.codIncIRRF)
        self.codIncFGTS = codIncFGTS
        self.validate_codIncFGTSType(self.codIncFGTS)
        self.codIncSIND = codIncSIND
        self.validate_codIncSINDType(self.codIncSIND)
    ...
    def validate_dscRubrType(self, value):
        # Validate type dscRubrType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 100:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on dscRubrType' % {"value" : value.encode("utf-8")} )
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on dscRubrType' % {"value" : value.encode("utf-8")} )
    def validate_natRubrType(self, value):
        # Validate type natRubrType, a restriction on xs:integer.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_natRubrType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_natRubrType_patterns_, ))
    validate_natRubrType_patterns_ = [['^\\d{4}$']]
    def validate_tpRubrType(self, value):
        # Validate type tpRubrType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tpRubrType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_tpRubrType_patterns_, ))
    validate_tpRubrType_patterns_ = [['^\\d$']]
    def validate_codIncCPType(self, value):
        # Validate type codIncCPType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 2:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on codIncCPType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_codIncCPType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_codIncCPType_patterns_, ))
    validate_codIncCPType_patterns_ = [['^\\d{2}$']]
    def validate_codIncIRRFType(self, value):
        # Validate type codIncIRRFType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 2:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on codIncIRRFType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_codIncIRRFType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_codIncIRRFType_patterns_, ))
    validate_codIncIRRFType_patterns_ = [['^\\d{2}$']]
    def validate_codIncFGTSType(self, value):
        # Validate type codIncFGTSType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 2:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on codIncFGTSType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_codIncFGTSType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_codIncFGTSType_patterns_, ))
    validate_codIncFGTSType_patterns_ = [['^\\d{2}$']]
    def validate_codIncSINDType(self, value):
        # Validate type codIncSINDType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 2:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on codIncSINDType' % {"value" : value.encode("utf-8")} )
            if not self.gds_validate_simple_patterns(
                    self.validate_codIncSINDType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_codIncSINDType_patterns_, ))
    validate_codIncSINDType_patterns_ = [['^\\d{2}$']]
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='TDadosRubrica', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TDadosRubrica')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='TDadosRubrica', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TDadosRubrica'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='TDadosRubrica', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.dscRubr is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<dscRubr>%s</dscRubr>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.dscRubr), input_name='dscRubr')), eol_))
        if self.natRubr is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<natRubr>%s</natRubr>%s' % (self.gds_format_integer(self.natRubr, input_name='natRubr'), eol_))
        if self.tpRubr is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tpRubr>%s</tpRubr>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.tpRubr), input_name='tpRubr')), eol_))
        if self.codIncCP is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<codIncCP>%s</codIncCP>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.codIncCP), input_name='codIncCP')), eol_))
        if self.codIncIRRF is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<codIncIRRF>%s</codIncIRRF>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.codIncIRRF), input_name='codIncIRRF')), eol_))
        if self.codIncFGTS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<codIncFGTS>%s</codIncFGTS>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.codIncFGTS), input_name='codIncFGTS')), eol_))
        if self.codIncSIND is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<codIncSIND>%s</codIncSIND>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.codIncSIND), input_name='codIncSIND')), eol_))
        ...
        for ideProcessoCP_ in self.ideProcessoCP:
            ideProcessoCP_.export(outfile, level, namespaceprefix_, name_='ideProcessoCP', pretty_print=pretty_print)
        for ideProcessoIRRF_ in self.ideProcessoIRRF:
            ideProcessoIRRF_.export(outfile, level, namespaceprefix_, name_='ideProcessoIRRF', pretty_print=pretty_print)
        for ideProcessoFGTS_ in self.ideProcessoFGTS:
            ideProcessoFGTS_.export(outfile, level, namespaceprefix_, name_='ideProcessoFGTS', pretty_print=pretty_print)
        for ideProcessoSIND_ in self.ideProcessoSIND:
            ideProcessoSIND_.export(outfile, level, namespaceprefix_, name_='ideProcessoSIND', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dscRubr':
            ...
            # validate type dscRubrType
            self.validate_dscRubrType(self.dscRubr)
        elif nodeName_ == 'natRubr' and child_.text:
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            ...
            self.natRubr = ival_
            # validate type natRubrType
            self.validate_natRubrType(self.natRubr)
        elif nodeName_ == 'tpRubr':
            tpRubr_ = child_.text
            tpRubr_ = self.gds_validate_string(tpRubr_, node, 'tpRubr')
            self.tpRubr = tpRubr_
            # validate type tpRubrType
            self.validate_tpRubrType(self.tpRubr)
...
class TPeriodoValidade(GeneratedsSuper):
    ...
    def __init__(self, iniValid=None, fimValid=None):
        self.original_tagname_ = None
        self.iniValid = iniValid
        self.validate_iniValidType5(self.iniValid)
        self.fimValid = fimValid
        self.validate_fimValidType6(self.fimValid)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def get_fimValid(self): return self.fimValid
    def set_fimValid(self, fimValid): self.fimValid = fimValid
    def validate_iniValidType5(self, value):
        # Validate type iniValidType5, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_iniValidType5_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_iniValidType5_patterns_, ))
    validate_iniValidType5_patterns_ = [['^[2]{1}\\d{3}-(1[0-2]|0[1-9])$']]
    def validate_fimValidType6(self, value):
        # Validate type fimValidType6, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_fimValidType6_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_fimValidType6_patterns_, ))
    validate_fimValidType6_patterns_ = [['^[2]{1}\\d{3}-(1[0-2]|0[1-9])$']]
    def hasContent_(self):
        if (
            self.iniValid is not None or
            self.fimValid is not None
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'iniValid':
            ...
            iniValid_ = self.gds_validate_string(iniValid_, node, 'iniValid')
            self.iniValid = iniValid_
            # validate type iniValidType5
            self.validate_iniValidType5(self.iniValid)
        elif nodeName_ == 'fimValid':
            fimValid_ = child_.text
            fimValid_ = self.gds_validate_string(fimValid_, node, 'fimValid')
            self.fimValid = fimValid_
            # validate type fimValidType6
            self.validate_fimValidType6(self.fimValid)
...
class evtTabRubricaType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtTabRubricaType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtTabRubricaType.subclass:
            return evtTabRubricaType.subclass(*args_, **kwargs_)
        else:
            return evtTabRubricaType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='evtTabRubricaType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtTabRubricaType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='evtTabRubricaType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='evtTabRubricaType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='evtTabRubricaType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='evtTabRubricaType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoRubrica is not None:
            self.infoRubrica.export(outfile, level, namespaceprefix_, name_='infoRubrica', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ideEvento':
            ...
            obj_ = infoRubricaType.factory()
            obj_.build(child_)
            self.infoRubrica = obj_
            obj_.original_tagname_ = 'infoRubrica'
# end class evtTabRubricaType


class infoRubricaType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoRubricaType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoRubricaType.subclass:
            return infoRubricaType.subclass(*args_, **kwargs_)
        else:
            return infoRubricaType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='infoRubricaType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoRubricaType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='infoRubricaType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='infoRubricaType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='infoRubricaType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='infoRubricaType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class inclusaoType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='inclusaoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.ideRubrica is not None:
            self.ideRubrica.export(outfile, level, namespaceprefix_, name_='ideRubrica', pretty_print=pretty_print)
        if self.dadosRubrica is not None:
            self.dadosRubrica.export(outfile, level, namespaceprefix_, name_='dadosRubrica', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class ideProcessoCPType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, tpProc=None, nrProc=None, extDecisao=None, codSusp=None):
        ...
        self.validate_extDecisaoType(self.extDecisao)
        self.codSusp = codSusp
        self.validate_codSuspType(self.codSusp)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ideProcessoCPType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ideProcessoCPType.subclass:
            return ideProcessoCPType.subclass(*args_, **kwargs_)
        else:
            return ideProcessoCPType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def validate_extDecisaoType(self, value):
        # Validate type extDecisaoType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_extDecisaoType_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_extDecisaoType_patterns_, ))
    validate_extDecisaoType_patterns_ = [['^\\d$']]
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='ideProcessoCPType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ideProcessoCPType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ideProcessoCPType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='ideProcessoCPType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ideProcessoCPType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideProcessoCPType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.extDecisao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<extDecisao>%s</extDecisao>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.extDecisao), input_name='extDecisao')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpProc':
            ...
            extDecisao_ = child_.text
            extDecisao_ = self.gds_validate_string(extDecisao_, node, 'extDecisao')
            self.extDecisao = extDecisao_
            # validate type extDecisaoType
            self.validate_extDecisaoType(self.extDecisao)
            ...
            self.validate_codSuspType(self.codSusp)
# end class ideProcessoCPType


class ideProcessoIRRFType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, nrProc=None, codSusp=None):
        self.original_tagname_ = None
        self.nrProc = nrProc
        self.validate_nrProcType1(self.nrProc)
        self.codSusp = codSusp
        self.validate_codSuspType2(self.codSusp)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ideProcessoIRRFType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ideProcessoIRRFType.subclass:
            return ideProcessoIRRFType.subclass(*args_, **kwargs_)
        else:
            return ideProcessoIRRFType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_nrProc(self): return self.nrProc
    def set_nrProc(self, nrProc): self.nrProc = nrProc
    def get_codSusp(self): return self.codSusp
    def set_codSusp(self, codSusp): self.codSusp = codSusp
    def validate_nrProcType1(self, value):
        # Validate type nrProcType1, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 21:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on nrProcType1' % {"value" : value.encode("utf-8")} )
            if len(value) < 3:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on nrProcType1' % {"value" : value.encode("utf-8")} )
    def validate_codSuspType2(self, value):
        # Validate type codSuspType2, a restriction on xs:integer.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_codSuspType2_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_codSuspType2_patterns_, ))
    validate_codSuspType2_patterns_ = [['^\\d{1,14}$']]
    def hasContent_(self):
        if (
            self.nrProc is not None or
            self.codSusp is not None
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='ideProcessoIRRFType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ideProcessoIRRFType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ideProcessoIRRFType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='ideProcessoIRRFType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ideProcessoIRRFType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideProcessoIRRFType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'nrProc':
            ...
            ival_ = self.gds_validate_integer(ival_, node, 'codSusp')
            self.codSusp = ival_
            # validate type codSuspType2
            self.validate_codSuspType2(self.codSusp)
# end class ideProcessoIRRFType


class ideProcessoFGTSType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, nrProc=None):
        self.original_tagname_ = None
        self.nrProc = nrProc
        self.validate_nrProcType3(self.nrProc)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ideProcessoFGTSType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ideProcessoFGTSType.subclass:
            return ideProcessoFGTSType.subclass(*args_, **kwargs_)
        else:
            return ideProcessoFGTSType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_nrProc(self): return self.nrProc
    def set_nrProc(self, nrProc): self.nrProc = nrProc
    def validate_nrProcType3(self, value):
        # Validate type nrProcType3, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 21:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on nrProcType3' % {"value" : value.encode("utf-8")} )
            if len(value) < 3:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on nrProcType3' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='ideProcessoFGTSType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ideProcessoFGTSType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ideProcessoFGTSType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='ideProcessoFGTSType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ideProcessoFGTSType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideProcessoFGTSType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'nrProc':
            ...
            nrProc_ = self.gds_validate_string(nrProc_, node, 'nrProc')
            self.nrProc = nrProc_
            # validate type nrProcType3
            self.validate_nrProcType3(self.nrProc)
# end class ideProcessoFGTSType


class ideProcessoSINDType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, nrProc=None):
        self.original_tagname_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ideProcessoSINDType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ideProcessoSINDType.subclass:
            return ideProcessoSINDType.subclass(*args_, **kwargs_)
        else:
            return ideProcessoSINDType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_nrProc(self): return self.nrProc
    def set_nrProc(self, nrProc): self.nrProc = nrProc
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', name_='ideProcessoSINDType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ideProcessoSINDType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ideProcessoSINDType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='', name_='ideProcessoSINDType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ideProcessoSINDType'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', name_='ideProcessoSINDType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''

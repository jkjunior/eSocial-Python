...
#   ('-o', 'classes/evtTabRubrica.py')
#   ('-s', 'classes/evtTabRubricaSub.py')
#   ('--super', 'evtTabRubrica')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtTabRubrica.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtTabRubrica.py" -s "classes/evtTabRubricaSub.py" --super="evtTabRubrica" /home/joao/Documents/teste_xsd/xsd/evtTabRubrica.xsd
#
...
import evtTabRubrica as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtTabRubrica=None, Signature=None):
        super(eSocialSub, self).__init__(evtTabRubrica, Signature, )
...
class TIdeRubricaSub(supermod.TIdeRubrica):
    def __init__(self, codRubr=None, ideTabRubr=None, iniValid=None, fimValid=None):
        super(TIdeRubricaSub, self).__init__(codRubr, ideTabRubr, iniValid, fimValid, )
supermod.TIdeRubrica.subclass = TIdeRubricaSub
# end class TIdeRubricaSub


class TDadosRubricaSub(supermod.TDadosRubrica):
    def __init__(self, dscRubr=None, natRubr=None, tpRubr=None, codIncCP=None, codIncIRRF=None, codIncFGTS=None, codIncSIND=None, observacao=None, ideProcessoCP=None, ideProcessoIRRF=None, ideProcessoFGTS=None, ideProcessoSIND=None):
        super(TDadosRubricaSub, self).__init__(dscRubr, natRubr, tpRubr, codIncCP, codIncIRRF, codIncFGTS, codIncSIND, observacao, ideProcessoCP, ideProcessoIRRF, ideProcessoFGTS, ideProcessoSIND, )
supermod.TDadosRubrica.subclass = TDadosRubricaSub
# end class TDadosRubricaSub
...
class evtTabRubricaTypeSub(supermod.evtTabRubricaType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, infoRubrica=None):
        super(evtTabRubricaTypeSub, self).__init__(Id, ideEvento, ideEmpregador, infoRubrica, )
supermod.evtTabRubricaType.subclass = evtTabRubricaTypeSub
# end class evtTabRubricaTypeSub


class infoRubricaTypeSub(supermod.infoRubricaType):
    def __init__(self, inclusao=None, alteracao=None, exclusao=None):
        super(infoRubricaTypeSub, self).__init__(inclusao, alteracao, exclusao, )
supermod.infoRubricaType.subclass = infoRubricaTypeSub
# end class infoRubricaTypeSub


class inclusaoTypeSub(supermod.inclusaoType):
    def __init__(self, ideRubrica=None, dadosRubrica=None):
        super(inclusaoTypeSub, self).__init__(ideRubrica, dadosRubrica, )
...
class alteracaoTypeSub(supermod.alteracaoType):
    def __init__(self, ideRubrica=None, dadosRubrica=None, novaValidade=None):
        super(alteracaoTypeSub, self).__init__(ideRubrica, dadosRubrica, novaValidade, )
...
class exclusaoTypeSub(supermod.exclusaoType):
    def __init__(self, ideRubrica=None):
        super(exclusaoTypeSub, self).__init__(ideRubrica, )
supermod.exclusaoType.subclass = exclusaoTypeSub
# end class exclusaoTypeSub


class ideProcessoCPTypeSub(supermod.ideProcessoCPType):
    def __init__(self, tpProc=None, nrProc=None, extDecisao=None, codSusp=None):
        super(ideProcessoCPTypeSub, self).__init__(tpProc, nrProc, extDecisao, codSusp, )
supermod.ideProcessoCPType.subclass = ideProcessoCPTypeSub
# end class ideProcessoCPTypeSub


class ideProcessoIRRFTypeSub(supermod.ideProcessoIRRFType):
    def __init__(self, nrProc=None, codSusp=None):
        super(ideProcessoIRRFTypeSub, self).__init__(nrProc, codSusp, )
supermod.ideProcessoIRRFType.subclass = ideProcessoIRRFTypeSub
# end class ideProcessoIRRFTypeSub


class ideProcessoFGTSTypeSub(supermod.ideProcessoFGTSType):
    def __init__(self, nrProc=None):
        super(ideProcessoFGTSTypeSub, self).__init__(nrProc, )
supermod.ideProcessoFGTSType.subclass = ideProcessoFGTSTypeSub
# end class ideProcessoFGTSTypeSub


class ideProcessoSINDTypeSub(supermod.ideProcessoSINDType):
    def __init__(self, nrProc=None):
        super(ideProcessoSINDTypeSub, self).__init__(nrProc, )
supermod.ideProcessoSINDType.subclass = ideProcessoSINDTypeSub
# end class ideProcessoSINDTypeSub

...
#   ('-o', 'classes/evtTotConting.py')
#   ('-s', 'classes/evtTotContingSub.py')
#   ('--super', 'evtTotConting')
#
# Command line arguments:
#   /home/joao/Documents/teste_xsd/xsd/evtTotConting.xsd
#
# Command line:
#   /home/joao/Documents/teste_xsd/dkuhlman-generateds-60c208fd6e8d/generateDS.py -o "classes/evtTotConting.py" -s "classes/evtTotContingSub.py" --super="evtTotConting" /home/joao/Documents/teste_xsd/xsd/evtTotConting.xsd
#
...
import evtTotConting as supermod
...
class eSocialSub(supermod.eSocial):
    def __init__(self, evtTotConting=None, Signature=None):
        super(eSocialSub, self).__init__(evtTotConting, Signature, )
...
class evtTotContingTypeSub(supermod.evtTotContingType):
    def __init__(self, Id=None, ideEvento=None, ideEmpregador=None, ideRespInf=None):
        super(evtTotContingTypeSub, self).__init__(Id, ideEvento, ideEmpregador, ideRespInf, )
supermod.evtTotContingType.subclass = evtTotContingTypeSub
# end class evtTotContingTypeSub
...
def parseLiteral(inFilename, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from evtTotConting import *\n\n')
        sys.stdout.write('import evtTotConting as model_\n\n')
